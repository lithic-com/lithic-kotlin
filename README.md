...
[![Maven Central](https://img.shields.io/maven-central/v/com.lithic.api/lithic-kotlin)](https://central.sonatype.com/artifact/com.lithic.api/lithic-kotlin/0.104.0)
[![javadoc](https://javadoc.io/badge2/com.lithic.api/lithic-kotlin/0.104.0/javadoc.svg)](https://javadoc.io/doc/com.lithic.api/lithic-kotlin/0.104.0)
...
The REST API documentation can be found on [docs.lithic.com](https://docs.lithic.com). KDocs are available on [javadoc.io](https://javadoc.io/doc/com.lithic.api/lithic-kotlin/0.104.0).
...
```kotlin
implementation("com.lithic.api:lithic-kotlin:0.104.0")
```
