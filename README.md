...
[![Maven Central](https://img.shields.io/maven-central/v/com.lithic.api/lithic-kotlin)](https://central.sonatype.com/artifact/com.lithic.api/lithic-kotlin/0.76.0)
...
```kotlin
implementation("com.lithic.api:lithic-kotlin:0.76.0")
```
