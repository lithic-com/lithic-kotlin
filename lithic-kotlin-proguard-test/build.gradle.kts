...
dependencies {
    testImplementation(project(":lithic-kotlin"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../lithic-kotlin-core/src/main/resources/META-INF/proguard/lithic-kotlin-core.pro")
}
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../lithic-kotlin-core/src/main/resources/META-INF/proguard/lithic-kotlin-core.pro",
