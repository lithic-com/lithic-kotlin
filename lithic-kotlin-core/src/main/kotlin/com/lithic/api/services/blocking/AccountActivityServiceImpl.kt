...
class AccountActivityServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): AccountActivityService =
        AccountActivityServiceImpl(clientOptions.toBuilder().apply(modifier).build())
