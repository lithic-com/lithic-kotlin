...
class LoanTapeConfigurationServiceImpl
internal constructor(private val clientOptions: ClientOptions) : LoanTapeConfigurationService {

    private val withRawResponse: LoanTapeConfigurationService.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): LoanTapeConfigurationService.WithRawResponse = withRawResponse

    override fun withOptions(
        modifier: (ClientOptions.Builder) -> Unit
    ): LoanTapeConfigurationService =
        LoanTapeConfigurationServiceImpl(clientOptions.toBuilder().apply(modifier).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            LoanTapeConfigurationServiceImpl.WithRawResponseImpl(
