...
class NetworkProgramServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): NetworkProgramService =
        NetworkProgramServiceImpl(clientOptions.toBuilder().apply(modifier).build())
