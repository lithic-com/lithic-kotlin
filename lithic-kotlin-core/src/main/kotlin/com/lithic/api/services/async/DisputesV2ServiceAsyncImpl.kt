...
class DisputesV2ServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): DisputesV2ServiceAsync =
        DisputesV2ServiceAsyncImpl(clientOptions.toBuilder().apply(modifier).build())
