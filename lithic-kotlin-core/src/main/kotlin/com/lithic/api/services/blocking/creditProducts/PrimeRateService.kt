...
interface PrimeRateService {
     ...
     */
    fun withOptions(modifier: (ClientOptions.Builder) -> Unit): PrimeRateService
    ...
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: (ClientOptions.Builder) -> Unit): PrimeRateService.WithRawResponse
