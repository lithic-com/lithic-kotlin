...
interface V2Service {
    ...
    fun list(
        params: V2ListParams = V2ListParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ): V2ListPage

    /** @see [list] */
    fun list(requestOptions: RequestOptions): V2ListPage = list(V2ListParams.none(), requestOptions)
    ...
    interface WithRawResponse {
        ...
        /** @see [list] */
        @MustBeClosed
        fun list(requestOptions: RequestOptions): HttpResponseFor<V2ListPage> =
            list(V2ListParams.none(), requestOptions)
