...
class TransactionServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override suspend fun expireAuthorization(
    ...
    override suspend fun route(params: TransactionRouteParams, requestOptions: RequestOptions) {
    ...
    override suspend fun simulateCreditAuthorizationAdvice(
