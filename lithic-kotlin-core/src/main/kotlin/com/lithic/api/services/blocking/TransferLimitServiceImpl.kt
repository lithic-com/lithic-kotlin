...
class TransferLimitServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): TransferLimitService =
        TransferLimitServiceImpl(clientOptions.toBuilder().apply(modifier).build())
