...
class LoanTapeServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        private val listHandler: Handler<LoanTapeListPageAsync.Response> =
            jsonHandler<LoanTapeListPageAsync.Response>(clientOptions.jsonMapper)
