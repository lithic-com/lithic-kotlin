...
import com.lithic.api.models.authrules.v2.V2ListPage
...
class V2ServiceImpl internal constructor(private val clientOptions: ClientOptions) : V2Service {
    ...
    override fun create(params: V2CreateParams, requestOptions: RequestOptions): V2CreateResponse =
        // post /v2/auth_rules
    ...
    override fun update(params: V2UpdateParams, requestOptions: RequestOptions): V2UpdateResponse =
    ...
    override fun apply(params: V2ApplyParams, requestOptions: RequestOptions): V2ApplyResponse =
        // post /v2/auth_rules/{auth_rule_token}/apply
        withRawResponse().apply(params, requestOptions).parse()

    override fun draft(params: V2DraftParams, requestOptions: RequestOptions): V2DraftResponse =
    ...
    override fun report(params: V2ReportParams, requestOptions: RequestOptions): V2ReportResponse =
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        private val listHandler: Handler<V2ListPage.Response> =
            jsonHandler<V2ListPage.Response>(clientOptions.jsonMapper)
        ...
        override fun list(
            ...
            return response.parseable {
                response
                    ...
                    .let { V2ListPage.of(V2ServiceImpl(clientOptions), params, it) }
            }
        }
