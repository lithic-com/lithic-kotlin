...
interface OpenToBuyService {
     ...
     */
    fun withOptions(modifier: (ClientOptions.Builder) -> Unit): OpenToBuyService
    ...
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: (ClientOptions.Builder) -> Unit): OpenToBuyService.WithRawResponse
