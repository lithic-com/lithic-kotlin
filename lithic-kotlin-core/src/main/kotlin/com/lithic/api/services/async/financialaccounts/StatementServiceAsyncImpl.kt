...
class StatementServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        private val listHandler: Handler<StatementListPageAsync.Response> =
            jsonHandler<StatementListPageAsync.Response>(clientOptions.jsonMapper)
