...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun progressTo(): ExternalPaymentProgressTo? = body.progressTo()
    ...
    internal fun _body(): CreateExternalPaymentRequest = body
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun progressTo(): ExternalPaymentProgressTo? = progressTo.getNullable("progress_to")
