...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CardBalanceListPageAsync && this.balancesService == other.balancesService && this.params == other.params && this.response == other.response /* spotless:on */
    }
    ...
    fun getNextPageParams(): CardBalanceListParams? {
        return null
    }
    ...
    constructor(
        ...
        override fun toString() =
            "CardBalanceListPageAsync.Response{data=$data, hasMore=$hasMore, additionalProperties=$additionalProperties}"
