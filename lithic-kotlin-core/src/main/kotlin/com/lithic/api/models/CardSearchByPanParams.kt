...
constructor(
    ...
    @JsonDeserialize(builder = CardSearchByPanBody.Builder::class)
    @NoAutoDetect
    ...
    override fun toString() =
        "CardSearchByPanParams{pan=$pan, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
