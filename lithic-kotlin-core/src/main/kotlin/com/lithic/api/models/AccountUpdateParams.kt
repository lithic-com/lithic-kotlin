...
private constructor(
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun dailySpendLimit(): Long? = dailySpendLimit.getNullable("daily_spend_limit")
         ...
         *   server responded with an unexpected value).
         */
        fun lifetimeSpendLimit(): Long? = lifetimeSpendLimit.getNullable("lifetime_spend_limit")
         ...
         *   server responded with an unexpected value).
         */
        fun monthlySpendLimit(): Long? = monthlySpendLimit.getNullable("monthly_spend_limit")
    ...
    class Substatus @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val FRAUD_IDENTIFIED = of("FRAUD_IDENTIFIED")

            val SUSPICIOUS_ACTIVITY = of("SUSPICIOUS_ACTIVITY")

            val RISK_VIOLATION = of("RISK_VIOLATION")
