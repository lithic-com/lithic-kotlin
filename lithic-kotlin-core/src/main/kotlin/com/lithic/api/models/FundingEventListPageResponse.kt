...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FundingEventListPageResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(fundingEventListPageResponse: FundingEventListPageResponse) = apply {
            data = fundingEventListPageResponse.data.map { it.toMutableList() }
            hasMore = fundingEventListPageResponse.hasMore
            additionalProperties = fundingEventListPageResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [FundingEventListPageResponse].
         *
         ...
         */
        fun build(): FundingEventListPageResponse =
            FundingEventListPageResponse(
    ...
    fun validate(): FundingEventListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is FundingEventListPageResponse && data == other.data && hasMore == other.hasMore && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "FundingEventListPageResponse{data=$data, hasMore=$hasMore, additionalProperties=$additionalProperties}"
}
