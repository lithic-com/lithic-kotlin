...
private constructor(
     ...
     */
    fun accountScore(): String? = accountScore.getNullable("account_score")
     ...
     *   server responded with an unexpected value).
     */
    fun deviceScore(): String? = deviceScore.getNullable("device_score")
     ...
     *   server responded with an unexpected value).
     */
    fun recommendedDecision(): String? = recommendedDecision.getNullable("recommended_decision")
     ...
     *   server responded with an unexpected value).
     */
    fun recommendationReasons(): List<String>? =
        recommendationReasons.getNullable("recommendation_reasons")
    ...
    internal fun validity(): Int =
        (if (accountScore.asKnown() == null) 0 else 1) +
            ...
            (if (recommendedDecision.asKnown() == null) 0 else 1) +
            (recommendationReasons.asKnown()?.size ?: 0)
