 ...
 */
class AuthenticationSimulateParams
private constructor(
     ...
     */
    fun cardExpiryCheck(): CardExpiryCheck? = body.cardExpiryCheck()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AuthenticationSimulateParams].
         *
    ...
    /** A builder for [AuthenticationSimulateParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(authenticationSimulateParams: AuthenticationSimulateParams) = apply {
            body = authenticationSimulateParams.body.toBuilder()
            additionalHeaders = authenticationSimulateParams.additionalHeaders.toBuilder()
            additionalQueryParams = authenticationSimulateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AuthenticationSimulateParams].
         *
         ...
         */
        fun build(): AuthenticationSimulateParams =
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun cardExpiryCheck(): CardExpiryCheck? = cardExpiryCheck.getNullable("card_expiry_check")
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AuthenticationSimulateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "AuthenticationSimulateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
