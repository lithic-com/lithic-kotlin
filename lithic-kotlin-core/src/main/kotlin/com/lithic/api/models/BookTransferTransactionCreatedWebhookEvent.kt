...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun transactionSeries(): BookTransferResponse.TransactionSeries? =
    ...
    /** A builder for [BookTransferTransactionCreatedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            bookTransferTransactionCreatedWebhookEvent: BookTransferTransactionCreatedWebhookEvent
        ) = apply {
            token = bookTransferTransactionCreatedWebhookEvent.token
            category = bookTransferTransactionCreatedWebhookEvent.category
            created = bookTransferTransactionCreatedWebhookEvent.created
            currency = bookTransferTransactionCreatedWebhookEvent.currency
            events = bookTransferTransactionCreatedWebhookEvent.events.map { it.toMutableList() }
            family = bookTransferTransactionCreatedWebhookEvent.family
            fromFinancialAccountToken =
                bookTransferTransactionCreatedWebhookEvent.fromFinancialAccountToken
            pendingAmount = bookTransferTransactionCreatedWebhookEvent.pendingAmount
            result = bookTransferTransactionCreatedWebhookEvent.result
            settledAmount = bookTransferTransactionCreatedWebhookEvent.settledAmount
            status = bookTransferTransactionCreatedWebhookEvent.status
            toFinancialAccountToken =
                bookTransferTransactionCreatedWebhookEvent.toFinancialAccountToken
            updated = bookTransferTransactionCreatedWebhookEvent.updated
            externalId = bookTransferTransactionCreatedWebhookEvent.externalId
            externalResource = bookTransferTransactionCreatedWebhookEvent.externalResource
            transactionSeries = bookTransferTransactionCreatedWebhookEvent.transactionSeries
            eventType = bookTransferTransactionCreatedWebhookEvent.eventType
            additionalProperties =
                bookTransferTransactionCreatedWebhookEvent.additionalProperties.toMutableMap()
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BookTransferTransactionCreatedWebhookEvent &&
            token == other.token &&
