...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is FinancialAccountStatementListPageAsync && this.statementsService == other.statementsService && this.params == other.params && this.response == other.response /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(statementsService, params, response) /* spotless:on */
    }
    ...
    constructor(
        ...
        override fun toString() =
            "FinancialAccountStatementListPageAsync.Response{data=$data, hasMore=$hasMore, additionalProperties=$additionalProperties}"
