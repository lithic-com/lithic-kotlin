...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is DisputeCreateParams && this.amount == other.amount && this.reason == other.reason && this.transactionToken == other.transactionToken && this.customerFiledDate == other.customerFiledDate && this.customerNote == other.customerNote && this.additionalQueryParams == other.additionalQueryParams && this.additionalHeaders == other.additionalHeaders && this.additionalBodyProperties == other.additionalBodyProperties /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(amount, reason, transactionToken, customerFiledDate, customerNote, additionalQueryParams, additionalHeaders, additionalBodyProperties) /* spotless:on */
    }
