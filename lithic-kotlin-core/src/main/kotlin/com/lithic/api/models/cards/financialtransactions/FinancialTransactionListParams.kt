...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(financialTransactionListParams: FinancialTransactionListParams) = apply {
            cardToken = financialTransactionListParams.cardToken
    ...
    override fun toString() =
        "FinancialTransactionListParams{cardToken=$cardToken, begin=$begin, category=$category, end=$end, endingBefore=$endingBefore, result=$result, startingAfter=$startingAfter, status=$status, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
