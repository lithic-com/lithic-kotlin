...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(disputeRetrieveResponse: DisputeRetrieveResponse) = apply {
            token = disputeRetrieveResponse.token
            amount = disputeRetrieveResponse.amount
            arbitrationDate = disputeRetrieveResponse.arbitrationDate
            created = disputeRetrieveResponse.created
            customerFiledDate = disputeRetrieveResponse.customerFiledDate
            customerNote = disputeRetrieveResponse.customerNote
            networkClaimIds = disputeRetrieveResponse.networkClaimIds.map { it.toMutableList() }
            networkFiledDate = disputeRetrieveResponse.networkFiledDate
            networkReasonCode = disputeRetrieveResponse.networkReasonCode
            prearbitrationDate = disputeRetrieveResponse.prearbitrationDate
            primaryClaimId = disputeRetrieveResponse.primaryClaimId
            reason = disputeRetrieveResponse.reason
            representmentDate = disputeRetrieveResponse.representmentDate
            resolutionDate = disputeRetrieveResponse.resolutionDate
            resolutionNote = disputeRetrieveResponse.resolutionNote
            resolutionReason = disputeRetrieveResponse.resolutionReason
            status = disputeRetrieveResponse.status
            transactionToken = disputeRetrieveResponse.transactionToken
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DisputeRetrieveResponse &&
            token == other.token &&
            amount == other.amount &&
