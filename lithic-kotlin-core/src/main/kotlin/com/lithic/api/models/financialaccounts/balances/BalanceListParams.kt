...
package com.lithic.api.models.financialaccounts.balances
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(balanceListParams: BalanceListParams) = apply {
            financialAccountToken = balanceListParams.financialAccountToken
            balanceDate = balanceListParams.balanceDate
            lastTransactionEventToken = balanceListParams.lastTransactionEventToken
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is BalanceListParams && financialAccountToken == other.financialAccountToken && balanceDate == other.balanceDate && lastTransactionEventToken == other.lastTransactionEventToken && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "BalanceListParams{financialAccountToken=$financialAccountToken, balanceDate=$balanceDate, lastTransactionEventToken=$lastTransactionEventToken, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
