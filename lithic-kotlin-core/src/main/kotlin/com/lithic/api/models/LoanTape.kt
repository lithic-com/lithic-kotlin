...
private constructor(
    ...
    private constructor(
         ...
         */
        internal fun validity(): Int =
            (due.asKnown()?.validity() ?: 0) +
                (nextStatementDue.asKnown()?.validity() ?: 0) +
                (pastDue.asKnown()?.validity() ?: 0) +
                (pastStatementsDue.asKnown()?.validity() ?: 0)
    ...
    private constructor(
         ...
         */
        internal fun validity(): Int =
            (if (amount.asKnown() == null) 0 else 1) + (if (remaining.asKnown() == null) 0 else 1)
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun feeDetails(): CategoryDetails? = feeDetails.getNullable("fee_details")
         ...
         *   server responded with an unexpected value).
         */
        fun interestDetails(): CategoryDetails? = interestDetails.getNullable("interest_details")
         ...
         *   server responded with an unexpected value).
         */
        fun principalDetails(): CategoryDetails? = principalDetails.getNullable("principal_details")
         ...
         */
        internal fun validity(): Int =
            (feeDetails.asKnown()?.validity() ?: 0) +
                (if (fees.asKnown() == null) 0 else 1) +
                (if (interest.asKnown() == null) 0 else 1) +
                (interestDetails.asKnown()?.validity() ?: 0) +
                (if (principal.asKnown() == null) 0 else 1) +
                (principalDetails.asKnown()?.validity() ?: 0)
