...
private constructor(
    ...
    class Builder {
        ...
        internal fun from(v2DraftResponse: V2DraftResponse) = apply {
            this.token = v2DraftResponse.token
            this.state = v2DraftResponse.state
            this.programLevel = v2DraftResponse.programLevel
            this.cardTokens = v2DraftResponse.cardTokens
            this.accountTokens = v2DraftResponse.accountTokens
            this.type = v2DraftResponse.type
            this.currentVersion = v2DraftResponse.currentVersion
            this.draftVersion = v2DraftResponse.draftVersion
            additionalProperties(v2DraftResponse.additionalProperties)
        }
    ...
    override fun toString() =
        "V2DraftResponse{token=$token, state=$state, programLevel=$programLevel, cardTokens=$cardTokens, accountTokens=$accountTokens, type=$type, currentVersion=$currentVersion, draftVersion=$draftVersion, additionalProperties=$additionalProperties}"
}
