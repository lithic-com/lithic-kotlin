...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [V2DraftResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(v2DraftResponse: V2DraftResponse) = apply {
            ...
            accountTokens = v2DraftResponse.accountTokens.map { it.toMutableList() }
            businessAccountTokens = v2DraftResponse.businessAccountTokens.map { it.toMutableList() }
            cardTokens = v2DraftResponse.cardTokens.map { it.toMutableList() }
            currentVersion = v2DraftResponse.currentVersion
            draftVersion = v2DraftResponse.draftVersion
            eventStream = v2DraftResponse.eventStream
            lithicManaged = v2DraftResponse.lithicManaged
            name = v2DraftResponse.name
            programLevel = v2DraftResponse.programLevel
            state = v2DraftResponse.state
            type = v2DraftResponse.type
            excludedCardTokens = v2DraftResponse.excludedCardTokens.map { it.toMutableList() }
        ...
        /**
         * Returns an immutable instance of [V2DraftResponse].
         *
    ...
    override fun toString() =
        "V2DraftResponse{token=$token, accountTokens=$accountTokens, businessAccountTokens=$businessAccountTokens, cardTokens=$cardTokens, currentVersion=$currentVersion, draftVersion=$draftVersion, eventStream=$eventStream, lithicManaged=$lithicManaged, name=$name, programLevel=$programLevel, state=$state, type=$type, excludedCardTokens=$excludedCardTokens, additionalProperties=$additionalProperties}"
}
