...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun serverSessionId(): String? = body.serverSessionId()
    ...
    companion object {
        ...
        fun none(): CardWebProvisionParams = builder().build()
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun serverSessionId(): String? = serverSessionId.getNullable("server_session_id")
        ...
        internal fun validity(): Int =
            (if (clientDeviceId.asKnown() == null) 0 else 1) +
                (if (clientWalletAccountId.asKnown() == null) 0 else 1) +
                (digitalWallet.asKnown()?.validity() ?: 0) +
                (if (serverSessionId.asKnown() == null) 0 else 1)
