...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is BookTransferListPage && this.bookTransfersService == other.bookTransfersService && this.params == other.params && this.response == other.response /* spotless:on */
    }
    ...
    fun getNextPage(): BookTransferListPage? {
    ...
    constructor(
        ...
        @JsonProperty("data") fun _data(): JsonField<List<BookTransferResponse>>? = data
        ...
        override fun toString() =
            "BookTransferListPage.Response{data=$data, hasMore=$hasMore, additionalProperties=$additionalProperties}"
