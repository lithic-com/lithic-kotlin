...
private constructor(
     ...
     */
    fun actionCounts(): ActionCounts? = actionCounts.getNullable("action_counts")
     ...
     *   server responded with an unexpected value).
     */
    @Deprecated("deprecated") fun approved(): Long? = approved.getNullable("approved")
     ...
     *   server responded with an unexpected value).
     */
    @Deprecated("deprecated") fun challenged(): Long? = challenged.getNullable("challenged")
     ...
     *   server responded with an unexpected value).
     */
    @Deprecated("deprecated") fun declined(): Long? = declined.getNullable("declined")
     ...
     *   server responded with an unexpected value).
     */
    fun examples(): List<Example>? = examples.getNullable("examples")
    ...
    class Builder internal constructor() {
         ...
         */
        fun actionCounts(actionCounts: ActionCounts) = actionCounts(JsonField.of(actionCounts))

        /**
         * Sets [Builder.actionCounts] to an arbitrary JSON value.
         *
         * You should usually call [Builder.actionCounts] with a well-typed [ActionCounts] value
    ...
    fun validate(): ReportStats = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (actionCounts.asKnown()?.validity() ?: 0) +
            (if (approved.asKnown() == null) 0 else 1) +
            (if (challenged.asKnown() == null) 0 else 1) +
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is ActionCounts && additionalProperties == other.additionalProperties
        }
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        @Deprecated("deprecated") fun approved(): Boolean? = approved.getNullable("approved")
         ...
         *   server responded with an unexpected value).
         */
        @Deprecated("deprecated") fun decision(): Decision? = decision.getNullable("decision")
        ...
        private constructor(
            ...
            fun resultAuthentication3ds(): ResultAuthentication3dsAction? = resultAuthentication3ds
            ...
            private constructor(
                 ...
                 */
                internal fun validity(): Int =
                    (code.asKnown()?.validity() ?: 0) + (type.asKnown()?.validity() ?: 0)
            ...
            private constructor(
                ...
                class Builder internal constructor() {
                    ...
                    internal fun from(
                        ...
                        additionalProperties =
                            resultAuthentication3dsAction.additionalProperties.toMutableMap()
                    }
            ...
            private constructor(
                 ...
                 */
                internal fun validity(): Int =
                    (type.asKnown()?.validity() ?: 0) + (reason.asKnown()?.validity() ?: 0)
