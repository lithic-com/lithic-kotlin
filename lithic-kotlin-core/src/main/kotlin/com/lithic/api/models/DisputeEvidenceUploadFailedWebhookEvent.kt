...
private constructor(
    ...
    private val uploadStatus: JsonField<DisputeEvidence.UploadStatus>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        uploadStatus: JsonField<DisputeEvidence.UploadStatus> = JsonMissing.of(),
    ...
    fun toDisputeEvidence(): DisputeEvidence =
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun uploadStatus(): DisputeEvidence.UploadStatus = uploadStatus.getRequired("upload_status")
    ...
    @JsonProperty("upload_status")
    @ExcludeMissing
    fun _uploadStatus(): JsonField<DisputeEvidence.UploadStatus> = uploadStatus
    ...
    /** A builder for [DisputeEvidenceUploadFailedWebhookEvent]. */
    class Builder internal constructor() {

        private var token: JsonField<String>? = null
        private var created: JsonField<OffsetDateTime>? = null
        private var disputeToken: JsonField<String>? = null
        private var uploadStatus: JsonField<DisputeEvidence.UploadStatus>? = null
        ...
        internal fun from(
            disputeEvidenceUploadFailedWebhookEvent: DisputeEvidenceUploadFailedWebhookEvent
        ) = apply {
            token = disputeEvidenceUploadFailedWebhookEvent.token
            created = disputeEvidenceUploadFailedWebhookEvent.created
            disputeToken = disputeEvidenceUploadFailedWebhookEvent.disputeToken
            uploadStatus = disputeEvidenceUploadFailedWebhookEvent.uploadStatus
            downloadUrl = disputeEvidenceUploadFailedWebhookEvent.downloadUrl
            filename = disputeEvidenceUploadFailedWebhookEvent.filename
            uploadUrl = disputeEvidenceUploadFailedWebhookEvent.uploadUrl
            eventType = disputeEvidenceUploadFailedWebhookEvent.eventType
            additionalProperties =
                disputeEvidenceUploadFailedWebhookEvent.additionalProperties.toMutableMap()
        }
         ...
         * * `UPLOADED` - Evidence was uploaded.
         */
        fun uploadStatus(uploadStatus: DisputeEvidence.UploadStatus) =
            uploadStatus(JsonField.of(uploadStatus))

        /**
         * Sets [Builder.uploadStatus] to an arbitrary JSON value.
         *
         * You should usually call [Builder.uploadStatus] with a well-typed
         * [DisputeEvidence.UploadStatus] value instead. This method is primarily for setting the
         * field to an undocumented or not yet supported value.
         */
        fun uploadStatus(uploadStatus: JsonField<DisputeEvidence.UploadStatus>) = apply {
        ...
        /**
         * Returns an immutable instance of [DisputeEvidenceUploadFailedWebhookEvent].
         *
    ...
    fun validate(): DisputeEvidenceUploadFailedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DisputeEvidenceUploadFailedWebhookEvent &&
            token == other.token &&
    ...
    override fun toString() =
        "DisputeEvidenceUploadFailedWebhookEvent{token=$token, created=$created, disputeToken=$disputeToken, uploadStatus=$uploadStatus, downloadUrl=$downloadUrl, filename=$filename, uploadUrl=$uploadUrl, eventType=$eventType, additionalProperties=$additionalProperties}"
}
