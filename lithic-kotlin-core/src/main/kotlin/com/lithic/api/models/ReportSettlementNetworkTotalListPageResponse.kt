...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            data = reportSettlementNetworkTotalListPageResponse.data.map { it.toMutableList() }
            hasMore = reportSettlementNetworkTotalListPageResponse.hasMore
        ...
        /**
         * Returns an immutable instance of [ReportSettlementNetworkTotalListPageResponse].
         *
         ...
         */
        fun build(): ReportSettlementNetworkTotalListPageResponse =
            ReportSettlementNetworkTotalListPageResponse(
    ...
    fun validate(): ReportSettlementNetworkTotalListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ReportSettlementNetworkTotalListPageResponse && data == other.data && hasMore == other.hasMore && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "ReportSettlementNetworkTotalListPageResponse{data=$data, hasMore=$hasMore, additionalProperties=$additionalProperties}"
}
