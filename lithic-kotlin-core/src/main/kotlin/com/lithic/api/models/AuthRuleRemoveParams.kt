...
constructor(
    ...
    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(accountTokens, cardTokens, programLevel, additionalHeaders, additionalQueryParams, additionalBodyProperties) /* spotless:on */
    }

    override fun toString() =
        "AuthRuleRemoveParams{accountTokens=$accountTokens, cardTokens=$cardTokens, programLevel=$programLevel, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
