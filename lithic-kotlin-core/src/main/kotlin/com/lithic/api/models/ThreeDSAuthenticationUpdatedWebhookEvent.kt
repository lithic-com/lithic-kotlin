...
private constructor(
    ...
    /** A builder for [ThreeDSAuthenticationUpdatedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            threeDSAuthenticationUpdatedWebhookEvent: ThreeDSAuthenticationUpdatedWebhookEvent
        ) = apply {
            token = threeDSAuthenticationUpdatedWebhookEvent.token
            accountType = threeDSAuthenticationUpdatedWebhookEvent.accountType
            authenticationResult = threeDSAuthenticationUpdatedWebhookEvent.authenticationResult
            cardExpiryCheck = threeDSAuthenticationUpdatedWebhookEvent.cardExpiryCheck
            cardToken = threeDSAuthenticationUpdatedWebhookEvent.cardToken
            cardholder = threeDSAuthenticationUpdatedWebhookEvent.cardholder
            channel = threeDSAuthenticationUpdatedWebhookEvent.channel
            created = threeDSAuthenticationUpdatedWebhookEvent.created
            merchant = threeDSAuthenticationUpdatedWebhookEvent.merchant
            messageCategory = threeDSAuthenticationUpdatedWebhookEvent.messageCategory
            threeDSRequestorChallengeIndicator =
                threeDSAuthenticationUpdatedWebhookEvent.threeDSRequestorChallengeIndicator
            additionalData = threeDSAuthenticationUpdatedWebhookEvent.additionalData
            app = threeDSAuthenticationUpdatedWebhookEvent.app
            authenticationRequestType =
                threeDSAuthenticationUpdatedWebhookEvent.authenticationRequestType
            browser = threeDSAuthenticationUpdatedWebhookEvent.browser
            challengeMetadata = threeDSAuthenticationUpdatedWebhookEvent.challengeMetadata
            challengeOrchestratedBy =
            ...
            additionalProperties =
                threeDSAuthenticationUpdatedWebhookEvent.additionalProperties.toMutableMap()
        }
    ...
    fun validate(): ThreeDSAuthenticationUpdatedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    class EventType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val THREE_DS_AUTHENTICATION_UPDATED = of("three_ds_authentication.updated")
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ThreeDSAuthenticationUpdatedWebhookEvent &&
            token == other.token &&
