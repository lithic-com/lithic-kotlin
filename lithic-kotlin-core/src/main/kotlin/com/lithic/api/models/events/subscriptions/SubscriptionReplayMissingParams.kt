 ...
 */
class SubscriptionReplayMissingParams
private constructor(
    ...
    /** A builder for [SubscriptionReplayMissingParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(subscriptionReplayMissingParams: SubscriptionReplayMissingParams) =
            apply {
                eventSubscriptionToken = subscriptionReplayMissingParams.eventSubscriptionToken
                begin = subscriptionReplayMissingParams.begin
                end = subscriptionReplayMissingParams.end
                additionalHeaders = subscriptionReplayMissingParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    subscriptionReplayMissingParams.additionalQueryParams.toBuilder()
                additionalBodyProperties =
                    subscriptionReplayMissingParams.additionalBodyProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SubscriptionReplayMissingParams].
         *
         ...
         */
        fun build(): SubscriptionReplayMissingParams =
            SubscriptionReplayMissingParams(
    ...
    override fun toString() =
        "SubscriptionReplayMissingParams{eventSubscriptionToken=$eventSubscriptionToken, begin=$begin, end=$end, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
