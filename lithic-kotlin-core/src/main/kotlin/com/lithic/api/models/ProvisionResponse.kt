...
private constructor(
     ...
     */
    fun activationData(): String? = activationData.getNullable("activationData")

    /**
     * @throws LithicInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun encryptedData(): String? = encryptedData.getNullable("encryptedData")

    /**
     * @throws LithicInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun ephemeralPublicKey(): String? = ephemeralPublicKey.getNullable("ephemeralPublicKey")
    ...
    internal fun validity(): Int =
        (if (activationData.asKnown() == null) 0 else 1) +
            (if (encryptedData.asKnown() == null) 0 else 1) +
            (if (ephemeralPublicKey.asKnown() == null) 0 else 1)
