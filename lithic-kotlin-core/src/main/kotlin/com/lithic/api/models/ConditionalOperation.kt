...
class ConditionalOperation @JsonCreator private constructor(private val value: JsonField<String>) :
    ...
    companion object {
        ...
        val CONTAINS_ANY = of("CONTAINS_ANY")

        val CONTAINS_ALL = of("CONTAINS_ALL")

        val CONTAINS_NONE = of("CONTAINS_NONE")

        fun of(value: String) = ConditionalOperation(JsonField.of(value))
    }
