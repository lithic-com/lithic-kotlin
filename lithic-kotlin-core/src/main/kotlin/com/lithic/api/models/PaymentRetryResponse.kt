...
private constructor(
    ...
    /** A builder for [PaymentRetryResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(paymentRetryResponse: PaymentRetryResponse) = apply {
            ...
            relatedAccountTokens = paymentRetryResponse.relatedAccountTokens
            ...
            blockchainRecipientToken = paymentRetryResponse.blockchainRecipientToken
        ...
        /**
         * Returns an immutable instance of [PaymentRetryResponse].
         *
