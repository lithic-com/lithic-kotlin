...
private constructor(
    ...
    private constructor(
        ...
        fun rejectedEntityStatusReasons(): List<String>? =
            rejectedEntityStatusReasons.getNullable("rejected_entity_status_reasons")
         ...
         *   server responded with an unexpected value).
         */
        fun status(): DocumentUploadStatus? = status.getNullable("status")

        /**
         * @throws LithicInvalidDataException if the JSON field has an unexpected type (e.g. if the
         *   server responded with an unexpected value).
         */
        fun statusReasons(): List<String>? = statusReasons.getNullable("status_reasons")
