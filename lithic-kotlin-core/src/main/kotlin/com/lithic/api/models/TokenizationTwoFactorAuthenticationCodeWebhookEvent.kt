...
private constructor(
    ...
    private val authenticationCode: JsonField<String>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        authenticationCode: JsonField<String> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun authenticationCode(): String = authenticationCode.getRequired("authentication_code")
     ...
     *
     * Unlike [authenticationCode], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("authentication_code")
    @ExcludeMissing
    fun _authenticationCode(): JsonField<String> = authenticationCode
    ...
    /** A builder for [TokenizationTwoFactorAuthenticationCodeWebhookEvent]. */
    class Builder internal constructor() {

        private var accountToken: JsonField<String>? = null
        private var activationMethod: JsonField<ActivationMethod>? = null
        private var authenticationCode: JsonField<String>? = null
        ...
        internal fun from(
            ...
            accountToken = tokenizationTwoFactorAuthenticationCodeWebhookEvent.accountToken
            activationMethod = tokenizationTwoFactorAuthenticationCodeWebhookEvent.activationMethod
            authenticationCode =
                tokenizationTwoFactorAuthenticationCodeWebhookEvent.authenticationCode
            cardToken = tokenizationTwoFactorAuthenticationCodeWebhookEvent.cardToken
            created = tokenizationTwoFactorAuthenticationCodeWebhookEvent.created
            eventType = tokenizationTwoFactorAuthenticationCodeWebhookEvent.eventType
            tokenizationToken =
                tokenizationTwoFactorAuthenticationCodeWebhookEvent.tokenizationToken
            additionalProperties =
                tokenizationTwoFactorAuthenticationCodeWebhookEvent.additionalProperties
                    .toMutableMap()
        }
        ...
        /** Authentication code to provide to the user tokenizing a card. */
        fun authenticationCode(authenticationCode: String) =
            authenticationCode(JsonField.of(authenticationCode))

        /**
         * Sets [Builder.authenticationCode] to an arbitrary JSON value.
         *
         * You should usually call [Builder.authenticationCode] with a well-typed [String] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun authenticationCode(authenticationCode: JsonField<String>) = apply {
         ...
         */
        fun build(): TokenizationTwoFactorAuthenticationCodeWebhookEvent =
            TokenizationTwoFactorAuthenticationCodeWebhookEvent(
                checkRequired("accountToken", accountToken),
                checkRequired("activationMethod", activationMethod),
                checkRequired("authenticationCode", authenticationCode),
    ...
    fun validate(): TokenizationTwoFactorAuthenticationCodeWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (if (accountToken.asKnown() == null) 0 else 1) +
            (activationMethod.asKnown()?.validity() ?: 0) +
            (if (authenticationCode.asKnown() == null) 0 else 1) +
    ...
    private constructor(
        ...
        /**
         * The location where the user wants to receive the authentication code. The format depends
         * on the ActivationMethod.Type field. If Type is Email, the Value will be the email
        ...
        class Builder internal constructor() {
             ...
             * depends on the ActivationMethod.Type field. If Type is Email, the Value will be the
         ...
         */
        internal fun validity(): Int =
            (type.asKnown()?.validity() ?: 0) + (if (value.asKnown() == null) 0 else 1)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TokenizationTwoFactorAuthenticationCodeWebhookEvent &&
            accountToken == other.accountToken &&
            activationMethod == other.activationMethod &&
            authenticationCode == other.authenticationCode &&
    ...
    override fun toString() =
        "TokenizationTwoFactorAuthenticationCodeWebhookEvent{accountToken=$accountToken, activationMethod=$activationMethod, authenticationCode=$authenticationCode, cardToken=$cardToken, created=$created, eventType=$eventType, tokenizationToken=$tokenizationToken, additionalProperties=$additionalProperties}"
}
