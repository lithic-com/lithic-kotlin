...
private constructor(
    ...
    class ShippingMethod @JsonCreator private constructor(private val value: JsonField<String>) :
        ...
        companion object {
            ...
            val EX_US_EXPEDITED_WITH_TRACKING = of("Ex-US expedited with tracking")

            val EX_US_STANDARD_WITH_TRACKING = of("Ex-US standard with tracking")

            val EX_US_STANDARD_WITHOUT_TRACKING = of("Ex-US standard without tracking")

            val FED_EX_2_DAYS = of("FedEx 2 days")

            val FED_EX_EXPRESS = of("FedEx express")

            val FED_EX_OVERNIGHT = of("FedEx overnight")

            val USPS_PRIORITY = of("USPS priority")

            val USPS_WITH_TRACKING = of("USPS with tracking")

            val USPS_WITHOUT_TRACKING_ENVELOPE = of("USPS without tracking envelope")

            val USPS_WITHOUT_TRACKING_ENVELOPE_NON_MACHINE =
                of("USPS without tracking envelope non-machine")

            val USPS_WITHOUT_TRACKING_FLAT = of("USPS without tracking flat")
