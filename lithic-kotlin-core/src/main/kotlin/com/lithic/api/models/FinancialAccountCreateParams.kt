...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun isForBenefitOf(): Boolean? = body.isForBenefitOf()
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun isForBenefitOf(): Boolean? = isForBenefitOf.getNullable("is_for_benefit_of")
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is CreateFinancialAccountRequest &&
        ...
        private val hashCode: Int by lazy {
            Objects.hash(nickname, type, accountToken, isForBenefitOf, additionalProperties)
        }
