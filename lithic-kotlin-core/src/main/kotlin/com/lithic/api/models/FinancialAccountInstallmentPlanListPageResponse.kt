...
private constructor(
    private val data: JsonField<List<InstallmentPlan>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<InstallmentPlan>> = JsonMissing.of(),
     ...
     */
    fun data(): List<InstallmentPlan> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<InstallmentPlan>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<InstallmentPlan>>? = null
        ...
        fun data(data: List<InstallmentPlan>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<InstallmentPlan>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<InstallmentPlan>>) = apply {
