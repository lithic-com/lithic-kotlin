...
private constructor(
    ...
    /** A builder for [ClaimDocumentRejectedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(claimDocumentRejectedWebhookEvent: ClaimDocumentRejectedWebhookEvent) =
            apply {
                token = claimDocumentRejectedWebhookEvent.token
                created = claimDocumentRejectedWebhookEvent.created
                downloadUrl = claimDocumentRejectedWebhookEvent.downloadUrl
                downloadUrlExpiresAt = claimDocumentRejectedWebhookEvent.downloadUrlExpiresAt
                eventType = claimDocumentRejectedWebhookEvent.eventType
                failureReason = claimDocumentRejectedWebhookEvent.failureReason
                name = claimDocumentRejectedWebhookEvent.name
                requirementId = claimDocumentRejectedWebhookEvent.requirementId
                status = claimDocumentRejectedWebhookEvent.status
                updated = claimDocumentRejectedWebhookEvent.updated
                uploadConstraints = claimDocumentRejectedWebhookEvent.uploadConstraints
                uploadUrl = claimDocumentRejectedWebhookEvent.uploadUrl
                uploadUrlExpiresAt = claimDocumentRejectedWebhookEvent.uploadUrlExpiresAt
                additionalProperties =
                    claimDocumentRejectedWebhookEvent.additionalProperties.toMutableMap()
            }
         ...
         */
        fun build(): ClaimDocumentRejectedWebhookEvent =
            ClaimDocumentRejectedWebhookEvent(
     ...
     *   expected type.
     */
    fun validate(): ClaimDocumentRejectedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ClaimDocumentRejectedWebhookEvent &&
            token == other.token &&
    ...
    override fun toString() =
        "ClaimDocumentRejectedWebhookEvent{token=$token, created=$created, downloadUrl=$downloadUrl, downloadUrlExpiresAt=$downloadUrlExpiresAt, eventType=$eventType, failureReason=$failureReason, name=$name, requirementId=$requirementId, status=$status, updated=$updated, uploadConstraints=$uploadConstraints, uploadUrl=$uploadUrl, uploadUrlExpiresAt=$uploadUrlExpiresAt, additionalProperties=$additionalProperties}"
}
