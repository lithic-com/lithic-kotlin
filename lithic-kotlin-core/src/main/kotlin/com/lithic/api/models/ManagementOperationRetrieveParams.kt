...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ManagementOperationRetrieveParams && this.managementOperationToken == other.managementOperationToken && this.additionalHeaders == other.additionalHeaders && this.additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(managementOperationToken, additionalHeaders, additionalQueryParams) /* spotless:on */
    }
