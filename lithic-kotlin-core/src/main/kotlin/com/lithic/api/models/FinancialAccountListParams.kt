...
constructor(
    ...
    override fun toString() =
        "FinancialAccountListParams{accountToken=$accountToken, businessAccountToken=$businessAccountToken, type=$type, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(financialAccountListParams: FinancialAccountListParams) = apply {
            ...
            additionalBodyProperties(financialAccountListParams.additionalBodyProperties)
        }
