...
class CardConvertPhysicalResponse
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CardConvertPhysicalResponse].
         *
    ...
    /** A builder for [CardConvertPhysicalResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(cardConvertPhysicalResponse: CardConvertPhysicalResponse) = apply {
            token = cardConvertPhysicalResponse.token
            accountToken = cardConvertPhysicalResponse.accountToken
            cardProgramToken = cardConvertPhysicalResponse.cardProgramToken
            created = cardConvertPhysicalResponse.created
            funding = cardConvertPhysicalResponse.funding
            lastFour = cardConvertPhysicalResponse.lastFour
            pinStatus = cardConvertPhysicalResponse.pinStatus
            spendLimit = cardConvertPhysicalResponse.spendLimit
            spendLimitDuration = cardConvertPhysicalResponse.spendLimitDuration
            state = cardConvertPhysicalResponse.state
            type = cardConvertPhysicalResponse.type
            authRuleTokens = cardConvertPhysicalResponse.authRuleTokens.map { it.toMutableList() }
            cardholderCurrency = cardConvertPhysicalResponse.cardholderCurrency
            cvv = cardConvertPhysicalResponse.cvv
            digitalCardArtToken = cardConvertPhysicalResponse.digitalCardArtToken
            expMonth = cardConvertPhysicalResponse.expMonth
            expYear = cardConvertPhysicalResponse.expYear
            hostname = cardConvertPhysicalResponse.hostname
            memo = cardConvertPhysicalResponse.memo
            pan = cardConvertPhysicalResponse.pan
            pendingCommands = cardConvertPhysicalResponse.pendingCommands.map { it.toMutableList() }
            productId = cardConvertPhysicalResponse.productId
            replacementFor = cardConvertPhysicalResponse.replacementFor
            additionalProperties = cardConvertPhysicalResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CardConvertPhysicalResponse].
         *
         ...
         */
        fun build(): CardConvertPhysicalResponse =
    ...
    fun validate(): CardConvertPhysicalResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (if (token.asKnown() == null) 0 else 1) +
            ...
            (if (cardProgramToken.asKnown() == null) 0 else 1) +
            (if (created.asKnown() == null) 0 else 1) +
            (funding.asKnown()?.validity() ?: 0) +
            (if (lastFour.asKnown() == null) 0 else 1) +
            (pinStatus.asKnown()?.validity() ?: 0) +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CardConvertPhysicalResponse && token == other.token && accountToken == other.accountToken && cardProgramToken == other.cardProgramToken && created == other.created && funding == other.funding && lastFour == other.lastFour && pinStatus == other.pinStatus && spendLimit == other.spendLimit && spendLimitDuration == other.spendLimitDuration && state == other.state && type == other.type && authRuleTokens == other.authRuleTokens && cardholderCurrency == other.cardholderCurrency && cvv == other.cvv && digitalCardArtToken == other.digitalCardArtToken && expMonth == other.expMonth && expYear == other.expYear && hostname == other.hostname && memo == other.memo && pan == other.pan && pendingCommands == other.pendingCommands && productId == other.productId && replacementFor == other.replacementFor && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "CardConvertPhysicalResponse{token=$token, accountToken=$accountToken, cardProgramToken=$cardProgramToken, created=$created, funding=$funding, lastFour=$lastFour, pinStatus=$pinStatus, spendLimit=$spendLimit, spendLimitDuration=$spendLimitDuration, state=$state, type=$type, authRuleTokens=$authRuleTokens, cardholderCurrency=$cardholderCurrency, cvv=$cvv, digitalCardArtToken=$digitalCardArtToken, expMonth=$expMonth, expYear=$expYear, hostname=$hostname, memo=$memo, pan=$pan, pendingCommands=$pendingCommands, productId=$productId, replacementFor=$replacementFor, additionalProperties=$additionalProperties}"
}
