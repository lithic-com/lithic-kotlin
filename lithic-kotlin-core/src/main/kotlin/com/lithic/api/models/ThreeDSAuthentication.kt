...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun psd2Context(): Psd2Context? = psd2Context.getNullable("psd2_context")
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is Cardholder &&
                ...
                email == other.email &&
                name == other.name &&
                phoneNumberHome == other.phoneNumberHome &&
        ...
        private constructor(
            ...
            private constructor(private val value: JsonField<String>) : Enum {
                ...
                override fun equals(other: Any?): Boolean {
                    ...
                    return other is DeliveryTimeFrame && value == other.value
                }
            ...
            private constructor(private val value: JsonField<String>) : Enum {
                ...
                override fun equals(other: Any?): Boolean {
                    ...
                    return other is OrderAvailability && value == other.value
                }
            ...
            private constructor(private val value: JsonField<String>) : Enum {
                ...
                override fun equals(other: Any?): Boolean {
                    ...
                    return other is ReorderItems && value == other.value
                }
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return other is RiskIndicator &&
                    deliveryEmailAddress == other.deliveryEmailAddress &&
                    deliveryTimeFrame == other.deliveryTimeFrame &&
                    giftCardAmount == other.giftCardAmount &&
                    giftCardCount == other.giftCardCount &&
                    giftCardCurrency == other.giftCardCurrency &&
                    orderAvailability == other.orderAvailability &&
                    preOrderAvailableDate == other.preOrderAvailableDate &&
                    reorderItems == other.reorderItems &&
    ...
    class MessageCategory @JsonCreator private constructor(private val value: JsonField<String>) :
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is MessageCategory && value == other.value
        }
    ...
    private constructor(private val value: JsonField<String>) : Enum {
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is ThreeDSRequestorChallengeIndicator && value == other.value
        }
    ...
    private constructor(
        ...
        private constructor(private val value: JsonField<String>) : Enum {
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return other is NetworkDecision && value == other.value
            }
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is AdditionalData &&
                networkDecision == other.networkDecision &&
                networkRiskScore == other.networkRiskScore &&
                additionalProperties == other.additionalProperties
        }

        private val hashCode: Int by lazy {
            Objects.hash(networkDecision, networkRiskScore, additionalProperties)
        }
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun device(): String? = device.getNullable("device")
         ...
         *   server responded with an unexpected value).
         */
        fun screenHeight(): Long? = screenHeight.getNullable("screen_height")
         ...
         *   server responded with an unexpected value).
         */
        fun screenWidth(): Long? = screenWidth.getNullable("screen_width")
         ...
         */
        internal fun validity(): Int =
            (if (device.asKnown() == null) 0 else 1) +
                (if (deviceInfo.asKnown() == null) 0 else 1) +
    ...
    private constructor(private val value: JsonField<String>) : Enum {
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is AuthenticationRequestType && value == other.value
        }
    ...
    private constructor(
        ...
        class Status @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
            ...
            companion object {
                ...
                val SMS_DELIVERY_FAILED = of("SMS_DELIVERY_FAILED")

                val CARDHOLDER_TIMEOUT = of("CARDHOLDER_TIMEOUT")

                val CANCELED_VIA_CHALLENGE_UI = of("CANCELED_VIA_CHALLENGE_UI")

                val CANCELED_OOB = of("CANCELED_OOB")

                val ATTEMPTS_EXCEEDED = of("ATTEMPTS_EXCEEDED")
    ...
    private constructor(private val value: JsonField<String>) : Enum {
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is ChallengeOrchestratedBy && value == other.value
        }
    ...
    private constructor(
        ...
        fun acquirerExemption(): AcquirerExemption? =
            acquirerExemption.getNullable("acquirer_exemption")
         ...
         *   server responded with an unexpected value).
         */
        fun lithicExemptionValidation(): LithicExemptionValidation? =
            lithicExemptionValidation.getNullable("lithic_exemption_validation")
        ...
        fun validate(): Psd2Context = apply {
            ...
            lithicExemptionValidation()?.validate()
            validated = true
        }
        ...
        internal fun validity(): Int =
            (acquirerExemption.asKnown()?.validity() ?: 0) +
                (lithicExemptionValidation.asKnown()?.validity() ?: 0)
        ...
        private constructor(private val value: JsonField<String>) : Enum {
            ...
            companion object {
                ...
                val TRUSTED_BENEFICIARY = of("TRUSTED_BENEFICIARY")
        ...
        private constructor(private val value: JsonField<String>) : Enum {
            ...
            companion object {
                ...
                val NOT_VALIDATED = of("NOT_VALIDATED")

                fun of(value: String) = LithicExemptionValidation(JsonField.of(value))
            }
    ...
    private constructor(private val value: JsonField<String>) : Enum {
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is ThreeRiRequestType && value == other.value
        }
