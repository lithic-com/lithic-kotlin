...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BacktestRetrieveParams].
         *
    ...
    /** A builder for [BacktestRetrieveParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(backtestRetrieveParams: BacktestRetrieveParams) = apply {
            authRuleToken = backtestRetrieveParams.authRuleToken
            authRuleBacktestToken = backtestRetrieveParams.authRuleBacktestToken
            additionalHeaders = backtestRetrieveParams.additionalHeaders.toBuilder()
            additionalQueryParams = backtestRetrieveParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [BacktestRetrieveParams].
         *
         ...
         */
        fun build(): BacktestRetrieveParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is BacktestRetrieveParams && authRuleToken == other.authRuleToken && authRuleBacktestToken == other.authRuleBacktestToken && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "BacktestRetrieveParams{authRuleToken=$authRuleToken, authRuleBacktestToken=$authRuleBacktestToken, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
