...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [V2ReportParams].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(v2ReportParams: V2ReportParams) = apply {
            authRuleToken = v2ReportParams.authRuleToken
            additionalHeaders = v2ReportParams.additionalHeaders.toBuilder()
            additionalQueryParams = v2ReportParams.additionalQueryParams.toBuilder()
            additionalBodyProperties = v2ReportParams.additionalBodyProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [V2ReportParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V2ReportParams && authRuleToken == other.authRuleToken && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams && additionalBodyProperties == other.additionalBodyProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "V2ReportParams{authRuleToken=$authRuleToken, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
