...
private constructor(
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun assigned(): Long? = assigned.getNullable("ASSIGNED")
         ...
         *   server responded with an unexpected value).
         */
        fun closed(): Long? = closed.getNullable("CLOSED")
         ...
         *   server responded with an unexpected value).
         */
        fun escalated(): Long? = escalated.getNullable("ESCALATED")
         ...
         *   server responded with an unexpected value).
         */
        fun inReview(): Long? = inReview.getNullable("IN_REVIEW")
         ...
         *   server responded with an unexpected value).
         */
        fun open(): Long? = open.getNullable("OPEN")
         ...
         *   server responded with an unexpected value).
         */
        fun resolved(): Long? = resolved.getNullable("RESOLVED")
         ...
         */
        internal fun validity(): Int =
            (if (assigned.asKnown() == null) 0 else 1) +
                (if (closed.asKnown() == null) 0 else 1) +
                (if (escalated.asKnown() == null) 0 else 1) +
                (if (inReview.asKnown() == null) 0 else 1) +
