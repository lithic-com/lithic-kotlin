...
private constructor(
    ...
    private constructor(
        ...
        fun externallyVerified(): ExternallyVerifiedCreateBankAccountApiRequest? =
            externallyVerified

        fun unverified(): UnverifiedCreateBankAccountApiRequest? = unverified
         ...
         *     override fun visitBankVerifiedCreateBankAccountApiRequest(bankVerifiedCreateBankAccountApiRequest: BankVerifiedCreateBankAccountApiRequest): String? = bankVerifiedCreateBankAccountApiRequest.toString()
         *
         *     // ...
         *
        ...
        override fun hashCode(): Int =
            Objects.hash(bankVerifiedCreateBankAccountApiRequest, externallyVerified, unverified)
        ...
        private constructor(
            ...
            internal fun validity(): Int =
                (if (accountNumber.asKnown() == null) 0 else 1) +
                    ...
                    (if (verificationEnforcement.asKnown() == null) 0 else 1)
