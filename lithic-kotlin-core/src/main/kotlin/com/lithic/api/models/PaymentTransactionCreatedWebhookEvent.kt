...
private constructor(
    ...
    /** A builder for [PaymentTransactionCreatedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            paymentTransactionCreatedWebhookEvent: PaymentTransactionCreatedWebhookEvent
        ) = apply {
            token = paymentTransactionCreatedWebhookEvent.token
            category = paymentTransactionCreatedWebhookEvent.category
            created = paymentTransactionCreatedWebhookEvent.created
            descriptor = paymentTransactionCreatedWebhookEvent.descriptor
            direction = paymentTransactionCreatedWebhookEvent.direction
            events = paymentTransactionCreatedWebhookEvent.events.map { it.toMutableList() }
            family = paymentTransactionCreatedWebhookEvent.family
            financialAccountToken = paymentTransactionCreatedWebhookEvent.financialAccountToken
            method = paymentTransactionCreatedWebhookEvent.method
            methodAttributes = paymentTransactionCreatedWebhookEvent.methodAttributes
            pendingAmount = paymentTransactionCreatedWebhookEvent.pendingAmount
            relatedAccountTokens = paymentTransactionCreatedWebhookEvent.relatedAccountTokens
            result = paymentTransactionCreatedWebhookEvent.result
            settledAmount = paymentTransactionCreatedWebhookEvent.settledAmount
            source = paymentTransactionCreatedWebhookEvent.source
            status = paymentTransactionCreatedWebhookEvent.status
            updated = paymentTransactionCreatedWebhookEvent.updated
            blockchainRecipientToken =
                paymentTransactionCreatedWebhookEvent.blockchainRecipientToken
            currency = paymentTransactionCreatedWebhookEvent.currency
            ...
            additionalProperties =
                paymentTransactionCreatedWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PaymentTransactionCreatedWebhookEvent].
         *
     ...
     *   expected type.
     */
    fun validate(): PaymentTransactionCreatedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PaymentTransactionCreatedWebhookEvent &&
            token == other.token &&
