    ...
    private constructor(
        ...
        internal fun validity(): Int =
            (if (companyId.asKnown() == null) 0 else 1) +
                (dailyLimit.asKnown()?.validity() ?: 0) +
                (if (date.asKnown() == null) 0 else 1) +
                (if (isFbo.asKnown() == null) 0 else 1) +
                (monthlyLimit.asKnown()?.validity() ?: 0) +
                (programLimitPerTransaction.asKnown()?.validity() ?: 0)
        ...
        private constructor(
             ...
             */
            internal fun validity(): Int =
                (credit.asKnown()?.validity() ?: 0) + (debit.asKnown()?.validity() ?: 0)
            ...
            private constructor(
                 ...
                 */
                fun amountOriginated(): Long? = amountOriginated.getNullable("amount_originated")
                ...
                internal fun validity(): Int =
                    (if (limit.asKnown() == null) 0 else 1) +
                        (if (amountOriginated.asKnown() == null) 0 else 1)
