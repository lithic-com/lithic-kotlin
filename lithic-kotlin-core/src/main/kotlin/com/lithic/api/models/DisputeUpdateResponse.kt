...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DisputeUpdateResponse].
         *
    ...
    /** A builder for [DisputeUpdateResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(disputeUpdateResponse: DisputeUpdateResponse) = apply {
            token = disputeUpdateResponse.token
            amount = disputeUpdateResponse.amount
            arbitrationDate = disputeUpdateResponse.arbitrationDate
            created = disputeUpdateResponse.created
            customerFiledDate = disputeUpdateResponse.customerFiledDate
            customerNote = disputeUpdateResponse.customerNote
            networkClaimIds = disputeUpdateResponse.networkClaimIds.map { it.toMutableList() }
            networkFiledDate = disputeUpdateResponse.networkFiledDate
            networkReasonCode = disputeUpdateResponse.networkReasonCode
            prearbitrationDate = disputeUpdateResponse.prearbitrationDate
            primaryClaimId = disputeUpdateResponse.primaryClaimId
            reason = disputeUpdateResponse.reason
            representmentDate = disputeUpdateResponse.representmentDate
            resolutionDate = disputeUpdateResponse.resolutionDate
            resolutionNote = disputeUpdateResponse.resolutionNote
            resolutionReason = disputeUpdateResponse.resolutionReason
            status = disputeUpdateResponse.status
            transactionToken = disputeUpdateResponse.transactionToken
            additionalProperties = disputeUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DisputeUpdateResponse].
         *
         ...
         */
        fun build(): DisputeUpdateResponse =
    ...
    fun validate(): DisputeUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DisputeUpdateResponse &&
            token == other.token &&
            amount == other.amount &&
