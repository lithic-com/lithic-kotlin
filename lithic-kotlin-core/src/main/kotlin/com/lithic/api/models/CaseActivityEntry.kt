...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun newValue(): String? = newValue.getNullable("new_value")
     ...
     *   server responded with an unexpected value).
     */
    fun previousValue(): String? = previousValue.getNullable("previous_value")
    ...
    internal fun validity(): Int =
        (if (token.asKnown() == null) 0 else 1) +
            ...
            (if (newValue.asKnown() == null) 0 else 1) +
            (if (previousValue.asKnown() == null) 0 else 1)
