...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CreditProductExtendedCreditRetrieveParams && this.creditProductId == other.creditProductId && this.additionalQueryParams == other.additionalQueryParams && this.additionalHeaders == other.additionalHeaders /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(creditProductId, additionalQueryParams, additionalHeaders) /* spotless:on */
    }

    override fun toString() =
        "CreditProductExtendedCreditRetrieveParams{creditProductId=$creditProductId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
