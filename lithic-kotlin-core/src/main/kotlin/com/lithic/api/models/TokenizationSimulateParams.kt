...
private constructor(
    ...
    fun walletRecommendedDecision(): WalletRecommendedDecision? = body.walletRecommendedDecision()
    ...
    internal fun getBody(): TokenizationSimulateBody = body
    ...
    internal constructor(
         ...
         */
        fun accountScore(): Long? = accountScore.getNullable("account_score")

        /**
         * The device score (1-5) that represents how the Digital Wallet's view on how reputable an
         * end user's device is.
         */
        fun deviceScore(): Long? = deviceScore.getNullable("device_score")
         ...
         */
        fun entity(): String? = entity.getNullable("entity")

        /** The decision that the Digital Wallet's recommend */
        fun walletRecommendedDecision(): WalletRecommendedDecision? =
