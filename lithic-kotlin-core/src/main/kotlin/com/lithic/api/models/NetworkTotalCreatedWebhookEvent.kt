...
class NetworkTotalCreatedWebhookEvent
...
private constructor(
    ...
    /** A builder for [NetworkTotalCreatedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(networkTotalCreatedWebhookEvent: NetworkTotalCreatedWebhookEvent) =
            apply {
                token = networkTotalCreatedWebhookEvent.token
                amounts = networkTotalCreatedWebhookEvent.amounts
                created = networkTotalCreatedWebhookEvent.created
                currency = networkTotalCreatedWebhookEvent.currency
                institutionId = networkTotalCreatedWebhookEvent.institutionId
                isComplete = networkTotalCreatedWebhookEvent.isComplete
                network = networkTotalCreatedWebhookEvent.network
                reportDate = networkTotalCreatedWebhookEvent.reportDate
                settlementInstitutionId = networkTotalCreatedWebhookEvent.settlementInstitutionId
                settlementService = networkTotalCreatedWebhookEvent.settlementService
                updated = networkTotalCreatedWebhookEvent.updated
                cycle = networkTotalCreatedWebhookEvent.cycle
                eventType = networkTotalCreatedWebhookEvent.eventType
                additionalProperties =
                    networkTotalCreatedWebhookEvent.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [NetworkTotalCreatedWebhookEvent].
         *
         ...
         */
        fun build(): NetworkTotalCreatedWebhookEvent =
            NetworkTotalCreatedWebhookEvent(
    ...
    fun validate(): NetworkTotalCreatedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (if (token.asKnown() == null) 0 else 1) +
            ...
            (if (settlementService.asKnown() == null) 0 else 1) +
    ...
    class EventType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val NETWORK_TOTAL_CREATED = of("network_total.created")
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is NetworkTotalCreatedWebhookEvent &&
            token == other.token &&
