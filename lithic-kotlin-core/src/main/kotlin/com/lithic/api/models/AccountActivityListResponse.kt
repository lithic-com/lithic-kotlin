...
private constructor(
     ...
     * import com.lithic.api.core.JsonValue
     *
     * val result: String? = accountActivityListResponse.accept(object : AccountActivityListResponse.Visitor<String?> {
    ...
    companion object {
        ...
        /** Card transaction with ledger base properties */
        fun ofCard(card: CardTransaction) = AccountActivityListResponse(card = card)

        /** Payment transaction */
        fun ofPayment(payment: Payment) = AccountActivityListResponse(payment = payment)
