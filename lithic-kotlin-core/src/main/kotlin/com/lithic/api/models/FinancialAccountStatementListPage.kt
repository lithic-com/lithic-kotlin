...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is FinancialAccountStatementListPage && this.statementsService == other.statementsService && this.params == other.params && this.response == other.response /* spotless:on */
    }
