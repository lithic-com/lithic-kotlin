...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun creditConfiguration(): FinancialAccount.FinancialAccountCreditConfig? =
     ...
     *   server responded with an unexpected value).
     */
    fun blockchainAddresses(): FinancialAccount.BlockchainAddresses? =
    ...
    /** A builder for [FinancialAccountCreatedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            financialAccountCreatedWebhookEvent: FinancialAccountCreatedWebhookEvent
        ) = apply {
            token = financialAccountCreatedWebhookEvent.token
            accountToken = financialAccountCreatedWebhookEvent.accountToken
            created = financialAccountCreatedWebhookEvent.created
            creditConfiguration = financialAccountCreatedWebhookEvent.creditConfiguration
        ...
        /**
         * Returns an immutable instance of [FinancialAccountCreatedWebhookEvent].
         *
     ...
     *   expected type.
     */
    fun validate(): FinancialAccountCreatedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (if (token.asKnown() == null) 0 else 1) +
            ...
            (creditConfiguration.asKnown()?.validity() ?: 0) +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FinancialAccountCreatedWebhookEvent &&
            token == other.token &&
