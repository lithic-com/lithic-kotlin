...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is DisputeListPageAsync && this.disputesService == other.disputesService && this.params == other.params && this.response == other.response /* spotless:on */
    }
    ...
    fun getNextPageParams(): DisputeListParams? {
        ...
        return if (params.endingBefore() != null) {
            DisputeListParams.builder().from(params).endingBefore(data().first().token()).build()
        } else {
            DisputeListParams.builder().from(params).startingAfter(data().last().token()).build()
        }
    }
    ...
    constructor(
        ...
        @JsonProperty("data") fun _data(): JsonField<List<Dispute>>? = data
