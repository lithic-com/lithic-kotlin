...
private constructor(
    ...
    /** A builder for [PaymentSimulateReceiptResponse]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [PaymentSimulateReceiptResponse].
         *
    ...
    internal fun validity(): Int =
        (if (debuggingRequestId.asKnown() == null) 0 else 1) +
            ...
            (if (transactionEventToken.asKnown() == null) 0 else 1)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is PaymentSimulateReceiptResponse && debuggingRequestId == other.debuggingRequestId && result == other.result && transactionEventToken == other.transactionEventToken && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "PaymentSimulateReceiptResponse{debuggingRequestId=$debuggingRequestId, result=$result, transactionEventToken=$transactionEventToken, additionalProperties=$additionalProperties}"
}
