...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(accountListPageResponse: AccountListPageResponse) = apply {
            ...
            hasMore = accountListPageResponse.hasMore
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AccountListPageResponse && data == other.data && hasMore == other.hasMore && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "AccountListPageResponse{data=$data, hasMore=$hasMore, additionalProperties=$additionalProperties}"
}
