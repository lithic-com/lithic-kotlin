...
private constructor(
    ...
    internal fun validity(): Int =
        (if (authRuleToken.asKnown() == null) 0 else 1) +
            (if (begin.asKnown() == null) 0 else 1) +
            (dailyStatistics.asKnown()?.sumOf { it.validity().toInt() } ?: 0) +
    ...
    private constructor(
        ...
        fun validate(): DailyStatistic = apply {
            ...
            currentVersionStatistics()?.validate()
            date()
            draftVersionStatistics()?.validate()
         ...
         */
        internal fun validity(): Int =
            (currentVersionStatistics.asKnown()?.validity() ?: 0) +
                (if (date.asKnown() == null) 0 else 1) +
                (draftVersionStatistics.asKnown()?.validity() ?: 0) +
                (versions.asKnown()?.sumOf { it.validity().toInt() } ?: 0)
        ...
        private constructor(
            ...
            private constructor(
                 ...
                 *
                 * Unlike [transactionToken], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("transaction_token")
                @ExcludeMissing
                ...
                class Builder internal constructor() {
                     ...
                     *
                     * You should usually call [Builder.transactionToken] with a well-typed [String]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                ...
                private constructor(
                    ...
                    fun resultAuthentication3ds(): ResultAuthentication3dsAction? =
                        resultAuthentication3ds

                    fun declineActionTokenization(): DeclineActionTokenization? =
