...
class SubscriptionListAttemptsPage
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SubscriptionListAttemptsPage && subscriptionsService == other.subscriptionsService && params == other.params && response == other.response /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(subscriptionsService, params, response) /* spotless:on */

    override fun toString() =
        "SubscriptionListAttemptsPage{subscriptionsService=$subscriptionsService, params=$params, response=$response}"
    ...
    fun getNextPage(): SubscriptionListAttemptsPage? {
    ...
    companion object {
        ...
        fun of(
            ...
            response: Response,
        ) = SubscriptionListAttemptsPage(subscriptionsService, params, response)
    }
    ...
    class AutoPager(private val firstPage: SubscriptionListAttemptsPage) :
