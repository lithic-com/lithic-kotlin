...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CardFinancialTransactionListPageAsync && this.financialTransactionsService == other.financialTransactionsService && this.params == other.params && this.response == other.response /* spotless:on */
    }
    ...
    constructor(
        ...
        override fun toString() =
            "CardFinancialTransactionListPageAsync.Response{data=$data, hasMore=$hasMore, additionalProperties=$additionalProperties}"
