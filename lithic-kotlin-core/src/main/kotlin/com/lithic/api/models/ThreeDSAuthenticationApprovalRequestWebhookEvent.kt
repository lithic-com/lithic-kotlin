...
private constructor(
     ...
     */
    fun accountType(): ThreeDSAuthentication.AccountType? = accountType.getNullable("account_type")
     ...
     *   server responded with an unexpected value).
     */
    fun additionalData(): ThreeDSAuthentication.AdditionalData? =
        additionalData.getNullable("additional_data")
     ...
     *   server responded with an unexpected value).
     */
    fun app(): ThreeDSAuthentication.App? = app.getNullable("app")
     ...
     *   server responded with an unexpected value).
     */
    fun authenticationRequestType(): ThreeDSAuthentication.AuthenticationRequestType? =
     ...
     *   server responded with an unexpected value).
     */
    fun browser(): ThreeDSAuthentication.Browser? = browser.getNullable("browser")
     ...
     *   server responded with an unexpected value).
     */
    fun challengeMetadata(): ThreeDSAuthentication.ChallengeMetadata? =
     ...
     *   server responded with an unexpected value).
     */
    fun challengeOrchestratedBy(): ThreeDSAuthentication.ChallengeOrchestratedBy? =
     ...
     *   server responded with an unexpected value).
     */
    fun threeRiRequestType(): ThreeDSAuthentication.ThreeRiRequestType? =
     ...
     *   server responded with an unexpected value).
     */
    fun transaction(): ThreeDSAuthentication.Transaction? = transaction.getNullable("transaction")
    ...
    /** A builder for [ThreeDSAuthenticationApprovalRequestWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            token = threeDSAuthenticationApprovalRequestWebhookEvent.token
            accountType = threeDSAuthenticationApprovalRequestWebhookEvent.accountType
            authenticationResult =
                threeDSAuthenticationApprovalRequestWebhookEvent.authenticationResult
            cardExpiryCheck = threeDSAuthenticationApprovalRequestWebhookEvent.cardExpiryCheck
            cardToken = threeDSAuthenticationApprovalRequestWebhookEvent.cardToken
            cardholder = threeDSAuthenticationApprovalRequestWebhookEvent.cardholder
            channel = threeDSAuthenticationApprovalRequestWebhookEvent.channel
            created = threeDSAuthenticationApprovalRequestWebhookEvent.created
            merchant = threeDSAuthenticationApprovalRequestWebhookEvent.merchant
            messageCategory = threeDSAuthenticationApprovalRequestWebhookEvent.messageCategory
            threeDSRequestorChallengeIndicator =
                threeDSAuthenticationApprovalRequestWebhookEvent.threeDSRequestorChallengeIndicator
            additionalData = threeDSAuthenticationApprovalRequestWebhookEvent.additionalData
            app = threeDSAuthenticationApprovalRequestWebhookEvent.app
            authenticationRequestType =
                threeDSAuthenticationApprovalRequestWebhookEvent.authenticationRequestType
            browser = threeDSAuthenticationApprovalRequestWebhookEvent.browser
            challengeMetadata = threeDSAuthenticationApprovalRequestWebhookEvent.challengeMetadata
            challengeOrchestratedBy =
                threeDSAuthenticationApprovalRequestWebhookEvent.challengeOrchestratedBy
            decisionMadeBy = threeDSAuthenticationApprovalRequestWebhookEvent.decisionMadeBy
            psd2Context = threeDSAuthenticationApprovalRequestWebhookEvent.psd2Context
            threeRiRequestType = threeDSAuthenticationApprovalRequestWebhookEvent.threeRiRequestType
            transaction = threeDSAuthenticationApprovalRequestWebhookEvent.transaction
            eventType = threeDSAuthenticationApprovalRequestWebhookEvent.eventType
            additionalProperties =
                threeDSAuthenticationApprovalRequestWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ThreeDSAuthenticationApprovalRequestWebhookEvent].
         *
         ...
         */
        fun build(): ThreeDSAuthenticationApprovalRequestWebhookEvent =
            ThreeDSAuthenticationApprovalRequestWebhookEvent(
     ...
     *   expected type.
     */
    fun validate(): ThreeDSAuthenticationApprovalRequestWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    class EventType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val THREE_DS_AUTHENTICATION_APPROVAL_REQUEST =
                of("three_ds_authentication.approval_request")
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ThreeDSAuthenticationApprovalRequestWebhookEvent &&
            token == other.token &&
