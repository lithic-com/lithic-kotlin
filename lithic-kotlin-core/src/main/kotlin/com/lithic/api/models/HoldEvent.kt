...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun settlingTransactionToken(): String? =
        settlingTransactionToken.getNullable("settling_transaction_token")
    ...
    internal fun validity(): Int =
        (if (token.asKnown() == null) 0 else 1) +
            ...
            (if (settlingTransactionToken.asKnown() == null) 0 else 1) +
    ...
    class HoldEventType @JsonCreator private constructor(private val value: JsonField<String>) :
        ...
        companion object {
            ...
            val HOLD_INITIATED = of("HOLD_INITIATED")

            val HOLD_VOIDED = of("HOLD_VOIDED")

            val HOLD_EXPIRED = of("HOLD_EXPIRED")

            val HOLD_SETTLED = of("HOLD_SETTLED")

            fun of(value: String) = HoldEventType(JsonField.of(value))
        }
