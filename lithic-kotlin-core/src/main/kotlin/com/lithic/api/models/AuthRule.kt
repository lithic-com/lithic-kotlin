...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun excludedAccountTokens(): List<String>? =
        excludedAccountTokens.getNullable("excluded_account_tokens")
     ...
     *   server responded with an unexpected value).
     */
    fun excludedBusinessAccountTokens(): List<String>? =
        excludedBusinessAccountTokens.getNullable("excluded_business_account_tokens")
    ...
    @JsonProperty("excluded_business_account_tokens")
    @ExcludeMissing
    fun _excludedBusinessAccountTokens(): JsonField<List<String>> = excludedBusinessAccountTokens
    ...
    class Builder internal constructor() {
        ...
        internal fun from(authRule: AuthRule) = apply {
            ...
            businessAccountTokens = authRule.businessAccountTokens.map { it.toMutableList() }
            cardTokens = authRule.cardTokens.map { it.toMutableList() }
            currentVersion = authRule.currentVersion
            draftVersion = authRule.draftVersion
            eventStream = authRule.eventStream
            lithicManaged = authRule.lithicManaged
            name = authRule.name
         ...
         *
         * You should usually call [Builder.excludedAccountTokens] with a well-typed `List<String>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
    ...
    private constructor(
        ...
        private constructor(
            ...
            fun conditionalAuthorizationAction(): ConditionalAuthorizationActionParameters? =
                conditionalAuthorizationAction

            fun conditionalAchAction(): ConditionalAchActionParameters? = conditionalAchAction
            ...
            fun conditionalAchPaymentUpdateAction(): ConditionalAchPaymentUpdateActionParameters? =
                conditionalAchPaymentUpdateAction
            ...
            fun asConditionalAuthorizationAdjustment():
                ConditionalAuthorizationAdjustmentParameters =
            ...
            companion object {
                ...
                fun ofConditionalAuthorizationAdjustment(
                    ...
                    Parameters(
                        conditionalAuthorizationAdjustment = conditionalAuthorizationAdjustment
                    )
            }
    ...
    class AuthRuleType @JsonCreator private constructor(private val value: JsonField<String>) :
        ...
        companion object {
            ...
            val CONDITIONAL_ACTION = of("CONDITIONAL_ACTION")
