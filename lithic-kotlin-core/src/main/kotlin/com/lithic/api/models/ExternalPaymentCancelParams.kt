...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ExternalPaymentCancelParams].
         *
    ...
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [ExternalPaymentCancelParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExternalPaymentCancelParams &&
