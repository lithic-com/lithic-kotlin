...
class StatementListPageAsync
private constructor(
    private val statementsService: StatementServiceAsync,
    private val params: StatementListParams,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is StatementListPageAsync && statementsService == other.statementsService && params == other.params && response == other.response /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(statementsService, params, response) /* spotless:on */

    override fun toString() =
        "StatementListPageAsync{statementsService=$statementsService, params=$params, response=$response}"

    fun hasNextPage(): Boolean {
        return !data().isEmpty()
    }

    fun getNextPageParams(): StatementListParams? {
        if (!hasNextPage()) {
            return null
        }
    ...
    suspend fun getNextPage(): StatementListPageAsync? {
    ...
    companion object {
        ...
        fun of(
            ...
            response: Response,
        ) = StatementListPageAsync(statementsService, params, response)
    }
    ...
    class Response(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("data") data: JsonField<List<Statement>> = JsonMissing.of(),
        ...
        companion object {
            ...
            /**
             * Returns a mutable builder for constructing an instance of [StatementListPageAsync].
             */
            fun builder() = Builder()
        }
    ...
    class AutoPager(private val firstPage: StatementListPageAsync) : Flow<Statement> {
