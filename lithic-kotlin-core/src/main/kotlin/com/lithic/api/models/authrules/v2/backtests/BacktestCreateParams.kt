...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BacktestCreateParams].
         *
    ...
    /** A builder for [BacktestCreateParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(backtestCreateParams: BacktestCreateParams) = apply {
            authRuleToken = backtestCreateParams.authRuleToken
            body = backtestCreateParams.body.toBuilder()
            additionalHeaders = backtestCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = backtestCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [BacktestCreateParams].
         *
         ...
         */
        fun build(): BacktestCreateParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is BacktestCreateParams && authRuleToken == other.authRuleToken && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "BacktestCreateParams{authRuleToken=$authRuleToken, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
