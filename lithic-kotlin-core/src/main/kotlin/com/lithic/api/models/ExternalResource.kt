...
private constructor(
     ...
     */
    fun externalResourceSubToken(): String? =
        externalResourceSubToken.getNullable("external_resource_sub_token")
    ...
    internal fun validity(): Int =
        (if (externalResourceToken.asKnown() == null) 0 else 1) +
            (externalResourceType.asKnown()?.validity() ?: 0) +
            (if (externalResourceSubToken.asKnown() == null) 0 else 1)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExternalResource &&
            externalResourceToken == other.externalResourceToken &&
            externalResourceType == other.externalResourceType &&
            externalResourceSubToken == other.externalResourceSubToken &&
