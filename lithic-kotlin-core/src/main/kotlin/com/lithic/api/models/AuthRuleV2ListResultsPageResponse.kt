...
private constructor(
    private val data: JsonField<List<V2ListResultsResponse>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<V2ListResultsResponse>> = JsonMissing.of(),
     ...
     */
    fun data(): List<V2ListResultsResponse> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<V2ListResultsResponse>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<V2ListResultsResponse>>? = null
        ...
        fun data(data: List<V2ListResultsResponse>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<V2ListResultsResponse>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<V2ListResultsResponse>>) = apply {
