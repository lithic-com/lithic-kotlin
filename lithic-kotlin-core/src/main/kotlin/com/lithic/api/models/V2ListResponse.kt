...
private constructor(
    ...
    class Builder {
        ...
        internal fun from(v2ListResponse: V2ListResponse) = apply {
            this.token = v2ListResponse.token
