...
private constructor(
     ...
     */
    fun data(): List<CaseFile> = response._data().getNullable("data") ?: emptyList()
    ...
    override suspend fun nextPage(): TransactionMonitoringCaseFileListPageAsync =
        service.list(nextPageParams())

    fun autoPager(): AutoPagerAsync<CaseFile> = AutoPagerAsync.from(this)
    ...
    override fun toString() =
        "TransactionMonitoringCaseFileListPageAsync{service=$service, params=$params, response=$response}"
}
