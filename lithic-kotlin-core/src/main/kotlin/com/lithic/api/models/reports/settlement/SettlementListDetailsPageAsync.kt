...
/** List details. */
class SettlementListDetailsPageAsync
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SettlementListDetailsPageAsync && settlementService == other.settlementService && params == other.params && response == other.response /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(settlementService, params, response) /* spotless:on */

    override fun toString() =
        "SettlementListDetailsPageAsync{settlementService=$settlementService, params=$params, response=$response}"

    fun hasNextPage(): Boolean {
        return !data().isEmpty()
    }

    fun getNextPageParams(): SettlementListDetailsParams? {
        if (!hasNextPage()) {
            return null
        }
    ...
    suspend fun getNextPage(): SettlementListDetailsPageAsync? {
    ...
    companion object {
        ...
        fun of(
            ...
            response: Response,
        ) = SettlementListDetailsPageAsync(settlementService, params, response)
    }
    ...
    class AutoPager(private val firstPage: SettlementListDetailsPageAsync) :
