...
private constructor(
    ...
    /** A builder for [CardTransactionEnhancedDataCreatedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            token = cardTransactionEnhancedDataCreatedWebhookEvent.token
            common = cardTransactionEnhancedDataCreatedWebhookEvent.common
            eventToken = cardTransactionEnhancedDataCreatedWebhookEvent.eventToken
            fleet = cardTransactionEnhancedDataCreatedWebhookEvent.fleet.map { it.toMutableList() }
            transactionToken = cardTransactionEnhancedDataCreatedWebhookEvent.transactionToken
            eventType = cardTransactionEnhancedDataCreatedWebhookEvent.eventType
            additionalProperties =
                cardTransactionEnhancedDataCreatedWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CardTransactionEnhancedDataCreatedWebhookEvent].
         *
         ...
         */
        fun build(): CardTransactionEnhancedDataCreatedWebhookEvent =
            CardTransactionEnhancedDataCreatedWebhookEvent(
    ...
    internal fun validity(): Int =
        (if (token.asKnown() == null) 0 else 1) +
            (common.asKnown()?.validity() ?: 0) +
            (if (eventToken.asKnown() == null) 0 else 1) +
            (fleet.asKnown()?.sumOf { it.validity().toInt() } ?: 0) +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CardTransactionEnhancedDataCreatedWebhookEvent &&
            token == other.token &&
            common == other.common &&
    ...
    override fun toString() =
        "CardTransactionEnhancedDataCreatedWebhookEvent{token=$token, common=$common, eventToken=$eventToken, fleet=$fleet, transactionToken=$transactionToken, eventType=$eventType, additionalProperties=$additionalProperties}"
}
