...
private constructor(
    ...
    private val tokenMetadata: JsonField<TokenMetadata>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        tokenMetadata: JsonField<TokenMetadata> = JsonMissing.of(),
     ...
     */
    fun customerTokenizationDecision(): CustomerTokenizationDecision? =
        customerTokenizationDecision.getNullable("customer_tokenization_decision")
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun tokenMetadata(): TokenMetadata = tokenMetadata.getRequired("token_metadata")
     ...
     *   server responded with an unexpected value).
     */
    fun device(): Device? = device.getNullable("device")
     ...
     *   server responded with an unexpected value).
     */
    fun ruleResults(): List<TokenizationRuleResult>? = ruleResults.getNullable("rule_results")
    ...
    fun tokenizationDeclineReasons(): List<TokenizationDeclineReason>? =
        tokenizationDeclineReasons.getNullable("tokenization_decline_reasons")
    ...
    fun tokenizationSource(): TokenizationSource? =
        tokenizationSource.getNullable("tokenization_source")
     ...
     *   server responded with an unexpected value).
     */
    fun tokenizationTfaReasons(): List<TokenizationTfaReason>? =
        tokenizationTfaReasons.getNullable("tokenization_tfa_reasons")
    ...
    @JsonProperty("token_metadata")
    @ExcludeMissing
    fun _tokenMetadata(): JsonField<TokenMetadata> = tokenMetadata
    ...
    /** A builder for [TokenizationApprovalRequestWebhookEvent]. */
    class Builder internal constructor() {
        ...
        private var tokenMetadata: JsonField<TokenMetadata>? = null
        ...
        internal fun from(
            tokenizationApprovalRequestWebhookEvent: TokenizationApprovalRequestWebhookEvent
        ) = apply {
            accountToken = tokenizationApprovalRequestWebhookEvent.accountToken
            cardToken = tokenizationApprovalRequestWebhookEvent.cardToken
            created = tokenizationApprovalRequestWebhookEvent.created
            customerTokenizationDecision =
                tokenizationApprovalRequestWebhookEvent.customerTokenizationDecision
            eventType = tokenizationApprovalRequestWebhookEvent.eventType
            issuerDecision = tokenizationApprovalRequestWebhookEvent.issuerDecision
            tokenMetadata = tokenizationApprovalRequestWebhookEvent.tokenMetadata
            tokenizationChannel = tokenizationApprovalRequestWebhookEvent.tokenizationChannel
            tokenizationToken = tokenizationApprovalRequestWebhookEvent.tokenizationToken
            walletDecisioningInfo = tokenizationApprovalRequestWebhookEvent.walletDecisioningInfo
            device = tokenizationApprovalRequestWebhookEvent.device
            ruleResults =
                tokenizationApprovalRequestWebhookEvent.ruleResults.map { it.toMutableList() }
            tokenizationDeclineReasons =
                tokenizationApprovalRequestWebhookEvent.tokenizationDeclineReasons.map {
                    it.toMutableList()
                }
            tokenizationSource = tokenizationApprovalRequestWebhookEvent.tokenizationSource
            tokenizationTfaReasons =
                tokenizationApprovalRequestWebhookEvent.tokenizationTfaReasons.map {
                    it.toMutableList()
                }
            additionalProperties =
                tokenizationApprovalRequestWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /** Contains the metadata for the digital wallet being tokenized. */
        fun tokenMetadata(tokenMetadata: TokenMetadata) = tokenMetadata(JsonField.of(tokenMetadata))

        /**
         * Sets [Builder.tokenMetadata] to an arbitrary JSON value.
         *
         * You should usually call [Builder.tokenMetadata] with a well-typed [TokenMetadata] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun tokenMetadata(tokenMetadata: JsonField<TokenMetadata>) = apply {
    ...
    fun validate(): TokenizationApprovalRequestWebhookEvent = apply {
        if (validated) {
            return@apply
        }
        ...
        cardToken()
        created()
        customerTokenizationDecision()?.validate()
        eventType().validate()
        issuerDecision().validate()
        tokenMetadata().validate()
        ...
        tokenizationTfaReasons()?.forEach { it.validate() }
        validated = true
    }
    ...
    internal fun validity(): Int =
        (if (accountToken.asKnown() == null) 0 else 1) +
            ...
            (customerTokenizationDecision.asKnown()?.validity() ?: 0) +
            (eventType.asKnown()?.validity() ?: 0) +
            (issuerDecision.asKnown()?.validity() ?: 0) +
            (tokenMetadata.asKnown()?.validity() ?: 0) +
            (tokenizationChannel.asKnown()?.validity() ?: 0) +
            (if (tokenizationToken.asKnown() == null) 0 else 1) +
            (walletDecisioningInfo.asKnown()?.validity() ?: 0) +
            (device.asKnown()?.validity() ?: 0) +
            (ruleResults.asKnown()?.sumOf { it.validity().toInt() } ?: 0) +
            (tokenizationDeclineReasons.asKnown()?.sumOf { it.validity().toInt() } ?: 0) +
            (tokenizationSource.asKnown()?.validity() ?: 0) +
            (tokenizationTfaReasons.asKnown()?.sumOf { it.validity().toInt() } ?: 0)
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun latency(): String? = latency.getNullable("latency")
         ...
         *   server responded with an unexpected value).
         */
        fun responseCode(): String? = responseCode.getNullable("response_code")
        ...
        internal fun validity(): Int =
            (outcome.asKnown()?.validity() ?: 0) +
                (if (responderUrl.asKnown() == null) 0 else 1) +
                (if (latency.asKnown() == null) 0 else 1) +
                (if (responseCode.asKnown() == null) 0 else 1)
        ...
        class Outcome @JsonCreator private constructor(private val value: JsonField<String>) :
            ...
            companion object {
                ...
                val INVALID_RESPONSE = of("INVALID_RESPONSE")
    ...
    class IssuerDecision @JsonCreator private constructor(private val value: JsonField<String>) :
        ...
        companion object {
            ...
            val VERIFICATION_REQUIRED = of("VERIFICATION_REQUIRED")

            fun of(value: String) = IssuerDecision(JsonField.of(value))
        }
    ...
    private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val ACCOUNT_ON_FILE = of("ACCOUNT_ON_FILE")

            val CONTACTLESS_TAP = of("CONTACTLESS_TAP")

            val MANUAL_PROVISION = of("MANUAL_PROVISION")

            val PUSH_PROVISION = of("PUSH_PROVISION")
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TokenizationApprovalRequestWebhookEvent &&
    ...
    override fun toString() =
        "TokenizationApprovalRequestWebhookEvent{accountToken=$accountToken, cardToken=$cardToken, created=$created, customerTokenizationDecision=$customerTokenizationDecision, eventType=$eventType, issuerDecision=$issuerDecision, tokenMetadata=$tokenMetadata, tokenizationChannel=$tokenizationChannel, tokenizationToken=$tokenizationToken, walletDecisioningInfo=$walletDecisioningInfo, device=$device, ruleResults=$ruleResults, tokenizationDeclineReasons=$tokenizationDeclineReasons, tokenizationSource=$tokenizationSource, tokenizationTfaReasons=$tokenizationTfaReasons, additionalProperties=$additionalProperties}"
}
