...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is FinancialTransactionListPage && this.financialTransactionsService == other.financialTransactionsService && this.params == other.params && this.response == other.response /* spotless:on */
    }
