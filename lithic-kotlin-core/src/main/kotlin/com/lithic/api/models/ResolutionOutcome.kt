...
class ResolutionOutcome @JsonCreator private constructor(private val value: JsonField<String>) :
    ...
    companion object {
        ...
        val CONFIRMED_FRAUD = of("CONFIRMED_FRAUD")

        val SUSPICIOUS_ACTIVITY = of("SUSPICIOUS_ACTIVITY")

        val FALSE_POSITIVE = of("FALSE_POSITIVE")

        val NO_ACTION_REQUIRED = of("NO_ACTION_REQUIRED")

        val ESCALATED_EXTERNAL = of("ESCALATED_EXTERNAL")

        fun of(value: String) = ResolutionOutcome(JsonField.of(value))
    }
