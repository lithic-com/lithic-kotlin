...
private constructor(
    ...
    private constructor(
         ...
         *   provider for the recommended decision. Valid values are:
         *     - Common: `ACCOUNT_CARD_TOO_NEW`, `ACCOUNT_RECENTLY_CHANGED`, `ACCOUNT_TOO_NEW`,
         *       `ACCOUNT_TOO_NEW_SINCE_LAUNCH`, `DEVICE_RECENTLY_LOST`, `HAS_SUSPENDED_TOKENS`,
         *       `HIGH_RISK`, `INACTIVE_ACCOUNT`, `LOW_ACCOUNT_SCORE`, `LOW_DEVICE_SCORE`,
         *       `OUTSIDE_HOME_TERRITORY`, `SUSPICIOUS_ACTIVITY`, `TOO_MANY_DIFFERENT_CARDHOLDERS`,
         ...
         *       `LOW_TRANSACTION_VOLUME`, `USER_ACCOUNT_DEVICE_TOO_NEW`, `WALLET_ACCOUNT_TOO_NEW`
         *     - Amex only: `DEVICE_USING_VPN_PROXY`, `EXCESSIVE_BILLING_NAME_ATTEMPTS_MODERATE`,
        ...
        class Builder internal constructor() {
             ...
             *       `ACCOUNT_TOO_NEW_SINCE_LAUNCH`, `DEVICE_RECENTLY_LOST`, `HAS_SUSPENDED_TOKENS`,
             *       `HIGH_RISK`, `INACTIVE_ACCOUNT`, `LOW_ACCOUNT_SCORE`, `LOW_DEVICE_SCORE`,
             *       `OUTSIDE_HOME_TERRITORY`, `SUSPICIOUS_ACTIVITY`,
        ...
        class Attribute @JsonCreator private constructor(private val value: JsonField<String>) :
            ...
            companion object {
                ...
                val TIMESTAMP = of("TIMESTAMP")

                val TOKENIZATION_CHANNEL = of("TOKENIZATION_CHANNEL")

                val TOKENIZATION_SOURCE = of("TOKENIZATION_SOURCE")

                val TOKEN_REQUESTOR_NAME = of("TOKEN_REQUESTOR_NAME")

                val WALLET_ACCOUNT_SCORE = of("WALLET_ACCOUNT_SCORE")

                val WALLET_DEVICE_SCORE = of("WALLET_DEVICE_SCORE")

                val WALLET_RECOMMENDED_DECISION = of("WALLET_RECOMMENDED_DECISION")

                val WALLET_RECOMMENDATION_REASONS = of("WALLET_RECOMMENDATION_REASONS")

                val TOKEN_REQUESTOR_ID = of("TOKEN_REQUESTOR_ID")
