...
private constructor(
    ...
    class Builder internal constructor() {
         ...
         *   validation.
         * - claim.created: Occurs when a dispute intake claim is created.
         * - claim.updated: Occurs when a dispute intake claim is updated, such as a status change
         *   or a change to its outstanding requirements.
    ...
    class EventType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val NETWORK_TOTAL_UPDATED = of("network_total.updated")
