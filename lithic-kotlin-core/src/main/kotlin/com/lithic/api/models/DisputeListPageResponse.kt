...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(disputeListPageResponse: DisputeListPageResponse) = apply {
            data = disputeListPageResponse.data.map { it.toMutableList() }
            hasMore = disputeListPageResponse.hasMore
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is DisputeListPageResponse && data == other.data && hasMore == other.hasMore && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "DisputeListPageResponse{data=$data, hasMore=$hasMore, additionalProperties=$additionalProperties}"
}
