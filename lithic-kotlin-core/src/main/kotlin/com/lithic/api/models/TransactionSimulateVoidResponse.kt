...
private constructor(
    ...
    /** A builder for [TransactionSimulateVoidResponse]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [TransactionSimulateVoidResponse].
         *
     ...
     */
    internal fun validity(): Int = (if (debuggingRequestId.asKnown() == null) 0 else 1)
