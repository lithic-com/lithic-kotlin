...
private constructor(
    ...
    fun accountLevelRule(): AccountLevelRule? = body.accountLevelRule()

    fun cardLevelRule(): CardLevelRule? = body.cardLevelRule()

    fun programLevelRule(): ProgramLevelRule? = body.programLevelRule()

    fun _additionalHeaders(): Headers = additionalHeaders

    fun _additionalQueryParams(): QueryParams = additionalQueryParams

    internal fun getBody(): AuthRuleV2UpdateBody = body
