...
private constructor(
    ...
    private constructor(
        ...
        override fun toString() =
            "UpdateBankAccountApiRequest{address=$address, companyId=$companyId, dob=$dob, doingBusinessAs=$doingBusinessAs, name=$name, owner=$owner, ownerType=$ownerType, userDefinedId=$userDefinedId, additionalProperties=$additionalProperties}"
    }
