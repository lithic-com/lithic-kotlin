...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ResponderEndpointCreateParams && this.type == other.type && this.url == other.url && this.additionalQueryParams == other.additionalQueryParams && this.additionalHeaders == other.additionalHeaders && this.additionalBodyProperties == other.additionalBodyProperties /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(type, url, additionalQueryParams, additionalHeaders, additionalBodyProperties) /* spotless:on */
    }
