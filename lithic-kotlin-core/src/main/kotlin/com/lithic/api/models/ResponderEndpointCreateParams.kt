...
private constructor(
    ...
    /** A builder for [ResponderEndpointCreateParams]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [ResponderEndpointCreateParams].
         *
    ...
    private constructor(
        ...
        internal fun validity(): Int =
            (type.asKnown()?.validity() ?: 0) + (if (url.asKnown() == null) 0 else 1)
