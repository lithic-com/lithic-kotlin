...
private constructor(
     ...
     */
    fun funding(): FundingAccount? = funding.getNullable("funding")
     ...
     *   server responded with an unexpected value).
     */
    fun networkProgramToken(): String? = networkProgramToken.getNullable("network_program_token")
    ...
    class Builder internal constructor() {
        ...
        internal fun from(nonPciCard: NonPciCard) = apply {
            ...
            networkProgramToken = nonPciCard.networkProgramToken
            ...
            substatus = nonPciCard.substatus
    ...
    internal fun validity(): Int =
        (if (token.asKnown() == null) 0 else 1) +
            ...
            (if (networkProgramToken.asKnown() == null) 0 else 1) +
