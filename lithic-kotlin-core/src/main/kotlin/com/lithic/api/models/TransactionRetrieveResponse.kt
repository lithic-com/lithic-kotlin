...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun fraudType(): FraudType? = fraudType.getNullable("fraud_type")
    ...
    class Builder internal constructor() {
        ...
        internal fun from(transactionRetrieveResponse: TransactionRetrieveResponse) = apply {
            fraudStatus = transactionRetrieveResponse.fraudStatus
            transactionToken = transactionRetrieveResponse.transactionToken
            comment = transactionRetrieveResponse.comment
            createdAt = transactionRetrieveResponse.createdAt
            fraudType = transactionRetrieveResponse.fraudType
    ...
    class FraudStatus @JsonCreator private constructor(private val value: JsonField<String>) :
        ...
        companion object {
            ...
            val NOT_FRAUDULENT = of("NOT_FRAUDULENT")

            val NO_REPORTED_FRAUD = of("NO_REPORTED_FRAUD")

            fun of(value: String) = FraudStatus(JsonField.of(value))
        }
    ...
    class FraudType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val FIRST_PARTY_FRAUD = of("FIRST_PARTY_FRAUD")

            val ACCOUNT_TAKEOVER = of("ACCOUNT_TAKEOVER")

            val CARD_COMPROMISED = of("CARD_COMPROMISED")

            val IDENTITY_THEFT = of("IDENTITY_THEFT")

            val CARDHOLDER_MANIPULATION = of("CARDHOLDER_MANIPULATION")
    ...
    override fun toString() =
        "TransactionRetrieveResponse{fraudStatus=$fraudStatus, transactionToken=$transactionToken, comment=$comment, createdAt=$createdAt, fraudType=$fraudType, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
