...
private constructor(
    ...
    internal fun validity(): Int =
        (if (token.asKnown() == null) 0 else 1) +
            ...
            (eventTokens.asKnown()?.size ?: 0) +
            (if (institution.asKnown() == null) 0 else 1) +
            (if (interchangeFeeExtendedPrecision.asKnown() == null) 0 else 1) +
            (if (interchangeGrossAmount.asKnown() == null) 0 else 1) +
            (network.asKnown()?.validity() ?: 0) +
            (otherFeesDetails.asKnown()?.validity() ?: 0) +
            ...
            (if (feeDescription.asKnown() == null) 0 else 1)
    ...
    private constructor(
         ...
         * Used for best match union deserialization.
         */
        internal fun validity(): Int = (if (isa.asKnown() == null) 0 else 1)
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val NON_FINANCIAL = of("NON_FINANCIAL")
