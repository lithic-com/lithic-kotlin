...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun previousExpMonth(): String? = previousExpMonth.getNullable("previous_exp_month")
     ...
     *   server responded with an unexpected value).
     */
    fun previousExpYear(): String? = previousExpYear.getNullable("previous_exp_year")
    ...
    internal fun validity(): Int =
        (eventType.asKnown()?.validity() ?: 0) +
            ...
            (if (previousExpMonth.asKnown() == null) 0 else 1) +
            (if (previousExpYear.asKnown() == null) 0 else 1)
