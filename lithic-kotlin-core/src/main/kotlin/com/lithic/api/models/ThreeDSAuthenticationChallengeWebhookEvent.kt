...
private constructor(
    ...
    internal fun validity(): Int =
        (authenticationObject.asKnown()?.validity() ?: 0) +
    ...
    private constructor(
         ...
         */
        fun appRequestorUrl(): String? = appRequestorUrl.getNullable("app_requestor_url")
         ...
         */
        internal fun validity(): Int =
            (challengeMethodType.asKnown()?.validity() ?: 0) +
                (if (expiryTime.asKnown() == null) 0 else 1) +
                (if (startTime.asKnown() == null) 0 else 1) +
                (if (appRequestorUrl.asKnown() == null) 0 else 1)
        ...
        private constructor(private val value: JsonField<String>) : Enum {
            ...
            companion object {
                ...
                fun of(value: String) = ChallengeMethodType(JsonField.of(value))
            }
