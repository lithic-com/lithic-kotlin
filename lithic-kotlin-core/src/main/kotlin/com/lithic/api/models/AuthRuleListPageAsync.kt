...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AuthRuleListPageAsync && this.authRulesService == other.authRulesService && this.params == other.params && this.response == other.response /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(authRulesService, params, response) /* spotless:on */
    }
    ...
    constructor(
        ...
        override fun toString() =
            "AuthRuleListPageAsync.Response{data=$data, hasMore=$hasMore, additionalProperties=$additionalProperties}"
