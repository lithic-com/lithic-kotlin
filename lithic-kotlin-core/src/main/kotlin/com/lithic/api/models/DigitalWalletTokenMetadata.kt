...
private constructor(
     ...
     */
    fun paymentAppInstanceId(): String? =
        paymentAppInstanceId.getNullable("payment_app_instance_id")
     ...
     *   server responded with an unexpected value).
     */
    fun tokenRequestorId(): String? = tokenRequestorId.getNullable("token_requestor_id")
    ...
    fun tokenRequestorName(): TokenRequestorName? =
        tokenRequestorName.getNullable("token_requestor_name")
    ...
    internal fun validity(): Int =
        (paymentAccountInfo.asKnown()?.validity() ?: 0) +
            (if (status.asKnown() == null) 0 else 1) +
            (if (paymentAppInstanceId.asKnown() == null) 0 else 1) +
            (if (tokenRequestorId.asKnown() == null) 0 else 1) +
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun panUniqueReference(): String? = panUniqueReference.getNullable("pan_unique_reference")
         ...
         *   server responded with an unexpected value).
         */
        fun paymentAccountReference(): String? =
            paymentAccountReference.getNullable("payment_account_reference")
         ...
         *   server responded with an unexpected value).
         */
        fun tokenUniqueReference(): String? =
            tokenUniqueReference.getNullable("token_unique_reference")
         ...
         */
        internal fun validity(): Int =
            (accountHolderData.asKnown()?.validity() ?: 0) +
                (if (panUniqueReference.asKnown() == null) 0 else 1) +
                (if (paymentAccountReference.asKnown() == null) 0 else 1) +
