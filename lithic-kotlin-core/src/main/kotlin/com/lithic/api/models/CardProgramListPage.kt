...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CardProgramListPage && this.cardProgramsService == other.cardProgramsService && this.params == other.params && this.response == other.response /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(cardProgramsService, params, response) /* spotless:on */
    }
    ...
    constructor(
        ...
        override fun toString() =
            "CardProgramListPage.Response{data=$data, hasMore=$hasMore, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: CardProgramListPage,
    ) : Sequence<CardProgram> {
