...
private constructor(
     ...
     * import com.lithic.api.core.JsonValue
     *
     * val result: String? = accountHolderUpdatedWebhookEvent.accept(object : AccountHolderUpdatedWebhookEvent.Visitor<String?> {
     *     override fun visitKybPayload(kybPayload: KybPayload): String? = kybPayload.toString()
     *
     *     // ...
     *
