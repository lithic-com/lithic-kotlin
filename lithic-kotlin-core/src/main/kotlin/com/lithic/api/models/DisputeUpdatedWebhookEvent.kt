...
/** Dispute. */
class DisputeUpdatedWebhookEvent
...
private constructor(
    ...
    private val reason: JsonField<Dispute.Reason>,
    ...
    private val resolutionReason: JsonField<Dispute.ResolutionReason>,
    private val status: JsonField<Dispute.Status>,
    ...
    private constructor(
        ...
        @JsonProperty("reason")
        @ExcludeMissing
        reason: JsonField<Dispute.Reason> = JsonMissing.of(),
        ...
        @ExcludeMissing
        resolutionReason: JsonField<Dispute.ResolutionReason> = JsonMissing.of(),
        @JsonProperty("status")
        @ExcludeMissing
        status: JsonField<Dispute.Status> = JsonMissing.of(),
    ...
    fun toDispute(): Dispute =
        Dispute.builder()
            ...
            .networkFiledDate(networkFiledDate)
            .networkReasonCode(networkReasonCode)
            .prearbitrationDate(prearbitrationDate)
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun reason(): Dispute.Reason = reason.getRequired("reason")
     ...
     *   server responded with an unexpected value).
     */
    fun resolutionReason(): Dispute.ResolutionReason? =
        resolutionReason.getNullable("resolution_reason")
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun status(): Dispute.Status = status.getRequired("status")
     ...
     */
    @JsonProperty("reason") @ExcludeMissing fun _reason(): JsonField<Dispute.Reason> = reason
    ...
    @JsonProperty("resolution_reason")
    @ExcludeMissing
    fun _resolutionReason(): JsonField<Dispute.ResolutionReason> = resolutionReason
     ...
     */
    @JsonProperty("status") @ExcludeMissing fun _status(): JsonField<Dispute.Status> = status
    ...
    /** A builder for [DisputeUpdatedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        private var reason: JsonField<Dispute.Reason>? = null
        ...
        private var resolutionReason: JsonField<Dispute.ResolutionReason>? = null
        private var status: JsonField<Dispute.Status>? = null
        private var transactionToken: JsonField<String>? = null
        private var eventType: JsonField<EventType>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(disputeUpdatedWebhookEvent: DisputeUpdatedWebhookEvent) = apply {
            token = disputeUpdatedWebhookEvent.token
            amount = disputeUpdatedWebhookEvent.amount
            arbitrationDate = disputeUpdatedWebhookEvent.arbitrationDate
            created = disputeUpdatedWebhookEvent.created
            customerFiledDate = disputeUpdatedWebhookEvent.customerFiledDate
            customerNote = disputeUpdatedWebhookEvent.customerNote
            networkClaimIds = disputeUpdatedWebhookEvent.networkClaimIds.map { it.toMutableList() }
            networkFiledDate = disputeUpdatedWebhookEvent.networkFiledDate
            networkReasonCode = disputeUpdatedWebhookEvent.networkReasonCode
            prearbitrationDate = disputeUpdatedWebhookEvent.prearbitrationDate
            primaryClaimId = disputeUpdatedWebhookEvent.primaryClaimId
            reason = disputeUpdatedWebhookEvent.reason
            representmentDate = disputeUpdatedWebhookEvent.representmentDate
            resolutionDate = disputeUpdatedWebhookEvent.resolutionDate
            resolutionNote = disputeUpdatedWebhookEvent.resolutionNote
            resolutionReason = disputeUpdatedWebhookEvent.resolutionReason
            status = disputeUpdatedWebhookEvent.status
            transactionToken = disputeUpdatedWebhookEvent.transactionToken
            eventType = disputeUpdatedWebhookEvent.eventType
            additionalProperties = disputeUpdatedWebhookEvent.additionalProperties.toMutableMap()
        }
         ...
         * * `RECURRING_TRANSACTION_NOT_CANCELLED`: The recurring transaction was not cancelled.
         */
        fun reason(reason: Dispute.Reason) = reason(JsonField.of(reason))

        /**
         * Sets [Builder.reason] to an arbitrary JSON value.
         *
         * You should usually call [Builder.reason] with a well-typed [Dispute.Reason] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun reason(reason: JsonField<Dispute.Reason>) = apply { this.reason = reason }
         ...
         * * `WON_PREARBITRATION`: Won prearbitration.
         */
        fun resolutionReason(resolutionReason: Dispute.ResolutionReason?) =
            resolutionReason(JsonField.ofNullable(resolutionReason))

        /**
         * Sets [Builder.resolutionReason] to an arbitrary JSON value.
         *
         * You should usually call [Builder.resolutionReason] with a well-typed
         * [Dispute.ResolutionReason] value instead. This method is primarily for setting the field
         * to an undocumented or not yet supported value.
         */
        fun resolutionReason(resolutionReason: JsonField<Dispute.ResolutionReason>) = apply {
         ...
         * * `CASE_CLOSED` - Case was lost or withdrawn.
         */
        fun status(status: Dispute.Status) = status(JsonField.of(status))

        /**
         * Sets [Builder.status] to an arbitrary JSON value.
         *
         * You should usually call [Builder.status] with a well-typed [Dispute.Status] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun status(status: JsonField<Dispute.Status>) = apply { this.status = status }
         ...
         */
        fun build(): DisputeUpdatedWebhookEvent =
    ...
    fun validate(): DisputeUpdatedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DisputeUpdatedWebhookEvent &&
            token == other.token &&
            amount == other.amount &&
