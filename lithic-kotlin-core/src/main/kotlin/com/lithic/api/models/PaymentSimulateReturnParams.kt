...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is PaymentSimulateReturnParams && this.paymentToken == other.paymentToken && this.returnReasonCode == other.returnReasonCode && this.additionalQueryParams == other.additionalQueryParams && this.additionalHeaders == other.additionalHeaders && this.additionalBodyProperties == other.additionalBodyProperties /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(paymentToken, returnReasonCode, additionalQueryParams, additionalHeaders, additionalBodyProperties) /* spotless:on */
    }
