...
private constructor(
    ...
    companion object {
        ...
        fun none(): V2ListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(v2ListParams: V2ListParams) = apply {
            accountToken = v2ListParams.accountToken
            cardToken = v2ListParams.cardToken
            endingBefore = v2ListParams.endingBefore
            pageSize = v2ListParams.pageSize
            startingAfter = v2ListParams.startingAfter
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V2ListParams && accountToken == other.accountToken && cardToken == other.cardToken && endingBefore == other.endingBefore && pageSize == other.pageSize && startingAfter == other.startingAfter && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "V2ListParams{accountToken=$accountToken, cardToken=$cardToken, endingBefore=$endingBefore, pageSize=$pageSize, startingAfter=$startingAfter, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
