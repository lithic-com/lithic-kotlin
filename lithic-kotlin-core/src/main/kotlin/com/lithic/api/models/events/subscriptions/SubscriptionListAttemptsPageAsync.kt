...
import com.lithic.api.models.events.MessageAttempt
...
class SubscriptionListAttemptsPageAsync
private constructor(
    private val subscriptionsService: SubscriptionServiceAsync,
    private val params: SubscriptionListAttemptsParams,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SubscriptionListAttemptsPageAsync && subscriptionsService == other.subscriptionsService && params == other.params && response == other.response /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(subscriptionsService, params, response) /* spotless:on */

    override fun toString() =
        "SubscriptionListAttemptsPageAsync{subscriptionsService=$subscriptionsService, params=$params, response=$response}"

    fun hasNextPage(): Boolean {
        return !data().isEmpty()
    }

    fun getNextPageParams(): SubscriptionListAttemptsParams? {
        if (!hasNextPage()) {
            return null
        }
    ...
    suspend fun getNextPage(): SubscriptionListAttemptsPageAsync? {
    ...
    companion object {
        ...
        fun of(
            ...
            response: Response,
        ) = SubscriptionListAttemptsPageAsync(subscriptionsService, params, response)
    }
    ...
    class AutoPager(private val firstPage: SubscriptionListAttemptsPageAsync) :
        Flow<MessageAttempt> {
