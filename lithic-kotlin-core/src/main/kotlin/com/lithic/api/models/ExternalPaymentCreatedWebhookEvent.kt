...
class ExternalPaymentCreatedWebhookEvent
...
private constructor(
     ...
     */
    fun category(): ExternalPayment.ExternalPaymentCategory? = category.getNullable("category")
     ...
     *   server responded with an unexpected value).
     */
    fun events(): List<ExternalPayment.ExternalPaymentEvent>? = events.getNullable("events")
     ...
     *   server responded with an unexpected value).
     */
    fun family(): ExternalPayment.Family? = family.getNullable("family")
     ...
     *   server responded with an unexpected value).
     */
    fun paymentType(): ExternalPayment.ExternalPaymentDirection? =
        paymentType.getNullable("payment_type")
     ...
     *   server responded with an unexpected value).
     */
    fun result(): ExternalPayment.TransactionResult? = result.getNullable("result")
    ...
    /** A builder for [ExternalPaymentCreatedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(externalPaymentCreatedWebhookEvent: ExternalPaymentCreatedWebhookEvent) =
            apply {
                token = externalPaymentCreatedWebhookEvent.token
                created = externalPaymentCreatedWebhookEvent.created
                status = externalPaymentCreatedWebhookEvent.status
                updated = externalPaymentCreatedWebhookEvent.updated
                category = externalPaymentCreatedWebhookEvent.category
                currency = externalPaymentCreatedWebhookEvent.currency
                events = externalPaymentCreatedWebhookEvent.events.map { it.toMutableList() }
                family = externalPaymentCreatedWebhookEvent.family
                financialAccountToken = externalPaymentCreatedWebhookEvent.financialAccountToken
                paymentType = externalPaymentCreatedWebhookEvent.paymentType
                pendingAmount = externalPaymentCreatedWebhookEvent.pendingAmount
                result = externalPaymentCreatedWebhookEvent.result
                settledAmount = externalPaymentCreatedWebhookEvent.settledAmount
                userDefinedId = externalPaymentCreatedWebhookEvent.userDefinedId
                eventType = externalPaymentCreatedWebhookEvent.eventType
                additionalProperties =
                    externalPaymentCreatedWebhookEvent.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ExternalPaymentCreatedWebhookEvent].
         *
    ...
    fun validate(): ExternalPaymentCreatedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExternalPaymentCreatedWebhookEvent &&
            token == other.token &&
