...
private constructor(
    ...
    fun accountHolderCreated(): AccountHolderCreatedWebhookEvent? = accountHolderCreated

    /** KYB payload for an updated account holder. */
    fun kybPayload(): KybPayload? = kybPayload

    /** KYC payload for an updated account holder. */
    fun kycPayload(): KycPayload? = kycPayload

    /** Legacy payload for an updated account holder. */
    fun legacyPayload(): LegacyPayload? = legacyPayload

    fun accountHolderVerification(): AccountHolderVerificationWebhookEvent? =
    ...
    fun balanceUpdated(): BalanceUpdatedWebhookEvent? = balanceUpdated

    /** Book transfer transaction */
    fun bookTransferTransactionCreated(): BookTransferTransactionCreatedWebhookEvent? =
        bookTransferTransactionCreated

    /** Book transfer transaction */
    fun bookTransferTransactionUpdated(): BookTransferTransactionUpdatedWebhookEvent? =
        bookTransferTransactionUpdated

    fun cardCreated(): CardCreatedWebhookEvent? = cardCreated

    fun cardConverted(): CardConvertedWebhookEvent? = cardConverted

    fun cardPinUpdated(): CardPinUpdatedWebhookEvent? = cardPinUpdated

    fun cardRenewed(): CardRenewedWebhookEvent? = cardRenewed
    ...
    fun cardTransactionEnhancedDataCreated(): CardTransactionEnhancedDataCreatedWebhookEvent? =
    ...
    fun claimCreated(): ClaimCreatedWebhookEvent? = claimCreated

    fun claimUpdated(): ClaimUpdatedWebhookEvent? = claimUpdated

    fun claimDocumentUploaded(): ClaimDocumentUploadedWebhookEvent? = claimDocumentUploaded

    fun claimDocumentAccepted(): ClaimDocumentAcceptedWebhookEvent? = claimDocumentAccepted

    fun claimDocumentRejected(): ClaimDocumentRejectedWebhookEvent? = claimDocumentRejected
    ...
    fun digitalWalletTokenizationResult(): DigitalWalletTokenizationResultWebhookEvent? =
    ...
    fun digitalWalletTokenizationUpdated(): DigitalWalletTokenizationUpdatedWebhookEvent? =
        digitalWalletTokenizationUpdated

    /** Dispute. */
    fun disputeUpdated(): DisputeUpdatedWebhookEvent? = disputeUpdated

    /** Dispute evidence. */
    fun disputeEvidenceUploadFailed(): DisputeEvidenceUploadFailedWebhookEvent? =
        disputeEvidenceUploadFailed

    fun embedSessionGenerated(): EmbedSessionGeneratedWebhookEvent? = embedSessionGenerated

    fun embedViewed(): EmbedViewedWebhookEvent? = embedViewed

    fun externalBankAccountCreated(): ExternalBankAccountCreatedWebhookEvent? =
        externalBankAccountCreated

    fun externalBankAccountUpdated(): ExternalBankAccountUpdatedWebhookEvent? =
        externalBankAccountUpdated

    fun externalPaymentCreated(): ExternalPaymentCreatedWebhookEvent? = externalPaymentCreated

    fun externalPaymentUpdated(): ExternalPaymentUpdatedWebhookEvent? = externalPaymentUpdated

    fun financialAccountCreated(): FinancialAccountCreatedWebhookEvent? = financialAccountCreated

    fun financialAccountUpdated(): FinancialAccountUpdatedWebhookEvent? = financialAccountUpdated

    fun fundingEventCreated(): FundingEventCreatedWebhookEvent? = fundingEventCreated

    fun loanTapeCreated(): LoanTapeCreatedWebhookEvent? = loanTapeCreated

    fun loanTapeUpdated(): LoanTapeUpdatedWebhookEvent? = loanTapeUpdated

    fun managementOperationCreated(): ManagementOperationCreatedWebhookEvent? =
        managementOperationCreated

    fun managementOperationUpdated(): ManagementOperationUpdatedWebhookEvent? =
        managementOperationUpdated

    fun internalTransactionCreated(): InternalTransactionCreatedWebhookEvent? =
        internalTransactionCreated

    fun internalTransactionUpdated(): InternalTransactionUpdatedWebhookEvent? =
        internalTransactionUpdated

    fun networkTotalCreated(): NetworkTotalCreatedWebhookEvent? = networkTotalCreated

    fun networkTotalUpdated(): NetworkTotalUpdatedWebhookEvent? = networkTotalUpdated

    /** Payment transaction */
    fun paymentTransactionCreated(): PaymentTransactionCreatedWebhookEvent? =
        paymentTransactionCreated

    /** Payment transaction */
    fun paymentTransactionUpdated(): PaymentTransactionUpdatedWebhookEvent? =
        paymentTransactionUpdated

    fun settlementReportUpdated(): SettlementReportUpdatedWebhookEvent? = settlementReportUpdated

    fun statementsCreated(): StatementsCreatedWebhookEvent? = statementsCreated

    /** Represents a 3DS authentication */
    fun threeDSAuthenticationCreated(): ThreeDSAuthenticationCreatedWebhookEvent? =
        threeDSAuthenticationCreated

    /** Represents a 3DS authentication */
    fun threeDSAuthenticationUpdated(): ThreeDSAuthenticationUpdatedWebhookEvent? =
        threeDSAuthenticationUpdated

    fun threeDSAuthenticationChallenge(): ThreeDSAuthenticationChallengeWebhookEvent? =
        threeDSAuthenticationChallenge

    fun tokenizationApprovalRequest(): TokenizationApprovalRequestWebhookEvent? =
        tokenizationApprovalRequest

    fun tokenizationResult(): TokenizationResultWebhookEvent? = tokenizationResult
    ...
    /** The Dispute object tracks the progression of a dispute throughout its lifecycle. */
    fun disputeTransactionUpdated(): DisputeTransactionUpdatedWebhookEvent? =
     ...
     *     override fun visitAccountHolderCreated(accountHolderCreated: AccountHolderCreatedWebhookEvent): String? = accountHolderCreated.toString()
     *
     *     // ...
     *
        ...
        override fun ObjectCodec.deserialize(node: JsonNode): ParsedWebhookEvent {
            ...
            val bestMatches =
                sequenceOf(
                        ...
                        tryDeserialize(node, jacksonTypeRef<CardPinUpdatedWebhookEvent>())?.let {
    ...
    private constructor(
        ...
        internal fun validity(): Int =
            (if (token.asKnown() == null) 0 else 1) +
                (updateRequest.asKnown()?.validity() ?: 0) +
    ...
    private constructor(
        ...
        private constructor(
             ...
             * Used for best match union deserialization.
             */
            internal fun validity(): Int = (individual.asKnown()?.validity() ?: 0)
