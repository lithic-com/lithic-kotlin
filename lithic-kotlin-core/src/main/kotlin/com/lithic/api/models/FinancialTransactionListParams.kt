...
constructor(
    ...
    class Builder {
        ...
        internal fun from(financialTransactionListParams: FinancialTransactionListParams) = apply {
            ...
            additionalBodyProperties(financialTransactionListParams.additionalBodyProperties)
        }
