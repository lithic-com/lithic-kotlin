...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(v2PromoteResponse: V2PromoteResponse) = apply {
            ...
            businessAccountTokens =
                v2PromoteResponse.businessAccountTokens.map { it.toMutableList() }
            ...
            lithicManaged = v2PromoteResponse.lithicManaged
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is V2PromoteResponse &&
            token == other.token &&
    ...
    override fun toString() =
        "V2PromoteResponse{token=$token, accountTokens=$accountTokens, businessAccountTokens=$businessAccountTokens, cardTokens=$cardTokens, currentVersion=$currentVersion, draftVersion=$draftVersion, eventStream=$eventStream, lithicManaged=$lithicManaged, name=$name, programLevel=$programLevel, state=$state, type=$type, excludedCardTokens=$excludedCardTokens, additionalProperties=$additionalProperties}"
}
