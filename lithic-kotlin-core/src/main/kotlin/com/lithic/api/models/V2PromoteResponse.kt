...
private constructor(
    ...
    class Builder {
        ...
        internal fun from(v2PromoteResponse: V2PromoteResponse) = apply {
            ...
            cardTokens = v2PromoteResponse.cardTokens
            excludedCardTokens = v2PromoteResponse.excludedCardTokens
            accountTokens = v2PromoteResponse.accountTokens
    ...
    override fun toString() =
        "V2PromoteResponse{token=$token, state=$state, programLevel=$programLevel, cardTokens=$cardTokens, excludedCardTokens=$excludedCardTokens, accountTokens=$accountTokens, type=$type, currentVersion=$currentVersion, draftVersion=$draftVersion, name=$name, additionalProperties=$additionalProperties}"
}
