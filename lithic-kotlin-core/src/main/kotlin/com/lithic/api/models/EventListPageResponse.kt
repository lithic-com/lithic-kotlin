...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(eventListPageResponse: EventListPageResponse) = apply {
            ...
            hasMore = eventListPageResponse.hasMore
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is EventListPageResponse && data == other.data && hasMore == other.hasMore && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "EventListPageResponse{data=$data, hasMore=$hasMore, additionalProperties=$additionalProperties}"
}
