...
class ManagementOperationCreatedWebhookEvent
...
private constructor(
     ...
     */
    fun category(): ManagementOperationTransaction.ManagementOperationCategory? =
        category.getNullable("category")
     ...
     *   server responded with an unexpected value).
     */
    fun direction(): ManagementOperationTransaction.ManagementOperationDirection? =
        direction.getNullable("direction")

    /**
     * @throws LithicInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun events(): List<ManagementOperationTransaction.ManagementOperationEvent>? =
        events.getNullable("events")
     ...
     *   server responded with an unexpected value).
     */
    fun family(): ManagementOperationTransaction.Family? = family.getNullable("family")
     ...
     *   server responded with an unexpected value).
     */
    fun result(): ManagementOperationTransaction.TransactionResult? = result.getNullable("result")
     ...
     *   server responded with an unexpected value).
     */
    fun transactionSeries(): ManagementOperationTransaction.TransactionSeries? =
    ...
    /** A builder for [ManagementOperationCreatedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            managementOperationCreatedWebhookEvent: ManagementOperationCreatedWebhookEvent
        ) = apply {
            token = managementOperationCreatedWebhookEvent.token
            created = managementOperationCreatedWebhookEvent.created
            status = managementOperationCreatedWebhookEvent.status
            updated = managementOperationCreatedWebhookEvent.updated
            category = managementOperationCreatedWebhookEvent.category
            currency = managementOperationCreatedWebhookEvent.currency
            direction = managementOperationCreatedWebhookEvent.direction
            events = managementOperationCreatedWebhookEvent.events.map { it.toMutableList() }
            externalResource = managementOperationCreatedWebhookEvent.externalResource
            family = managementOperationCreatedWebhookEvent.family
            financialAccountToken = managementOperationCreatedWebhookEvent.financialAccountToken
            pendingAmount = managementOperationCreatedWebhookEvent.pendingAmount
            result = managementOperationCreatedWebhookEvent.result
            settledAmount = managementOperationCreatedWebhookEvent.settledAmount
            transactionSeries = managementOperationCreatedWebhookEvent.transactionSeries
            userDefinedId = managementOperationCreatedWebhookEvent.userDefinedId
            eventType = managementOperationCreatedWebhookEvent.eventType
            additionalProperties =
                managementOperationCreatedWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ManagementOperationCreatedWebhookEvent].
         *
         ...
         */
        fun build(): ManagementOperationCreatedWebhookEvent =
            ManagementOperationCreatedWebhookEvent(
    ...
    fun validate(): ManagementOperationCreatedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ManagementOperationCreatedWebhookEvent &&
            token == other.token &&
