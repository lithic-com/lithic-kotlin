...
private constructor(
     ...
     */
    fun nameValidation(): CardAuthorization.NameValidation? =
        nameValidation.getNullable("name_validation")
     ...
     *   server responded with an unexpected value).
     */
    fun serviceLocation(): CardAuthorization.ServiceLocation? =
     ...
     *   server responded with an unexpected value).
     */
    fun accountType(): CardAuthorization.AccountType? = accountType.getNullable("account_type")
     ...
     *   server responded with an unexpected value).
     */
    fun fleetInfo(): CardAuthorization.AsaRequestFleetInfo? = fleetInfo.getNullable("fleet_info")
     ...
     *   server responded with an unexpected value).
     */
    fun latestChallenge(): CardAuthorization.LatestChallenge? =
        latestChallenge.getNullable("latest_challenge")
     ...
     *   server responded with an unexpected value).
     */
    fun network(): CardAuthorization.Network? = network.getNullable("network")
     ...
     *   server responded with an unexpected value).
     */
    fun networkSpecificData(): CardAuthorization.AsaNetworkSpecificData? =
     ...
     *   server responded with an unexpected value).
     */
    fun pos(): CardAuthorization.Pos? = pos.getNullable("pos")
