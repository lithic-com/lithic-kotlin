...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun bulkOrderToken(): String? = body.bulkOrderToken()
     ...
     *   server responded with an unexpected value).
     */
    fun replacementComment(): String? = body.replacementComment()
     ...
     *   server responded with an unexpected value).
     */
    fun replacementSubstatus(): ReplacementSubstatus? = body.replacementSubstatus()
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun replacementComment(): String? = replacementComment.getNullable("replacement_comment")
         ...
         *   server responded with an unexpected value).
         */
        fun replacementSubstatus(): ReplacementSubstatus? =
            replacementSubstatus.getNullable("replacement_substatus")
        ...
        internal fun validity(): Int =
            (type.asKnown()?.validity() ?: 0) +
                ...
                (if (replacementAccountToken.asKnown() == null) 0 else 1) +
                (if (replacementComment.asKnown() == null) 0 else 1) +
                (if (replacementFor.asKnown() == null) 0 else 1) +
                (replacementSubstatus.asKnown()?.validity() ?: 0) +
    ...
    private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            fun of(value: String) = ReplacementSubstatus(JsonField.of(value))
        }
