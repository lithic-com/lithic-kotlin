...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is BalanceListPageAsync && this.balancesService == other.balancesService && this.params == other.params && this.response == other.response /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(balancesService, params, response) /* spotless:on */
    }
    ...
    fun getNextPageParams(): BalanceListParams? {
        return null
    }
    ...
    constructor(
        ...
        @JsonProperty("data") fun _data(): JsonField<List<Balance>>? = data
        ...
        override fun toString() =
            "BalanceListPageAsync.Response{data=$data, hasMore=$hasMore, additionalProperties=$additionalProperties}"
