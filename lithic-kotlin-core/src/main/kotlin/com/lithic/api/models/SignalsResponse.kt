...
private constructor(
     ...
     */
    fun approvedTxnAmountM2(): Double? = approvedTxnAmountM2.getNullable("approved_txn_amount_m2")
     ...
     *   server responded with an unexpected value).
     */
    fun approvedTxnAmountM2_30d(): Double? =
        approvedTxnAmountM2_30d.getNullable("approved_txn_amount_m2_30d")
     ...
     *   server responded with an unexpected value).
     */
    fun approvedTxnAmountM2_7d(): Double? =
        approvedTxnAmountM2_7d.getNullable("approved_txn_amount_m2_7d")
     ...
     *   server responded with an unexpected value).
     */
    fun approvedTxnAmountM2_90d(): Double? =
        approvedTxnAmountM2_90d.getNullable("approved_txn_amount_m2_90d")
     ...
     *   server responded with an unexpected value).
     */
    fun approvedTxnCount(): Long? = approvedTxnCount.getNullable("approved_txn_count")
     ...
     *   server responded with an unexpected value).
     */
    fun approvedTxnCount30d(): Long? = approvedTxnCount30d.getNullable("approved_txn_count_30d")
     ...
     *   server responded with an unexpected value).
     */
    fun approvedTxnCount7d(): Long? = approvedTxnCount7d.getNullable("approved_txn_count_7d")
     ...
     *   server responded with an unexpected value).
     */
    fun approvedTxnCount90d(): Long? = approvedTxnCount90d.getNullable("approved_txn_count_90d")
     ...
     *   server responded with an unexpected value).
     */
    fun avgTransactionAmount(): Double? = avgTransactionAmount.getNullable("avg_transaction_amount")
     ...
     *   server responded with an unexpected value).
     */
    fun avgTransactionAmount30d(): Double? =
        avgTransactionAmount30d.getNullable("avg_transaction_amount_30d")
     ...
     *   server responded with an unexpected value).
     */
    fun avgTransactionAmount7d(): Double? =
        avgTransactionAmount7d.getNullable("avg_transaction_amount_7d")
     ...
     *   server responded with an unexpected value).
     */
    fun avgTransactionAmount90d(): Double? =
        avgTransactionAmount90d.getNullable("avg_transaction_amount_90d")
     ...
     *   server responded with an unexpected value).
     */
    fun distinctCountryCount(): Long? = distinctCountryCount.getNullable("distinct_country_count")
     ...
     *   server responded with an unexpected value).
     */
    fun distinctMccCount(): Long? = distinctMccCount.getNullable("distinct_mcc_count")
     ...
     *   server responded with an unexpected value).
     */
    fun firstTxnAt(): OffsetDateTime? = firstTxnAt.getNullable("first_txn_at")
     ...
     *   server responded with an unexpected value).
     */
    fun isFirstTransaction(): Boolean? = isFirstTransaction.getNullable("is_first_transaction")
     ...
     *   server responded with an unexpected value).
     */
    fun lastCpCountry(): String? = lastCpCountry.getNullable("last_cp_country")
     ...
     *   server responded with an unexpected value).
     */
    fun lastCpPostalCode(): String? = lastCpPostalCode.getNullable("last_cp_postal_code")
     ...
     *   server responded with an unexpected value).
     */
    fun lastCpTimestamp(): OffsetDateTime? = lastCpTimestamp.getNullable("last_cp_timestamp")
     ...
     *   server responded with an unexpected value).
     */
    fun lastTxnApprovedAt(): OffsetDateTime? = lastTxnApprovedAt.getNullable("last_txn_approved_at")
     ...
     *   server responded with an unexpected value).
     */
    fun seenCountries(): List<String>? = seenCountries.getNullable("seen_countries")
     ...
     *   server responded with an unexpected value).
     */
    fun seenMccs(): List<String>? = seenMccs.getNullable("seen_mccs")
     ...
     *   server responded with an unexpected value).
     */
    fun seenMerchants(): List<String>? = seenMerchants.getNullable("seen_merchants")
     ...
     *   server responded with an unexpected value).
     */
    fun stdevTransactionAmount(): Double? =
        stdevTransactionAmount.getNullable("stdev_transaction_amount")
     ...
     *   server responded with an unexpected value).
     */
    fun stdevTransactionAmount30d(): Double? =
        stdevTransactionAmount30d.getNullable("stdev_transaction_amount_30d")
     ...
     *   server responded with an unexpected value).
     */
    fun stdevTransactionAmount7d(): Double? =
        stdevTransactionAmount7d.getNullable("stdev_transaction_amount_7d")
     ...
     *   server responded with an unexpected value).
     */
    fun stdevTransactionAmount90d(): Double? =
        stdevTransactionAmount90d.getNullable("stdev_transaction_amount_90d")
     ...
     *   server responded with an unexpected value).
     */
    fun threeDSSuccessCount(): Long? = threeDSSuccessCount.getNullable("three_ds_success_count")
     ...
     *   server responded with an unexpected value).
     */
    fun threeDSSuccessRate(): Double? = threeDSSuccessRate.getNullable("three_ds_success_rate")
     ...
     *   server responded with an unexpected value).
     */
    fun threeDSTotalCount(): Long? = threeDSTotalCount.getNullable("three_ds_total_count")
     ...
     *   server responded with an unexpected value).
     */
    fun timeSinceLastTransactionDays(): Double? =
        timeSinceLastTransactionDays.getNullable("time_since_last_transaction_days")
    ...
    internal fun validity(): Int =
        (if (approvedTxnAmountM2.asKnown() == null) 0 else 1) +
            (if (approvedTxnAmountM2_30d.asKnown() == null) 0 else 1) +
            (if (approvedTxnAmountM2_7d.asKnown() == null) 0 else 1) +
            (if (approvedTxnAmountM2_90d.asKnown() == null) 0 else 1) +
            (if (approvedTxnCount.asKnown() == null) 0 else 1) +
            (if (approvedTxnCount30d.asKnown() == null) 0 else 1) +
            (if (approvedTxnCount7d.asKnown() == null) 0 else 1) +
            (if (approvedTxnCount90d.asKnown() == null) 0 else 1) +
            (if (avgTransactionAmount.asKnown() == null) 0 else 1) +
            (if (avgTransactionAmount30d.asKnown() == null) 0 else 1) +
            (if (avgTransactionAmount7d.asKnown() == null) 0 else 1) +
            (if (avgTransactionAmount90d.asKnown() == null) 0 else 1) +
            (if (distinctCountryCount.asKnown() == null) 0 else 1) +
            (if (distinctMccCount.asKnown() == null) 0 else 1) +
            (if (firstTxnAt.asKnown() == null) 0 else 1) +
            (if (isFirstTransaction.asKnown() == null) 0 else 1) +
            (if (lastCpCountry.asKnown() == null) 0 else 1) +
            (if (lastCpPostalCode.asKnown() == null) 0 else 1) +
            (if (lastCpTimestamp.asKnown() == null) 0 else 1) +
            (if (lastTxnApprovedAt.asKnown() == null) 0 else 1) +
            (seenCountries.asKnown()?.size ?: 0) +
            (seenMccs.asKnown()?.size ?: 0) +
            (seenMerchants.asKnown()?.size ?: 0) +
            (if (stdevTransactionAmount.asKnown() == null) 0 else 1) +
            (if (stdevTransactionAmount30d.asKnown() == null) 0 else 1) +
            (if (stdevTransactionAmount7d.asKnown() == null) 0 else 1) +
            (if (stdevTransactionAmount90d.asKnown() == null) 0 else 1) +
            (if (threeDSSuccessCount.asKnown() == null) 0 else 1) +
            (if (threeDSSuccessRate.asKnown() == null) 0 else 1) +
            (if (threeDSTotalCount.asKnown() == null) 0 else 1) +
            (if (timeSinceLastTransactionDays.asKnown() == null) 0 else 1)
