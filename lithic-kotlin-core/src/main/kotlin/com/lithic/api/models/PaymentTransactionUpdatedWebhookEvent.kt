...
private constructor(
    ...
    /** A builder for [PaymentTransactionUpdatedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            paymentTransactionUpdatedWebhookEvent: PaymentTransactionUpdatedWebhookEvent
        ) = apply {
            token = paymentTransactionUpdatedWebhookEvent.token
            category = paymentTransactionUpdatedWebhookEvent.category
            created = paymentTransactionUpdatedWebhookEvent.created
            descriptor = paymentTransactionUpdatedWebhookEvent.descriptor
            direction = paymentTransactionUpdatedWebhookEvent.direction
            events = paymentTransactionUpdatedWebhookEvent.events.map { it.toMutableList() }
            family = paymentTransactionUpdatedWebhookEvent.family
            financialAccountToken = paymentTransactionUpdatedWebhookEvent.financialAccountToken
            method = paymentTransactionUpdatedWebhookEvent.method
            methodAttributes = paymentTransactionUpdatedWebhookEvent.methodAttributes
            pendingAmount = paymentTransactionUpdatedWebhookEvent.pendingAmount
            relatedAccountTokens = paymentTransactionUpdatedWebhookEvent.relatedAccountTokens
            result = paymentTransactionUpdatedWebhookEvent.result
            settledAmount = paymentTransactionUpdatedWebhookEvent.settledAmount
            ...
            externalBankAccountToken =
                paymentTransactionUpdatedWebhookEvent.externalBankAccountToken
            tags = paymentTransactionUpdatedWebhookEvent.tags
            type = paymentTransactionUpdatedWebhookEvent.type
            userDefinedId = paymentTransactionUpdatedWebhookEvent.userDefinedId
            eventType = paymentTransactionUpdatedWebhookEvent.eventType
            additionalProperties =
                paymentTransactionUpdatedWebhookEvent.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): PaymentTransactionUpdatedWebhookEvent =
            PaymentTransactionUpdatedWebhookEvent(
     ...
     *   expected type.
     */
    fun validate(): PaymentTransactionUpdatedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PaymentTransactionUpdatedWebhookEvent &&
            token == other.token &&
