...
private constructor(
    ...
    fun trailingWindowObject(): TrailingWindowObject? = trailingWindowObject

    /** Velocity over the current day since 00:00 / 12 AM in Eastern Time */
    fun fixedWindowDay(): FixedWindowDay? = fixedWindowDay

    /**
     * Velocity over the current week since 00:00 / 12 AM in Eastern Time on specified `day_of_week`
     */
    fun fixedWindowWeek(): FixedWindowWeek? = fixedWindowWeek

    /**
     * Velocity over the current month since 00:00 / 12 AM in Eastern Time on specified
     * `day_of_month`.
     */
    fun fixedWindowMonth(): FixedWindowMonth? = fixedWindowMonth
     ...
     * February 28th.
     */
    fun fixedWindowYear(): FixedWindowYear? = fixedWindowYear
     ...
     * import com.lithic.api.core.JsonValue
     *
     * val result: String? = velocityLimitPeriod.accept(object : VelocityLimitPeriod.Visitor<String?> {
     *     override fun visitTrailingWindowObject(trailingWindowObject: TrailingWindowObject): String? = trailingWindowObject.toString()
     *
     *     // ...
     *
    ...
    private constructor(
         ...
         */
        internal fun validity(): Int =
            (if (duration.asKnown() == null) 0 else 1) + (type.asKnown()?.validity() ?: 0)
    ...
    private constructor(
         ...
         */
        fun dayOfWeek(): Long? = dayOfWeek.getNullable("day_of_week")
         ...
         */
        internal fun validity(): Int =
            (type.asKnown()?.validity() ?: 0) + (if (dayOfWeek.asKnown() == null) 0 else 1)
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun dayOfMonth(): Long? = dayOfMonth.getNullable("day_of_month")
         ...
         */
        internal fun validity(): Int =
            (type.asKnown()?.validity() ?: 0) + (if (dayOfMonth.asKnown() == null) 0 else 1)
    ...
    private constructor(
        ...
        internal fun validity(): Int =
            (type.asKnown()?.validity() ?: 0) +
                (if (dayOfMonth.asKnown() == null) 0 else 1) +
