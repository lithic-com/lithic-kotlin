...
private constructor(
     ...
     */
    fun data(): List<AggregateBalanceListResponse> = data.getRequired("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<AggregateBalanceListResponse>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<AggregateBalanceListResponse>>? = null
         ...
         * `List<AggregateBalanceListResponse>` value instead. This method is primarily for setting
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CardAggregateBalanceListPageResponse && data == other.data && hasMore == other.hasMore && additionalProperties == other.additionalProperties /* spotless:on */
    }
