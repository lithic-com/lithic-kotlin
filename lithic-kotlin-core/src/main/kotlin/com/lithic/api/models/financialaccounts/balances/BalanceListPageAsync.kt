...
private constructor(
    ...
    class Response(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("data") data: JsonField<List<BalanceListResponse>> = JsonMissing.of(),
    ...
    class AutoPager(private val firstPage: BalanceListPageAsync) : Flow<BalanceListResponse> {
