...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(fundingEventRetrieveResponse: FundingEventRetrieveResponse) = apply {
            ...
            settlementBreakdowns =
                fundingEventRetrieveResponse.settlementBreakdowns.map { it.toMutableList() }
    ...
    internal fun validity(): Int =
        (if (token.asKnown() == null) 0 else 1) +
            ...
            (settlementBreakdowns.asKnown()?.sumOf { it.validity().toInt() } ?: 0) +
    ...
    private constructor(
        ...
        internal fun validity(): Int =
            (if (amount.asKnown() == null) 0 else 1) +
                (if (settlementDate.asKnown() == null) 0 else 1)
