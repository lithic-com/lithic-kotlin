...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V2ListPageAsync && v2Service == other.v2Service && params == other.params && response == other.response /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(v2Service, params, response) /* spotless:on */

    override fun toString() =
        "V2ListPageAsync{v2Service=$v2Service, params=$params, response=$response}"

    fun hasNextPage(): Boolean {
        return !data().isEmpty()
    }

    fun getNextPageParams(): V2ListParams? {
        if (!hasNextPage()) {
            return null
        }
    ...
    suspend fun getNextPage(): V2ListPageAsync? {
    ...
    companion object {
        ...
        fun of(v2Service: V2ServiceAsync, params: V2ListParams, response: Response) =
            V2ListPageAsync(v2Service, params, response)
    }
    ...
    class AutoPager(private val firstPage: V2ListPageAsync) : Flow<V2ListResponse> {
