...
private constructor(
    ...
    override fun toString() =
        "AuthRuleApplyResponse{data=$data, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        fun build(): AuthRuleApplyResponse =
            AuthRuleApplyResponse(data, additionalProperties.toUnmodifiable())
    }
}
