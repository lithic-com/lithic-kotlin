...
class LoanTapeListPage
private constructor(
    private val loanTapesService: LoanTapeService,
    private val params: LoanTapeListParams,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is LoanTapeListPage && loanTapesService == other.loanTapesService && params == other.params && response == other.response /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(loanTapesService, params, response) /* spotless:on */

    override fun toString() =
        "LoanTapeListPage{loanTapesService=$loanTapesService, params=$params, response=$response}"

    fun hasNextPage(): Boolean {
        return !data().isEmpty()
    }

    fun getNextPageParams(): LoanTapeListParams? {
        if (!hasNextPage()) {
            return null
        }
    ...
    fun getNextPage(): LoanTapeListPage? {
    ...
    companion object {
        ...
        fun of(loanTapesService: LoanTapeService, params: LoanTapeListParams, response: Response) =
            LoanTapeListPage(loanTapesService, params, response)
    }
    ...
    class Response(
        ...
        companion object {
            ...
            /** Returns a mutable builder for constructing an instance of [LoanTapeListPage]. */
            fun builder() = Builder()
        }
    ...
    class AutoPager(private val firstPage: LoanTapeListPage) : Sequence<LoanTape> {
