...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is LoanTapeListPageAsync && loanTapesService == other.loanTapesService && params == other.params && response == other.response /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(loanTapesService, params, response) /* spotless:on */

    override fun toString() =
        "LoanTapeListPageAsync{loanTapesService=$loanTapesService, params=$params, response=$response}"
    ...
    suspend fun getNextPage(): LoanTapeListPageAsync? {
    ...
    companion object {
        ...
        fun of(
            ...
            response: Response,
        ) = LoanTapeListPageAsync(loanTapesService, params, response)
    }
    ...
    class Response(
        ...
        companion object {
            ...
            /**
             * Returns a mutable builder for constructing an instance of [LoanTapeListPageAsync].
             */
            fun builder() = Builder()
        }
    ...
    class AutoPager(private val firstPage: LoanTapeListPageAsync) : Flow<LoanTape> {
