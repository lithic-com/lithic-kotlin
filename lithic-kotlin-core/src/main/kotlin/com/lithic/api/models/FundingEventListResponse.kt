...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(fundingEventListResponse: FundingEventListResponse) = apply {
            ...
            networkSettlementSummary =
                fundingEventListResponse.networkSettlementSummary.map { it.toMutableList() }
    ...
    internal fun validity(): Int =
        (if (token.asKnown() == null) 0 else 1) +
            (collectionResourceType.asKnown()?.validity() ?: 0) +
            (collectionTokens.asKnown()?.size ?: 0) +
            (if (created.asKnown() == null) 0 else 1) +
            (if (highWatermark.asKnown() == null) 0 else 1) +
            (networkSettlementSummary.asKnown()?.sumOf { it.validity().toInt() } ?: 0) +
            (if (previousHighWatermark.asKnown() == null) 0 else 1) +
    ...
    private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val BOOK_TRANSFER = of("BOOK_TRANSFER")

            val PAYMENT = of("PAYMENT")

            fun of(value: String) = CollectionResourceType(JsonField.of(value))
        }
    ...
    private constructor(
         ...
         */
        internal fun validity(): Int =
            (if (networkSettlementDate.asKnown() == null) 0 else 1) +
                (if (settledGrossAmount.asKnown() == null) 0 else 1)
