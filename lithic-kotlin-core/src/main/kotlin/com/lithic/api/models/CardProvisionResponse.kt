...
private constructor(
     ...
     */
    fun provisioningPayload(): ProvisioningPayload? =
        provisioningPayload.getNullable("provisioning_payload")
     ...
     */
    internal fun validity(): Int = (provisioningPayload.asKnown()?.validity() ?: 0)
    ...
    private constructor(
         ...
         * Pay wallet.
         */
        fun provisionResponse(): ProvisionResponse? = provisionResponse
         ...
         * import com.lithic.api.core.JsonValue
         *
         * val result: String? = provisioningPayload.accept(object : ProvisioningPayload.Visitor<String?> {
        ...
        companion object {
             ...
             */
            fun ofString(string: String) = ProvisioningPayload(string = string)
