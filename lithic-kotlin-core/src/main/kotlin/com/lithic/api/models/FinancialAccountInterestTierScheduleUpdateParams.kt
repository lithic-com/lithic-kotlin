...
private constructor(
     ...
     * ```kotlin
     * val myObject: MyClass = financialAccountInterestTierScheduleUpdateParams.penaltyRates().convert(MyClass::class.java)
     * ```
     */
     ...
     */
    fun tierName(): String? = body.tierName()
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```kotlin
     * val myObject: MyClass = financialAccountInterestTierScheduleUpdateParams.tierRates().convert(MyClass::class.java)
     * ```
     */
    ...
    private constructor(
         ...
         * This arbitrary value can be deserialized into a custom type using the `convert` method:
         * ```kotlin
         * val myObject: MyClass = updateTierScheduleEntryRequest.penaltyRates().convert(MyClass::class.java)
         * ```
         */
         ...
         *   server responded with an unexpected value).
         */
        fun tierName(): String? = tierName.getNullable("tier_name")
         ...
         * This arbitrary value can be deserialized into a custom type using the `convert` method:
         * ```kotlin
         * val myObject: MyClass = updateTierScheduleEntryRequest.tierRates().convert(MyClass::class.java)
         * ```
         */
         ...
         */
        internal fun validity(): Int = (if (tierName.asKnown() == null) 0 else 1)
