...
class CaseActivityType @JsonCreator private constructor(private val value: JsonField<String>) :
    ...
    companion object {
        ...
        val ASSIGNED_TO = of("ASSIGNED_TO")

        val RESOLUTION_OUTCOME = of("RESOLUTION_OUTCOME")

        val RESOLUTION_NOTES = of("RESOLUTION_NOTES")

        val TAGS = of("TAGS")

        val PRIORITY = of("PRIORITY")

        val COMMENT = of("COMMENT")

        val FILE = of("FILE")

        fun of(value: String) = CaseActivityType(JsonField.of(value))
    }
