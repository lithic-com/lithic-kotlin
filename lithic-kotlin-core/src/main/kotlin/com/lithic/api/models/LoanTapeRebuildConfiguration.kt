...
private constructor(
     ...
     */
    fun lastRebuild(): LocalDate? = lastRebuild.getNullable("last_rebuild")
     ...
     *   server responded with an unexpected value).
     */
    fun rebuildFrom(): LocalDate? = rebuildFrom.getNullable("rebuild_from")
    ...
    internal fun validity(): Int =
        (if (rebuildNeeded.asKnown() == null) 0 else 1) +
            (if (lastRebuild.asKnown() == null) 0 else 1) +
            (if (rebuildFrom.asKnown() == null) 0 else 1)
