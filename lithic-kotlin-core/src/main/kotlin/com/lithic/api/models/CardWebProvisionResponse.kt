...
private constructor(
    ...
    private constructor(
         ...
         */
        @JsonProperty("protected") @ExcludeMissing fun _protected(): JsonField<String> = protected
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.protected] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
