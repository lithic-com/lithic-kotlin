...
private constructor(
    ...
    fun appleWebPushProvisioning(): AppleWebPushProvisioningResponse? = appleWebPushProvisioning

    fun googleWebPushProvisioning(): GoogleWebPushProvisioningResponse? = googleWebPushProvisioning
     ...
     * import com.lithic.api.core.JsonValue
     *
     * val result: String? = cardWebProvisionResponse.accept(object : CardWebProvisionResponse.Visitor<String?> {
     *     override fun visitAppleWebPushProvisioning(appleWebPushProvisioning: AppleWebPushProvisioningResponse): String? = appleWebPushProvisioning.toString()
     *
     *     // ...
     *
    ...
    private constructor(
         ...
         */
        internal fun validity(): Int =
            (jws.asKnown()?.validity() ?: 0) + (if (state.asKnown() == null) 0 else 1)
        ...
        private constructor(
            ...
            private val protected: JsonField<String>,
            ...
            private constructor(
                ...
                @ExcludeMissing
                protected: JsonField<String> = JsonMissing.of(),
             ...
             */
            fun header(): WebPushProvisioningResponseHeader? = header.getNullable("header")
             ...
             *   the server responded with an unexpected value).
             */
            fun payload(): String? = payload.getNullable("payload")
             ...
             *   the server responded with an unexpected value).
             */
            fun protected(): String? = protected.getNullable("protected")
             ...
             *
             * Unlike [protected], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("protected")
            @ExcludeMissing
            fun _protected(): JsonField<String> = protected
            ...
            class Builder internal constructor() {
                ...
                private var protected: JsonField<String> = JsonMissing.of()
                ...
                internal fun from(webPushProvisioningResponseJws: WebPushProvisioningResponseJws) =
                    apply {
                        ...
                        protected = webPushProvisioningResponseJws.protected
                 ...
                 * integrity-protected by the JWS signature.
                 */
                fun protected(protected: String) = protected(JsonField.of(protected))

                /**
                 * Sets [Builder.protected] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.protected] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
             ...
             */
            internal fun validity(): Int =
                (header.asKnown()?.validity() ?: 0) +
                    (if (payload.asKnown() == null) 0 else 1) +
            ...
            private constructor(
                 ...
                 */
                fun kid(): String? = kid.getNullable("kid")
                 ...
                 * Used for best match union deserialization.
                 */
                internal fun validity(): Int = (if (kid.asKnown() == null) 0 else 1)
            ...
            override fun toString() =
                "WebPushProvisioningResponseJws{header=$header, payload=$payload, protected=$protected, signature=$signature, additionalProperties=$additionalProperties}"
        }
    ...
    private constructor(
         ...
         */
        fun googleOpc(): String? = googleOpc.getNullable("google_opc")
         ...
         *   server responded with an unexpected value).
         */
        fun tspOpc(): String? = tspOpc.getNullable("tsp_opc")
         ...
         */
        internal fun validity(): Int =
            (if (googleOpc.asKnown() == null) 0 else 1) + (if (tspOpc.asKnown() == null) 0 else 1)
