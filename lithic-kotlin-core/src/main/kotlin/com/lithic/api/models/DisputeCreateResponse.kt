...
private constructor(
    ...
    /** A builder for [DisputeCreateResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(disputeCreateResponse: DisputeCreateResponse) = apply {
            token = disputeCreateResponse.token
            amount = disputeCreateResponse.amount
            arbitrationDate = disputeCreateResponse.arbitrationDate
            created = disputeCreateResponse.created
            customerFiledDate = disputeCreateResponse.customerFiledDate
            customerNote = disputeCreateResponse.customerNote
            networkClaimIds = disputeCreateResponse.networkClaimIds.map { it.toMutableList() }
            networkFiledDate = disputeCreateResponse.networkFiledDate
            networkReasonCode = disputeCreateResponse.networkReasonCode
            prearbitrationDate = disputeCreateResponse.prearbitrationDate
            primaryClaimId = disputeCreateResponse.primaryClaimId
            reason = disputeCreateResponse.reason
            representmentDate = disputeCreateResponse.representmentDate
            resolutionDate = disputeCreateResponse.resolutionDate
            resolutionNote = disputeCreateResponse.resolutionNote
            resolutionReason = disputeCreateResponse.resolutionReason
            status = disputeCreateResponse.status
            transactionToken = disputeCreateResponse.transactionToken
            additionalProperties = disputeCreateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DisputeCreateResponse].
         *
         ...
         */
        fun build(): DisputeCreateResponse =
    ...
    fun validate(): DisputeCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DisputeCreateResponse &&
            token == other.token &&
            amount == other.amount &&
