...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(financialTransactionRetrieveParams: FinancialTransactionRetrieveParams) =
            apply {
                cardToken = financialTransactionRetrieveParams.cardToken
                financialTransactionToken =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is FinancialTransactionRetrieveParams && cardToken == other.cardToken && financialTransactionToken == other.financialTransactionToken && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "FinancialTransactionRetrieveParams{cardToken=$cardToken, financialTransactionToken=$financialTransactionToken, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
