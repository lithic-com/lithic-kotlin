...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CardFinancialTransactionListPage && this.financialTransactionsService == other.financialTransactionsService && this.params == other.params && this.response == other.response /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(financialTransactionsService, params, response) /* spotless:on */
    }
    ...
    constructor(
        ...
        override fun toString() =
            "CardFinancialTransactionListPage.Response{data=$data, hasMore=$hasMore, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: CardFinancialTransactionListPage,
