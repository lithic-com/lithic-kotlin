...
class CaseSortOrder @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
    ...
    companion object {
        ...
        val PRIORITY_DESC = of("PRIORITY_DESC")

        val PRIORITY_ASC = of("PRIORITY_ASC")

        val STATUS_DESC = of("STATUS_DESC")

        val STATUS_ASC = of("STATUS_ASC")

        fun of(value: String) = CaseSortOrder(JsonField.of(value))
    }
