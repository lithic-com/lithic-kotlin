...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun events(): List<HoldEvent>? = events.getNullable("events")
     ...
     *   server responded with an unexpected value).
     */
    fun expirationDatetime(): OffsetDateTime? =
        expirationDatetime.getNullable("expiration_datetime")
    ...
    internal fun validity(): Int =
        (if (token.asKnown() == null) 0 else 1) +
            ...
            (if (expirationDatetime.asKnown() == null) 0 else 1) +
