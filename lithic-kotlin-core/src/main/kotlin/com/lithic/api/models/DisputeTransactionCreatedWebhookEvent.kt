...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun disposition(): DisputeV2.Disposition? = disposition.getNullable("disposition")
     ...
     *   server responded with an unexpected value).
     */
    fun status(): DisputeV2.Status? = status.getNullable("status")
     ...
     *   server responded with an unexpected value).
     */
    fun transactionSeries(): DisputeV2.TransactionSeries? =
    ...
    /** A builder for [DisputeTransactionCreatedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            disputeTransactionCreatedWebhookEvent: DisputeTransactionCreatedWebhookEvent
        ) = apply {
            token = disputeTransactionCreatedWebhookEvent.token
            ...
            events = disputeTransactionCreatedWebhookEvent.events.map { it.toMutableList() }
            liabilityAllocation = disputeTransactionCreatedWebhookEvent.liabilityAllocation
            merchant = disputeTransactionCreatedWebhookEvent.merchant
            network = disputeTransactionCreatedWebhookEvent.network
            status = disputeTransactionCreatedWebhookEvent.status
            transactionSeries = disputeTransactionCreatedWebhookEvent.transactionSeries
            updated = disputeTransactionCreatedWebhookEvent.updated
            eventType = disputeTransactionCreatedWebhookEvent.eventType
            additionalProperties =
                disputeTransactionCreatedWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DisputeTransactionCreatedWebhookEvent].
         *
         ...
         */
        fun build(): DisputeTransactionCreatedWebhookEvent =
            DisputeTransactionCreatedWebhookEvent(
    ...
    fun validate(): DisputeTransactionCreatedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DisputeTransactionCreatedWebhookEvent &&
            token == other.token &&
