...
package com.lithic.api.models.cardprograms
...
private constructor(
    ...
    companion object {
        ...
        fun none(): CardProgramListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [CardProgramListParams]. */
        fun builder() = Builder()
    }
