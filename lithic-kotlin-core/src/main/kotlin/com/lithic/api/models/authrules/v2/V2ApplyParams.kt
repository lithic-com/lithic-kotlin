...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [V2ApplyParams].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(v2ApplyParams: V2ApplyParams) = apply {
            authRuleToken = v2ApplyParams.authRuleToken
            body = v2ApplyParams.body
            additionalHeaders = v2ApplyParams.additionalHeaders.toBuilder()
            additionalQueryParams = v2ApplyParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [V2ApplyParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V2ApplyParams && authRuleToken == other.authRuleToken && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "V2ApplyParams{authRuleToken=$authRuleToken, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
