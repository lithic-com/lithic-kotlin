...
private constructor(
    ...
    companion object {
        ...
        fun none(): TokenizationActivateParams = builder().build()
    ...
    /** A builder for [TokenizationActivateParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(tokenizationActivateParams: TokenizationActivateParams) = apply {
            tokenizationToken = tokenizationActivateParams.tokenizationToken
            additionalHeaders = tokenizationActivateParams.additionalHeaders.toBuilder()
            additionalQueryParams = tokenizationActivateParams.additionalQueryParams.toBuilder()
            additionalBodyProperties =
                tokenizationActivateParams.additionalBodyProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TokenizationActivateParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TokenizationActivateParams =
            TokenizationActivateParams(
                tokenizationToken,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is TokenizationActivateParams && tokenizationToken == other.tokenizationToken && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams && additionalBodyProperties == other.additionalBodyProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "TokenizationActivateParams{tokenizationToken=$tokenizationToken, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
