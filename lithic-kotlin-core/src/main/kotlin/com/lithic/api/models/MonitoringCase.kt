...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun collectionStopped(): OffsetDateTime? = collectionStopped.getNullable("collection_stopped")
     ...
     *   server responded with an unexpected value).
     */
    fun entity(): CaseEntity? = entity.getNullable("entity")
     ...
     *   server responded with an unexpected value).
     */
    fun resolved(): OffsetDateTime? = resolved.getNullable("resolved")
     ...
     *   server responded with an unexpected value).
     */
    fun ruleToken(): String? = ruleToken.getNullable("rule_token")
    ...
    internal fun validity(): Int =
        (if (token.asKnown() == null) 0 else 1) +
            ...
            (if (collectionStopped.asKnown() == null) 0 else 1) +
