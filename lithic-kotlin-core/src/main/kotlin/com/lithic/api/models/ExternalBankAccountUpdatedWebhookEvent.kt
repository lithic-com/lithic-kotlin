...
private constructor(
    ...
    /** A builder for [ExternalBankAccountUpdatedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            externalBankAccountUpdatedWebhookEvent: ExternalBankAccountUpdatedWebhookEvent
        ) = apply {
            token = externalBankAccountUpdatedWebhookEvent.token
            country = externalBankAccountUpdatedWebhookEvent.country
            created = externalBankAccountUpdatedWebhookEvent.created
            currency = externalBankAccountUpdatedWebhookEvent.currency
            lastFour = externalBankAccountUpdatedWebhookEvent.lastFour
            owner = externalBankAccountUpdatedWebhookEvent.owner
            ownerType = externalBankAccountUpdatedWebhookEvent.ownerType
            routingNumber = externalBankAccountUpdatedWebhookEvent.routingNumber
            state = externalBankAccountUpdatedWebhookEvent.state
            type = externalBankAccountUpdatedWebhookEvent.type
            verificationAttempts = externalBankAccountUpdatedWebhookEvent.verificationAttempts
            verificationMethod = externalBankAccountUpdatedWebhookEvent.verificationMethod
            verificationState = externalBankAccountUpdatedWebhookEvent.verificationState
            accountToken = externalBankAccountUpdatedWebhookEvent.accountToken
            address = externalBankAccountUpdatedWebhookEvent.address
            companyId = externalBankAccountUpdatedWebhookEvent.companyId
            dob = externalBankAccountUpdatedWebhookEvent.dob
            doingBusinessAs = externalBankAccountUpdatedWebhookEvent.doingBusinessAs
            financialAccountToken = externalBankAccountUpdatedWebhookEvent.financialAccountToken
            name = externalBankAccountUpdatedWebhookEvent.name
            userDefinedId = externalBankAccountUpdatedWebhookEvent.userDefinedId
            verificationFailedReason =
                externalBankAccountUpdatedWebhookEvent.verificationFailedReason
            eventType = externalBankAccountUpdatedWebhookEvent.eventType
            additionalProperties =
                externalBankAccountUpdatedWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ExternalBankAccountUpdatedWebhookEvent].
         *
         ...
         */
        fun build(): ExternalBankAccountUpdatedWebhookEvent =
            ExternalBankAccountUpdatedWebhookEvent(
    ...
    fun validate(): ExternalBankAccountUpdatedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (if (token.asKnown() == null) 0 else 1) +
            ...
            (if (verificationAttempts.asKnown() == null) 0 else 1) +
            ...
            (if (verificationFailedReason.asKnown() == null) 0 else 1) +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExternalBankAccountUpdatedWebhookEvent &&
            token == other.token &&
