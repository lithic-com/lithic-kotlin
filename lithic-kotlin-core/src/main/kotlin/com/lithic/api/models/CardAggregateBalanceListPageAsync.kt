...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CardAggregateBalanceListPageAsync && this.aggregateBalancesService == other.aggregateBalancesService && this.params == other.params && this.response == other.response /* spotless:on */
    }
