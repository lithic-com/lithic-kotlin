...
private constructor(
    ...
    /** A builder for [DigitalWalletTokenizationUpdatedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            accountToken = digitalWalletTokenizationUpdatedWebhookEvent.accountToken
            cardToken = digitalWalletTokenizationUpdatedWebhookEvent.cardToken
            created = digitalWalletTokenizationUpdatedWebhookEvent.created
            eventType = digitalWalletTokenizationUpdatedWebhookEvent.eventType
            tokenization = digitalWalletTokenizationUpdatedWebhookEvent.tokenization
            additionalProperties =
                digitalWalletTokenizationUpdatedWebhookEvent.additionalProperties.toMutableMap()
        }
    ...
    fun validate(): DigitalWalletTokenizationUpdatedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (if (accountToken.asKnown() == null) 0 else 1) +
            ...
            (tokenization.asKnown()?.validity() ?: 0)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DigitalWalletTokenizationUpdatedWebhookEvent &&
    ...
    override fun toString() =
        "DigitalWalletTokenizationUpdatedWebhookEvent{accountToken=$accountToken, cardToken=$cardToken, created=$created, eventType=$eventType, tokenization=$tokenization, additionalProperties=$additionalProperties}"
}
