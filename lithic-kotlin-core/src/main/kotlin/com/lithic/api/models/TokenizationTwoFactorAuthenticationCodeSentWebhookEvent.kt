...
private constructor(
    ...
    /** A builder for [TokenizationTwoFactorAuthenticationCodeSentWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            accountToken = tokenizationTwoFactorAuthenticationCodeSentWebhookEvent.accountToken
            activationMethod =
                tokenizationTwoFactorAuthenticationCodeSentWebhookEvent.activationMethod
            cardToken = tokenizationTwoFactorAuthenticationCodeSentWebhookEvent.cardToken
            created = tokenizationTwoFactorAuthenticationCodeSentWebhookEvent.created
            eventType = tokenizationTwoFactorAuthenticationCodeSentWebhookEvent.eventType
            tokenizationToken =
                tokenizationTwoFactorAuthenticationCodeSentWebhookEvent.tokenizationToken
            additionalProperties =
                tokenizationTwoFactorAuthenticationCodeSentWebhookEvent.additionalProperties
                    .toMutableMap()
        }
    ...
    fun validate(): TokenizationTwoFactorAuthenticationCodeSentWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TokenizationTwoFactorAuthenticationCodeSentWebhookEvent &&
    ...
    override fun toString() =
        "TokenizationTwoFactorAuthenticationCodeSentWebhookEvent{accountToken=$accountToken, activationMethod=$activationMethod, cardToken=$cardToken, created=$created, eventType=$eventType, tokenizationToken=$tokenizationToken, additionalProperties=$additionalProperties}"
}
