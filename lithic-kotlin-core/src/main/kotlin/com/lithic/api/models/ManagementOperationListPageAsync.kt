...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ManagementOperationListPageAsync && this.managementOperationsService == other.managementOperationsService && this.params == other.params && this.response == other.response /* spotless:on */
    }
