...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is StatementListPage && statementsService == other.statementsService && params == other.params && response == other.response /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(statementsService, params, response) /* spotless:on */

    override fun toString() =
        "StatementListPage{statementsService=$statementsService, params=$params, response=$response}"
    ...
    fun getNextPage(): StatementListPage? {
    ...
    companion object {
        ...
        fun of(
            ...
            response: Response,
        ) = StatementListPage(statementsService, params, response)
    }
    ...
    class Response(
        ...
        companion object {
            ...
            /** Returns a mutable builder for constructing an instance of [StatementListPage]. */
            fun builder() = Builder()
        }
    ...
    class AutoPager(private val firstPage: StatementListPage) : Sequence<Statement> {
