...
@JsonDeserialize(using = V2ListResultsResponse.Deserializer::class)
@JsonSerialize(using = V2ListResultsResponse.Serializer::class)
...
private constructor(
    ...
    fun authorizationResult(): AuthorizationResult? = authorizationResult

    fun authentication3dsResult(): Authentication3dsResult? = authentication3dsResult

    fun tokenizationResult(): TokenizationResult? = tokenizationResult

    fun achResult(): AchResult? = achResult

    fun cardTransactionUpdateResult(): CardTransactionUpdateResult? = cardTransactionUpdateResult

    fun achPaymentUpdateResult(): AchPaymentUpdateResult? = achPaymentUpdateResult
    ...
    fun asAuthentication3dsResult(): Authentication3dsResult =
        authentication3dsResult.getOrThrow("authentication3dsResult")

    fun asTokenizationResult(): TokenizationResult =
     ...
     * import com.lithic.api.core.JsonValue
     *
     * val result: String? = v2ListResultsResponse.accept(object : V2ListResultsResponse.Visitor<String?> {
     *     override fun visitAuthorizationResult(authorizationResult: AuthorizationResult): String? = authorizationResult.toString()
     *
     *     // ...
     *
    ...
    fun <T> accept(visitor: Visitor<T>): T =
        when {
            authorizationResult != null -> visitor.visitAuthorizationResult(authorizationResult)
            authentication3dsResult != null ->
    ...
    fun validate(): V2ListResultsResponse = apply {
        ...
        accept(
            object : Visitor<Unit> {
                override fun visitAuthorizationResult(authorizationResult: AuthorizationResult) {
                    authorizationResult.validate()
                }

                override fun visitAuthentication3dsResult(
                    authentication3dsResult: Authentication3dsResult
                ) {
                    authentication3dsResult.validate()
                }

                override fun visitTokenizationResult(tokenizationResult: TokenizationResult) {
    ...
    internal fun validity(): Int =
        accept(
            object : Visitor<Int> {
                override fun visitAuthorizationResult(authorizationResult: AuthorizationResult) =
                    authorizationResult.validity()

                override fun visitAuthentication3dsResult(
                    authentication3dsResult: Authentication3dsResult
                ) = authentication3dsResult.validity()
    ...
    override fun toString(): String =
        when {
            authorizationResult != null ->
                "V2ListResultsResponse{authorizationResult=$authorizationResult}"
            authentication3dsResult != null ->
    ...
    companion object {
        ...
        fun ofAuthorizationResult(authorizationResult: AuthorizationResult) =
            V2ListResultsResponse(authorizationResult = authorizationResult)

        fun ofAuthentication3dsResult(authentication3dsResult: Authentication3dsResult) =
            V2ListResultsResponse(authentication3dsResult = authentication3dsResult)

        fun ofTokenizationResult(tokenizationResult: TokenizationResult) =
            V2ListResultsResponse(tokenizationResult = tokenizationResult)
    ...
    /**
     * An interface that defines how to map each variant of [V2ListResultsResponse] to a value of
     * type [T].
     */
    interface Visitor<out T> {

        fun visitAuthorizationResult(authorizationResult: AuthorizationResult): T

        fun visitAuthentication3dsResult(authentication3dsResult: Authentication3dsResult): T

        fun visitTokenizationResult(tokenizationResult: TokenizationResult): T
         ...
         *
         * An instance of [V2ListResultsResponse] can contain an unknown variant if it was
        ...
        fun unknown(json: JsonValue?): T {
            throw LithicInvalidDataException("Unknown V2ListResultsResponse: $json")
        }
    }

    internal class Deserializer :
        BaseDeserializer<V2ListResultsResponse>(V2ListResultsResponse::class) {

        override fun ObjectCodec.deserialize(node: JsonNode): V2ListResultsResponse {
            val json = JsonValue.fromJsonNode(node)

            val bestMatches =
                sequenceOf(
                        tryDeserialize(node, jacksonTypeRef<AuthorizationResult>())?.let {
                            V2ListResultsResponse(authorizationResult = it, _json = json)
                        },
                        tryDeserialize(node, jacksonTypeRef<Authentication3dsResult>())?.let {
                            V2ListResultsResponse(authentication3dsResult = it, _json = json)
                        },
                        tryDeserialize(node, jacksonTypeRef<TokenizationResult>())?.let {
                            V2ListResultsResponse(tokenizationResult = it, _json = json)
                        },
                        tryDeserialize(node, jacksonTypeRef<AchResult>())?.let {
                            V2ListResultsResponse(achResult = it, _json = json)
                        },
                        tryDeserialize(node, jacksonTypeRef<CardTransactionUpdateResult>())?.let {
                            V2ListResultsResponse(cardTransactionUpdateResult = it, _json = json)
                        },
                        tryDeserialize(node, jacksonTypeRef<AchPaymentUpdateResult>())?.let {
            ...
            return when (bestMatches.size) {
                ...
                0 -> V2ListResultsResponse(_json = json)
    ...
    internal class Serializer :
        BaseSerializer<V2ListResultsResponse>(V2ListResultsResponse::class) {

        override fun serialize(
            value: V2ListResultsResponse,
            generator: JsonGenerator,
            provider: SerializerProvider,
        ) {
            when {
                value.authorizationResult != null ->
                    generator.writeObject(value.authorizationResult)
                value.authentication3dsResult != null ->
    ...
    private constructor(
        ...
        companion object {
            ...
            /**
             * Returns a mutable builder for constructing an instance of [AuthorizationResult].
             *
        ...
        /** A builder for [AuthorizationResult]. */
        class Builder internal constructor() {
            ...
            internal fun from(authorizationResult: AuthorizationResult) = apply {
                ...
                actions = authorizationResult.actions.map { it.toMutableList() }
                authRuleToken = authorizationResult.authRuleToken
                evaluationTime = authorizationResult.evaluationTime
                eventStream = authorizationResult.eventStream
             ...
             */
            fun addAction(challengeActionAuthorization: Action.ChallengeActionAuthorization) =
                addAction(Action.ofChallengeActionAuthorization(challengeActionAuthorization))
            ...
            /**
             * Returns an immutable instance of [AuthorizationResult].
             *
         ...
         *   expected type.
         */
        fun validate(): AuthorizationResult = apply {
            if (validated) {
                return@apply
            }
        ...
        internal fun validity(): Int =
            (if (token.asKnown() == null) 0 else 1) +
                ...
                (if (evaluationTime.asKnown() == null) 0 else 1) +
        ...
        private constructor(
            ...
            fun declineActionAuthorization(): DeclineActionAuthorization? =
                declineActionAuthorization

            fun challengeActionAuthorization(): ChallengeActionAuthorization? =
                challengeActionAuthorization

            fun isDeclineActionAuthorization(): Boolean = declineActionAuthorization != null

            fun isChallengeActionAuthorization(): Boolean = challengeActionAuthorization != null
             ...
             *     override fun visitDeclineActionAuthorization(declineActionAuthorization: DeclineActionAuthorization): String? = declineActionAuthorization.toString()
             *
             *     // ...
             *
             *     override fun unknown(json: JsonValue?): String? {
            ...
            fun <T> accept(visitor: Visitor<T>): T =
                when {
                    ...
                    challengeActionAuthorization != null ->
                        visitor.visitChallengeActionAuthorization(challengeActionAuthorization)
                    else -> visitor.unknown(_json)
                }
            ...
            override fun hashCode(): Int =
                Objects.hash(declineActionAuthorization, challengeActionAuthorization)
            ...
            private constructor(
                 ...
                 * type.
                 */
                @JsonProperty("code") @ExcludeMissing fun _code(): JsonField<DetailedResult> = code
                ...
                class Builder internal constructor() {
                    ...
                    internal fun from(declineActionAuthorization: DeclineActionAuthorization) =
                        apply {
                            code = declineActionAuthorization.code
                            type = declineActionAuthorization.type
                            explanation = declineActionAuthorization.explanation
                     ...
                     *
                     * You should usually call [Builder.code] with a well-typed [DetailedResult]
                ...
                private constructor(private val value: JsonField<String>) : Enum {
                    ...
                    companion object {
                        ...
                        val ACCOUNT_PAUSED = of("ACCOUNT_PAUSED")
                        ...
                        val CARDHOLDER_CHALLENGED = of("CARDHOLDER_CHALLENGED")
                    ...
                    fun known(): Known =
                        when (this) {
                            ...
                            CARDHOLDER_CHALLENGE_FAILED -> Known.CARDHOLDER_CHALLENGE_FAILED
                                ...
                                throw LithicInvalidDataException("Unknown DetailedResult: $value")
                        }
                ...
                private val hashCode: Int by lazy {
                    Objects.hash(code, type, explanation, additionalProperties)
                }

                override fun hashCode(): Int = hashCode

                override fun toString() =
                    "DeclineActionAuthorization{code=$code, type=$type, explanation=$explanation, additionalProperties=$additionalProperties}"
            }
            ...
            private constructor(
                ...
                class Builder internal constructor() {
                    ...
                    internal fun from(challengeActionAuthorization: ChallengeActionAuthorization) =
                        apply {
                ...
                private val hashCode: Int by lazy {
                    Objects.hash(type, explanation, additionalProperties)
                }

                override fun hashCode(): Int = hashCode

                override fun toString() =
                    "ChallengeActionAuthorization{type=$type, explanation=$explanation, additionalProperties=$additionalProperties}"
            }
        }
    ...
    private constructor(
        ...
        companion object {
            ...
            /**
             * Returns a mutable builder for constructing an instance of [Authentication3dsResult].
             *
             * The following fields are required:
             * ```kotlin
             * .token()
        ...
        /** A builder for [Authentication3dsResult]. */
        class Builder internal constructor() {
            ...
            internal fun from(authentication3dsResult: Authentication3dsResult) = apply {
                token = authentication3dsResult.token
                actions = authentication3dsResult.actions.map { it.toMutableList() }
                authRuleToken = authentication3dsResult.authRuleToken
                evaluationTime = authentication3dsResult.evaluationTime
                eventStream = authentication3dsResult.eventStream
            ...
            /**
             * Returns an immutable instance of [Authentication3dsResult].
             *
             * Further updates to this [Builder] will not mutate the returned instance.
             *
             * The following fields are required:
         ...
         *   expected type.
         */
        fun validate(): Authentication3dsResult = apply {
            if (validated) {
                return@apply
            }
        ...
        private constructor(
             ...
             */
            internal fun validity(): Int =
                (type.asKnown()?.validity() ?: 0) + (if (explanation.asKnown() == null) 0 else 1)
            ...
            private constructor(private val value: JsonField<String>) : Enum {
                ...
                /**
                 * An enum containing [Authentication3dsAction]'s known values, as well as an
                 * [_UNKNOWN] member.
                 *
                ...
                enum class Value {
                    ...
                    CHALLENGE,
                    /**
                     * An enum member indicating that [Authentication3dsAction] was instantiated
            ...
            override fun toString() =
                "Action{type=$type, explanation=$explanation, additionalProperties=$additionalProperties}"
        }
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is Authentication3dsResult &&
                token == other.token &&
                actions == other.actions &&
                authRuleToken == other.authRuleToken &&
                evaluationTime == other.evaluationTime &&
    ...
    private constructor(
        ...
        /** A builder for [TokenizationResult]. */
        class Builder internal constructor() {
            ...
            internal fun from(tokenizationResult: TokenizationResult) = apply {
                ...
                actions = tokenizationResult.actions.map { it.toMutableList() }
                authRuleToken = tokenizationResult.authRuleToken
                evaluationTime = tokenizationResult.evaluationTime
                eventStream = tokenizationResult.eventStream
            ...
            /**
             * Returns an immutable instance of [TokenizationResult].
             *
             * Further updates to this [Builder] will not mutate the returned instance.
             *
             * The following fields are required:
         ...
         *   expected type.
         */
        fun validate(): TokenizationResult = apply {
            if (validated) {
                return@apply
            }
        ...
        private constructor(
             ...
             *
             * val result: String? = action.accept(object : Action.Visitor<String?> {
             *     override fun visitDeclineActionTokenization(declineActionTokenization: DeclineActionTokenization): String? = declineActionTokenization.toString()
             *
             *     // ...
             *
             *     override fun unknown(json: JsonValue?): String? {
            ...
            private constructor(
                ...
                class Builder internal constructor() {
                    ...
                    internal fun from(declineActionTokenization: DeclineActionTokenization) =
                        apply {
                            type = declineActionTokenization.type
                            explanation = declineActionTokenization.explanation
                ...
                private constructor(private val value: JsonField<String>) : Enum {
                    ...
                    companion object {
                        ...
                        val ACCOUNT_SCORE_1 = of("ACCOUNT_SCORE_1")

                        val DEVICE_SCORE_1 = of("DEVICE_SCORE_1")
                        ...
                        val CVC_MISMATCH = of("CVC_MISMATCH")
                        ...
                        val CUSTOMER_RED_PATH = of("CUSTOMER_RED_PATH")

                        val INVALID_CUSTOMER_RESPONSE = of("INVALID_CUSTOMER_RESPONSE")

                        val NETWORK_FAILURE = of("NETWORK_FAILURE")

                        val GENERIC_DECLINE = of("GENERIC_DECLINE")
                ...
                private val hashCode: Int by lazy {
                    Objects.hash(type, explanation, reason, additionalProperties)
                }

                override fun hashCode(): Int = hashCode

                override fun toString() =
                    "DeclineActionTokenization{type=$type, explanation=$explanation, reason=$reason, additionalProperties=$additionalProperties}"
            }
            ...
            private constructor(
                ...
                class Builder internal constructor() {
                    ...
                    internal fun from(requireTfaAction: RequireTfaAction) = apply {
                        ...
                        explanation = requireTfaAction.explanation
                ...
                class Type @JsonCreator private constructor(private val value: JsonField<String>) :
                    ...
                    companion object {
                        ...
                        val REQUIRE_TFA = of("REQUIRE_TFA")
                ...
                private constructor(private val value: JsonField<String>) : Enum {
                    ...
                    companion object {
                        ...
                        val WALLET_RECOMMENDED_TFA = of("WALLET_RECOMMENDED_TFA")

                        val SUSPICIOUS_ACTIVITY = of("SUSPICIOUS_ACTIVITY")

                        val DEVICE_RECENTLY_LOST = of("DEVICE_RECENTLY_LOST")

                        val TOO_MANY_RECENT_ATTEMPTS = of("TOO_MANY_RECENT_ATTEMPTS")

                        val TOO_MANY_RECENT_TOKENS = of("TOO_MANY_RECENT_TOKENS")

                        val TOO_MANY_DIFFERENT_CARDHOLDERS = of("TOO_MANY_DIFFERENT_CARDHOLDERS")

                        val OUTSIDE_HOME_TERRITORY = of("OUTSIDE_HOME_TERRITORY")

                        val HAS_SUSPENDED_TOKENS = of("HAS_SUSPENDED_TOKENS")

                        val HIGH_RISK = of("HIGH_RISK")

                        val ACCOUNT_SCORE_LOW = of("ACCOUNT_SCORE_LOW")

                        val DEVICE_SCORE_LOW = of("DEVICE_SCORE_LOW")

                        val CARD_STATE_TFA = of("CARD_STATE_TFA")

                        val HARDCODED_TFA = of("HARDCODED_TFA")

                        val CUSTOMER_RULE_TFA = of("CUSTOMER_RULE_TFA")
                ...
                override fun toString() =
                    "RequireTfaAction{type=$type, explanation=$explanation, reason=$reason, additionalProperties=$additionalProperties}"
            }
        }
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is TokenizationResult &&
                token == other.token &&
                actions == other.actions &&
                authRuleToken == other.authRuleToken &&
                evaluationTime == other.evaluationTime &&
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(achResult: AchResult) = apply {
                token = achResult.token
                actions = achResult.actions.map { it.toMutableList() }
                authRuleToken = achResult.authRuleToken
                evaluationTime = achResult.evaluationTime
                eventStream = achResult.eventStream
            ...
            /** Alias for calling [addAction] with `Action.ofApproveActionAch(approveActionAch)`. */
            ...
            /**
             * Returns an immutable instance of [AchResult].
             *
             * Further updates to this [Builder] will not mutate the returned instance.
             *
             * The following fields are required:
        ...
        private constructor(
            ...
            fun approveActionAch(): ApproveActionAch? = approveActionAch

            fun returnAction(): ReturnAction? = returnAction
             ...
             *
             * val result: String? = action.accept(object : Action.Visitor<String?> {
             *     override fun visitApproveActionAch(approveActionAch: ApproveActionAch): String? = approveActionAch.toString()
             *
             *     // ...
             *
             *     override fun unknown(json: JsonValue?): String? {
            ...
            private constructor(
                ...
                class Builder internal constructor() {
                    ...
                    internal fun from(approveActionAch: ApproveActionAch) = apply {
                        ...
                        explanation = approveActionAch.explanation
                ...
                override fun toString() =
                    "ApproveActionAch{type=$type, explanation=$explanation, additionalProperties=$additionalProperties}"
            }
            ...
            private constructor(
                ...
                class Builder internal constructor() {
                    ...
                    internal fun from(returnAction: ReturnAction) = apply {
                        ...
                        explanation = returnAction.explanation
                        additionalProperties = returnAction.additionalProperties.toMutableMap()
                    }

                    /**
                     * NACHA return code to use when returning the transaction. Note that the list
                     * of available return codes is subject to an allowlist configured at the
                     * program level
                     */
                ...
                override fun toString() =
                    "ReturnAction{code=$code, type=$type, explanation=$explanation, additionalProperties=$additionalProperties}"
            }
        }
    ...
    private constructor(
        ...
        private constructor(
            ...
            companion object {
                ...
                fun ofTag(tag: TagAction) = Action(tag = tag)
            ...
            private constructor(
                ...
                class Builder internal constructor() {
                    ...
                    internal fun from(tagAction: TagAction) = apply {
                        ...
                        explanation = tagAction.explanation
                ...
                private val hashCode: Int by lazy {
                    Objects.hash(key, type, value, explanation, additionalProperties)
                }

                override fun hashCode(): Int = hashCode

                override fun toString() =
                    "TagAction{key=$key, type=$type, value=$value, explanation=$explanation, additionalProperties=$additionalProperties}"
            }
            ...
            private constructor(
                 ...
                 *
                 * Unlike [queueToken], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("queue_token")
                @ExcludeMissing
                ...
                class Builder internal constructor() {
                    ...
                    internal fun from(createCaseAction: CreateCaseAction) = apply {
                        ...
                        explanation = createCaseAction.explanation
                ...
                private val hashCode: Int by lazy {
                    Objects.hash(queueToken, scope, type, explanation, additionalProperties)
                }

                override fun hashCode(): Int = hashCode

                override fun toString() =
                    "CreateCaseAction{queueToken=$queueToken, scope=$scope, type=$type, explanation=$explanation, additionalProperties=$additionalProperties}"
            }
        }
        ...
        class EventStream @JsonCreator private constructor(private val value: JsonField<String>) :
            ...
            companion object {
                ...
                val CARD_TRANSACTION_UPDATE = of("CARD_TRANSACTION_UPDATE")
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is CardTransactionUpdateResult &&
                token == other.token &&
                actions == other.actions &&
                authRuleToken == other.authRuleToken &&
                evaluationTime == other.evaluationTime &&
        ...
        override fun toString() =
            "CardTransactionUpdateResult{token=$token, actions=$actions, authRuleToken=$authRuleToken, evaluationTime=$evaluationTime, eventStream=$eventStream, eventToken=$eventToken, mode=$mode, ruleVersion=$ruleVersion, transactionToken=$transactionToken, additionalProperties=$additionalProperties}"
    }

    class AchPaymentUpdateResult
    @JsonCreator(mode = JsonCreator.Mode.DISABLED)
    private constructor(
        private val token: JsonField<String>,
        private val actions: JsonField<List<Action>>,
        ...
        companion object {
            ...
            /**
             * Returns a mutable builder for constructing an instance of [AchPaymentUpdateResult].
             *
             * The following fields are required:
             * ```kotlin
             * .token()
        ...
        /** A builder for [AchPaymentUpdateResult]. */
        class Builder internal constructor() {
            ...
            internal fun from(achPaymentUpdateResult: AchPaymentUpdateResult) = apply {
                token = achPaymentUpdateResult.token
                actions = achPaymentUpdateResult.actions.map { it.toMutableList() }
                authRuleToken = achPaymentUpdateResult.authRuleToken
                evaluationTime = achPaymentUpdateResult.evaluationTime
                eventStream = achPaymentUpdateResult.eventStream
                eventToken = achPaymentUpdateResult.eventToken
                mode = achPaymentUpdateResult.mode
                ruleVersion = achPaymentUpdateResult.ruleVersion
                transactionToken = achPaymentUpdateResult.transactionToken
                additionalProperties = achPaymentUpdateResult.additionalProperties.toMutableMap()
            }
            ...
            /**
             * Returns an immutable instance of [AchPaymentUpdateResult].
             *
             * Further updates to this [Builder] will not mutate the returned instance.
             *
             * The following fields are required:
         ...
         *   expected type.
         */
        fun validate(): AchPaymentUpdateResult = apply {
            if (validated) {
                return@apply
            }
        ...
        class EventStream @JsonCreator private constructor(private val value: JsonField<String>) :
            ...
            companion object {
                ...
                val ACH_PAYMENT_UPDATE = of("ACH_PAYMENT_UPDATE")
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is AchPaymentUpdateResult &&
                token == other.token &&
                actions == other.actions &&
                authRuleToken == other.authRuleToken &&
                evaluationTime == other.evaluationTime &&
        ...
        override fun toString() =
            "AchPaymentUpdateResult{token=$token, actions=$actions, authRuleToken=$authRuleToken, evaluationTime=$evaluationTime, eventStream=$eventStream, eventToken=$eventToken, mode=$mode, ruleVersion=$ruleVersion, transactionToken=$transactionToken, additionalProperties=$additionalProperties}"
    }
}
