...
private constructor(
    ...
    fun financialTransaction(): FinancialTransaction? = financialTransaction

    /** Book transfer transaction */
    fun bookTransferTransaction(): BookTransferTransaction? = bookTransferTransaction

    /** Base class for all transaction types in the ledger service */
    fun cardTransaction(): CardTransaction? = cardTransaction

    /** Payment transaction */
    fun paymentTransaction(): PaymentTransaction? = paymentTransaction

    fun externalPayment(): ExternalPayment? = externalPayment

    fun managementOperationTransaction(): ManagementOperationTransaction? =
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun externalResource(): ExternalResource? =
            externalResource.getNullable("external_resource")
        ...
        internal fun validity(): Int =
            (if (token.asKnown() == null) 0 else 1) +
                ...
                (events.asKnown()?.size ?: 0) +
                (family.asKnown()?.validity() ?: 0) +
                (if (fromFinancialAccountToken.asKnown() == null) 0 else 1) +
                (if (pendingAmount.asKnown() == null) 0 else 1) +
                (result.asKnown()?.validity() ?: 0) +
                (if (settledAmount.asKnown() == null) 0 else 1) +
                (status.asKnown()?.validity() ?: 0) +
                (if (toFinancialAccountToken.asKnown() == null) 0 else 1) +
                (if (updated.asKnown() == null) 0 else 1) +
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is BookTransferTransaction && token == other.token && category == other.category && created == other.created && currency == other.currency && events == other.events && family == other.family && fromFinancialAccountToken == other.fromFinancialAccountToken && pendingAmount == other.pendingAmount && result == other.result && settledAmount == other.settledAmount && status == other.status && toFinancialAccountToken == other.toFinancialAccountToken && updated == other.updated && externalId == other.externalId && externalResource == other.externalResource && transactionSeries == other.transactionSeries && additionalProperties == other.additionalProperties /* spotless:on */
        }

        /* spotless:off */
        private val hashCode: Int by lazy { Objects.hash(token, category, created, currency, events, family, fromFinancialAccountToken, pendingAmount, result, settledAmount, status, toFinancialAccountToken, updated, externalId, externalResource, transactionSeries, additionalProperties) }
        /* spotless:on */
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun avs(): Transaction.Avs? = avs.getNullable("avs")
         ...
         *   server responded with an unexpected value).
         */
        fun network(): Transaction.Network? = network.getNullable("network")
         ...
         *   server responded with an unexpected value).
         */
        fun events(): List<Transaction.TransactionEvent>? = events.getNullable("events")
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun expectedReleaseDate(): LocalDate? =
            expectedReleaseDate.getNullable("expected_release_date")
        ...
        private constructor(
            ...
            fun ach(): AchMethodAttributes? = ach
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return /* spotless:off */ other is MethodAttributes && ach == other.ach && wire == other.wire /* spotless:on */
            }

            override fun hashCode(): Int = /* spotless:off */ Objects.hash(ach, wire) /* spotless:on */
            ...
            private constructor(
                 ...
                 *   if the server responded with an unexpected value).
                 */
                fun traceNumbers(): List<String>? = traceNumbers.getNullable("trace_numbers")
                ...
                internal fun validity(): Int =
                    (secCode.asKnown()?.validity() ?: 0) +
                        ...
                        (if (retries.asKnown() == null) 0 else 1) +
                        (if (returnReasonCode.asKnown() == null) 0 else 1) +
                        (traceNumbers.asKnown()?.size ?: 0)
                ...
                override fun equals(other: Any?): Boolean {
                    ...
                    return /* spotless:off */ other is AchMethodAttributes && secCode == other.secCode && addenda == other.addenda && companyId == other.companyId && receiptRoutingNumber == other.receiptRoutingNumber && retries == other.retries && returnReasonCode == other.returnReasonCode && traceNumbers == other.traceNumbers && additionalProperties == other.additionalProperties /* spotless:on */
                }

                /* spotless:off */
                private val hashCode: Int by lazy { Objects.hash(secCode, addenda, companyId, receiptRoutingNumber, retries, returnReasonCode, traceNumbers, additionalProperties) }
                /* spotless:on */
            ...
            private constructor(
                 ...
                 *   if the server responded with an unexpected value).
                 */
                fun externalBankName(): String? = externalBankName.getNullable("external_bank_name")
                 ...
                 *   if the server responded with an unexpected value).
                 */
                fun externalBankRoutingNumber(): String? =
                    externalBankRoutingNumber.getNullable("external_bank_routing_number")
                 ...
                 *   if the server responded with an unexpected value).
                 */
                fun externalIndividualName(): String? =
                    externalIndividualName.getNullable("external_individual_name")
                 ...
                 *   if the server responded with an unexpected value).
                 */
                fun lithicBankName(): String? = lithicBankName.getNullable("lithic_bank_name")
                 ...
                 *   if the server responded with an unexpected value).
                 */
                fun lithicBankRoutingNumber(): String? =
                    lithicBankRoutingNumber.getNullable("lithic_bank_routing_number")
                 ...
                 *   if the server responded with an unexpected value).
                 */
                fun lithicIndividualName(): String? =
                    lithicIndividualName.getNullable("lithic_individual_name")
                 ...
                 *   if the server responded with an unexpected value).
                 */
                fun previousTransfer(): String? = previousTransfer.getNullable("previous_transfer")
                 ...
                 */
                internal fun validity(): Int =
                    (wireTransferType.asKnown()?.validity() ?: 0) +
                        (if (externalBankName.asKnown() == null) 0 else 1) +
                        (if (externalBankRoutingNumber.asKnown() == null) 0 else 1) +
                        (if (externalIndividualName.asKnown() == null) 0 else 1) +
                        (if (lithicBankName.asKnown() == null) 0 else 1) +
                        (if (lithicBankRoutingNumber.asKnown() == null) 0 else 1) +
                        (if (lithicIndividualName.asKnown() == null) 0 else 1) +
                        (if (previousTransfer.asKnown() == null) 0 else 1)
                ...
                private constructor(private val value: JsonField<String>) : Enum {
                    ...
                    companion object {
                        ...
                        val FEDWIRE = of("FEDWIRE")

                        val SWIFT = of("SWIFT")

                        fun of(value: String) = WireTransferType(JsonField.of(value))
                    }
                    ...
                    override fun equals(other: Any?): Boolean {
                        ...
                        return /* spotless:off */ other is WireTransferType && value == other.value /* spotless:on */
                    }
                ...
                override fun equals(other: Any?): Boolean {
                    ...
                    return /* spotless:off */ other is WireMethodAttributes && wireTransferType == other.wireTransferType && externalBankName == other.externalBankName && externalBankRoutingNumber == other.externalBankRoutingNumber && externalIndividualName == other.externalIndividualName && lithicBankName == other.lithicBankName && lithicBankRoutingNumber == other.lithicBankRoutingNumber && lithicIndividualName == other.lithicIndividualName && previousTransfer == other.previousTransfer && additionalProperties == other.additionalProperties /* spotless:on */
                }

                /* spotless:off */
                private val hashCode: Int by lazy { Objects.hash(wireTransferType, externalBankName, externalBankRoutingNumber, externalIndividualName, lithicBankName, lithicBankRoutingNumber, lithicIndividualName, previousTransfer, additionalProperties) }
                /* spotless:on */
