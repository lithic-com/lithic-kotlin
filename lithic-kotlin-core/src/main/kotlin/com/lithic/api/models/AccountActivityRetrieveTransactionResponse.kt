...
private constructor(
    ...
    fun internal_(): FinancialTransaction? = internal_

    /** Book transfer transaction */
    fun transfer(): BookTransferResponse? = transfer
     ...
     * import com.lithic.api.core.JsonValue
     *
     * val result: String? = accountActivityRetrieveTransactionResponse.accept(object : AccountActivityRetrieveTransactionResponse.Visitor<String?> {
     *     override fun visitInternal(internal_: FinancialTransaction): String? = internal_.toString()
     *
     *     // ...
     *
    ...
    override fun toString(): String =
        when {
            internal_ != null -> "AccountActivityRetrieveTransactionResponse{internal_=$internal_}"
            transfer != null -> "AccountActivityRetrieveTransactionResponse{transfer=$transfer}"
            card != null -> "AccountActivityRetrieveTransactionResponse{card=$card}"
            payment != null -> "AccountActivityRetrieveTransactionResponse{payment=$payment}"
    ...
    companion object {
        ...
        fun ofInternal(internal_: FinancialTransaction) =
            AccountActivityRetrieveTransactionResponse(internal_ = internal_)

        /** Book transfer transaction */
        fun ofTransfer(transfer: BookTransferResponse) =
            AccountActivityRetrieveTransactionResponse(transfer = transfer)

        /** Card transaction with ledger base properties */
        fun ofCard(card: CardTransaction) = AccountActivityRetrieveTransactionResponse(card = card)

        /** Payment transaction */
        fun ofPayment(payment: Payment) =
            AccountActivityRetrieveTransactionResponse(payment = payment)
         ...
         */
        fun ofHold(hold: Hold) = AccountActivityRetrieveTransactionResponse(hold = hold)
    }
            ...
            when (family) {
                "INTERNAL" -> {
                    return tryDeserialize(node, jacksonTypeRef<FinancialTransaction>())?.let {
                        AccountActivityRetrieveTransactionResponse(internal_ = it, _json = json)
                    } ?: AccountActivityRetrieveTransactionResponse(_json = json)
                }
                "TRANSFER" -> {
                    return tryDeserialize(node, jacksonTypeRef<BookTransferResponse>())?.let {
                        AccountActivityRetrieveTransactionResponse(transfer = it, _json = json)
                    } ?: AccountActivityRetrieveTransactionResponse(_json = json)
                }
                "CARD" -> {
                    return tryDeserialize(node, jacksonTypeRef<CardTransaction>())?.let {
                        AccountActivityRetrieveTransactionResponse(card = it, _json = json)
                    } ?: AccountActivityRetrieveTransactionResponse(_json = json)
                }
                "PAYMENT" -> {
                    return tryDeserialize(node, jacksonTypeRef<Payment>())?.let {
                        AccountActivityRetrieveTransactionResponse(payment = it, _json = json)
                    } ?: AccountActivityRetrieveTransactionResponse(_json = json)
                }
                "EXTERNAL_PAYMENT" -> {
