...
private constructor(
    ...
    companion object {
        ...
        fun none(): ThreeDSAuthenticationRetrieveParams = builder().build()
    ...
    /** A builder for [ThreeDSAuthenticationRetrieveParams]. */
    ...
    override fun hashCode(): Int =
        Objects.hash(threeDSAuthenticationToken, additionalHeaders, additionalQueryParams)
