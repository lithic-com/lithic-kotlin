...
private constructor(
    ...
    /** A builder for [CardConvertedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(cardConvertedWebhookEvent: CardConvertedWebhookEvent) = apply {
            cardToken = cardConvertedWebhookEvent.cardToken
            eventType = cardConvertedWebhookEvent.eventType
            additionalProperties = cardConvertedWebhookEvent.additionalProperties.toMutableMap()
        }
    ...
    internal fun validity(): Int =
        (if (cardToken.asKnown() == null) 0 else 1) + (eventType.asKnown()?.validity() ?: 0)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CardConvertedWebhookEvent &&
            cardToken == other.cardToken &&
            eventType == other.eventType &&
            additionalProperties == other.additionalProperties
    }

    private val hashCode: Int by lazy { Objects.hash(cardToken, eventType, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "CardConvertedWebhookEvent{cardToken=$cardToken, eventType=$eventType, additionalProperties=$additionalProperties}"
}
