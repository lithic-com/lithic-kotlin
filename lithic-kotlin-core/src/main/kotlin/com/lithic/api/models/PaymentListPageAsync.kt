...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is PaymentListPageAsync && this.paymentsService == other.paymentsService && this.params == other.params && this.response == other.response /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(paymentsService, params, response) /* spotless:on */
    }
    ...
    constructor(
        ...
        @JsonProperty("data") fun _data(): JsonField<List<Payment>>? = data
        ...
        override fun toString() =
            "PaymentListPageAsync.Response{data=$data, hasMore=$hasMore, additionalProperties=$additionalProperties}"
