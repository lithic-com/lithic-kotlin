...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(v2CreateResponse: V2CreateResponse) = apply {
            ...
            businessAccountTokens =
                v2CreateResponse.businessAccountTokens.map { it.toMutableList() }
            ...
            lithicManaged = v2CreateResponse.lithicManaged
    ...
    override fun toString() =
        "V2CreateResponse{token=$token, accountTokens=$accountTokens, businessAccountTokens=$businessAccountTokens, cardTokens=$cardTokens, currentVersion=$currentVersion, draftVersion=$draftVersion, eventStream=$eventStream, lithicManaged=$lithicManaged, name=$name, programLevel=$programLevel, state=$state, type=$type, excludedCardTokens=$excludedCardTokens, additionalProperties=$additionalProperties}"
}
