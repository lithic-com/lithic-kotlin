...
private constructor(
     ...
     */
    fun data(): List<Transaction>? = data.getNullable("data")
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is TransactionListPageResponse && data == other.data && hasMore == other.hasMore && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "TransactionListPageResponse{data=$data, hasMore=$hasMore, additionalProperties=$additionalProperties}"
}
