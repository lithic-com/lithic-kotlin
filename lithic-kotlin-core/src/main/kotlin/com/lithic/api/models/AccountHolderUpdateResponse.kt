...
@JsonDeserialize(using = AccountHolderUpdateResponse.Deserializer::class)
@JsonSerialize(using = AccountHolderUpdateResponse.Serializer::class)
class AccountHolderUpdateResponse
private constructor(
    private val kybKycPatch: KybKycPatchResponse? = null,
    private val patch: PatchResponse? = null,
    private val _json: JsonValue? = null,
) {

    fun kybKycPatch(): KybKycPatchResponse? = kybKycPatch

    fun patch(): PatchResponse? = patch

    fun isKybKycPatch(): Boolean = kybKycPatch != null

    fun isPatch(): Boolean = patch != null

    fun asKybKycPatch(): KybKycPatchResponse = kybKycPatch.getOrThrow("kybKycPatch")

    fun asPatch(): PatchResponse = patch.getOrThrow("patch")
    ...
    fun <T> accept(visitor: Visitor<T>): T =
        when {
            ...
            patch != null -> visitor.visitPatch(patch)
    ...
    fun validate(): AccountHolderUpdateResponse = apply {
        ...
        accept(
            object : Visitor<Unit> {
                override fun visitKybKycPatch(kybKycPatch: KybKycPatchResponse) {
                    kybKycPatch.validate()
                }

                override fun visitPatch(patch: PatchResponse) {
                    patch.validate()
                }
            }
        )
    ...
    internal fun validity(): Int =
        accept(
            object : Visitor<Int> {
                override fun visitKybKycPatch(kybKycPatch: KybKycPatchResponse) =
                    kybKycPatch.validity()

                override fun visitPatch(patch: PatchResponse) = patch.validity()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AccountHolderUpdateResponse && kybKycPatch == other.kybKycPatch && patch == other.patch /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(kybKycPatch, patch) /* spotless:on */

    override fun toString(): String =
        when {
            kybKycPatch != null -> "AccountHolderUpdateResponse{kybKycPatch=$kybKycPatch}"
            patch != null -> "AccountHolderUpdateResponse{patch=$patch}"
            _json != null -> "AccountHolderUpdateResponse{_unknown=$_json}"
            else -> throw IllegalStateException("Invalid AccountHolderUpdateResponse")
        }

    companion object {

        fun ofKybKycPatch(kybKycPatch: KybKycPatchResponse) =
            AccountHolderUpdateResponse(kybKycPatch = kybKycPatch)

        fun ofPatch(patch: PatchResponse) = AccountHolderUpdateResponse(patch = patch)
    }

    /**
     * An interface that defines how to map each variant of [AccountHolderUpdateResponse] to a value
     * of type [T].
     */
    interface Visitor<out T> {

        fun visitKybKycPatch(kybKycPatch: KybKycPatchResponse): T

        fun visitPatch(patch: PatchResponse): T

        /**
         * Maps an unknown variant of [AccountHolderUpdateResponse] to a value of type [T].
         *
         * An instance of [AccountHolderUpdateResponse] can contain an unknown variant if it was
        ...
        fun unknown(json: JsonValue?): T {
            throw LithicInvalidDataException("Unknown AccountHolderUpdateResponse: $json")
        }
    }

    internal class Deserializer :
        BaseDeserializer<AccountHolderUpdateResponse>(AccountHolderUpdateResponse::class) {

        override fun ObjectCodec.deserialize(node: JsonNode): AccountHolderUpdateResponse {
            val json = JsonValue.fromJsonNode(node)

            val bestMatches =
                sequenceOf(
                        tryDeserialize(node, jacksonTypeRef<KybKycPatchResponse>())?.let {
                            AccountHolderUpdateResponse(kybKycPatch = it, _json = json)
                        },
                        tryDeserialize(node, jacksonTypeRef<PatchResponse>())?.let {
                            AccountHolderUpdateResponse(patch = it, _json = json)
                        },
                    )
                    .filterNotNull()
            ...
            return when (bestMatches.size) {
                ...
                0 -> AccountHolderUpdateResponse(_json = json)
    ...
    internal class Serializer :
        BaseSerializer<AccountHolderUpdateResponse>(AccountHolderUpdateResponse::class) {

        override fun serialize(
            value: AccountHolderUpdateResponse,
            generator: JsonGenerator,
            provider: SerializerProvider,
        ) {
            when {
                value.kybKycPatch != null -> generator.writeObject(value.kybKycPatch)
                value.patch != null -> generator.writeObject(value.patch)
    ...
    private constructor(
         ...
         * owners can be submitted. If no individual owns 25% of the company you do not need to send
         * beneficial owner information. See
        ...
        fun businessAccountToken(): String? =
            businessAccountToken.getNullable("business_account_token")
         ...
         *
         * Unlike [businessEntity], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("business_entity")
        @ExcludeMissing
         ...
         *
         * Unlike [exemptionType], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("exemption_type")
        @ExcludeMissing
        ...
        /** A builder for [KybKycPatchResponse]. */
        class Builder internal constructor() {
            ...
            internal fun from(kybKycPatchResponse: KybKycPatchResponse) = apply {
                token = kybKycPatchResponse.token
                accountToken = kybKycPatchResponse.accountToken
                beneficialOwnerEntities =
                    kybKycPatchResponse.beneficialOwnerEntities.map { it.toMutableList() }
                beneficialOwnerIndividuals =
                    kybKycPatchResponse.beneficialOwnerIndividuals.map { it.toMutableList() }
                businessAccountToken = kybKycPatchResponse.businessAccountToken
                businessEntity = kybKycPatchResponse.businessEntity
                controlPerson = kybKycPatchResponse.controlPerson
                created = kybKycPatchResponse.created
                email = kybKycPatchResponse.email
                ...
                status = kybKycPatchResponse.status
                statusReasons = kybKycPatchResponse.statusReasons.map { it.toMutableList() }
                userType = kybKycPatchResponse.userType
                verificationApplication = kybKycPatchResponse.verificationApplication
                websiteUrl = kybKycPatchResponse.websiteUrl
                additionalProperties = kybKycPatchResponse.additionalProperties.toMutableMap()
            }
            ...
            /**
             * Only present when user_type == "BUSINESS". You must submit a list of all direct and
             * indirect individuals with 25% or more ownership in the company. A maximum of 4
             * beneficial owners can be submitted. If no individual owns 25% of the company you do
             * not need to send beneficial owner information. See
             * [FinCEN requirements](https://www.fincen.gov/sites/default/files/shared/CDD_Rev6.7_Sept_2017_Certificate.pdf)
             * (Section I) for more background on individuals that should be included.
             */
             ...
             * `List<Individual>` value instead. This method is primarily for setting the field to
            ...
            /**
             * Only present when user_type == "BUSINESS". Information about the business for which
             * the account is being opened and KYB is being run.
             */
             ...
             * [KybBusinessEntity] value instead. This method is primarily for setting the field to
             * an undocumented or not yet supported value.
             */
             ...
             * Chief Executive Officer, Chief Financial Officer, Chief Operating Officer,
             *
             * Managing Member, General Partner, President, Vice President, or Treasurer). This can
             * be an executive, or someone who will have program-wide access
             *
             * to the cards that Lithic will provide. In some cases, this individual could also be a
             * beneficial owner listed above.
             */
            ...
            fun exemptionType(exemptionType: ExemptionType) =
                exemptionType(JsonField.of(exemptionType))

            /**
             * Sets [Builder.exemptionType] to an arbitrary JSON value.
             *
             * You should usually call [Builder.exemptionType] with a well-typed [ExemptionType]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
             ...
             * which the account is being opened and KYC is being run.
             */
             ...
             * `List<RequiredDocument>` value instead. This method is primarily for setting the
             * field to an undocumented or not yet supported value.
             */
            ...
            /**
             * The type of Account Holder. If the type is "INDIVIDUAL", the "individual" attribute
             * will be present.
             *
             * If the type is "BUSINESS" then the "business_entity", "control_person",
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.dob] with a well-typed [String] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.statusReasons] with a well-typed
                 * `List<StatusReasons>` value instead. This method is primarily for setting the
                 * field to an undocumented or not yet supported value.
                 */
                fun statusReasons(statusReasons: JsonField<List<StatusReasons>>) = apply {
                    this.statusReasons = statusReasons.map { it.toMutableList() }
                 ...
                 *
                 * You should usually call [Builder.updated] with a well-typed [OffsetDateTime]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
            ...
            private constructor(private val value: JsonField<String>) : Enum {
                ...
                /**
                 * An enum containing [StatusReasons]'s known values, as well as an [_UNKNOWN]
                 * member.
                 *
                 * An instance of [StatusReasons] can contain an unknown value in a couple of cases:
                 * - It was deserialized from data that doesn't match any known member. For example,
                ...
                enum class Value {
                    ...
                    CONTROL_PERSON_NAME_VERIFICATION_FAILURE,
                    /**
                     * An enum member indicating that [StatusReasons] was instantiated with an
                     * unknown value.
                     */
                    _UNKNOWN,
                }
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun legalBusinessName(): String? = legalBusinessName.getNullable("legal_business_name")
        ...
        class Builder internal constructor() {
            ...
            internal fun from(patchResponse: PatchResponse) = apply {
                token = patchResponse.token
                address = patchResponse.address
                businessAccountToken = patchResponse.businessAccountToken
                email = patchResponse.email
                firstName = patchResponse.firstName
                lastName = patchResponse.lastName
                legalBusinessName = patchResponse.legalBusinessName
                phoneNumber = patchResponse.phoneNumber
                additionalProperties = patchResponse.additionalProperties.toMutableMap()
            }
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is PatchResponse && token == other.token && address == other.address && businessAccountToken == other.businessAccountToken && email == other.email && firstName == other.firstName && lastName == other.lastName && legalBusinessName == other.legalBusinessName && phoneNumber == other.phoneNumber && additionalProperties == other.additionalProperties /* spotless:on */
        }

        /* spotless:off */
        private val hashCode: Int by lazy { Objects.hash(token, address, businessAccountToken, email, firstName, lastName, legalBusinessName, phoneNumber, additionalProperties) }
        /* spotless:on */

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "PatchResponse{token=$token, address=$address, businessAccountToken=$businessAccountToken, email=$email, firstName=$firstName, lastName=$lastName, legalBusinessName=$legalBusinessName, phoneNumber=$phoneNumber, additionalProperties=$additionalProperties}"
    }
}
