...
private constructor(
     ...
     * import com.lithic.api.core.JsonValue
     *
     * val result: String? = accountHolderUpdateResponse.accept(object : AccountHolderUpdateResponse.Visitor<String?> {
     *     override fun visitKybKycPatch(kybKycPatch: KybKycPatchResponse): String? = kybKycPatch.toString()
     *
     *     // ...
     *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AccountHolderUpdateResponse &&
            kybKycPatch == other.kybKycPatch &&
            patch == other.patch
    }

    override fun hashCode(): Int = Objects.hash(kybKycPatch, patch)
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is KybKycPatchResponse &&
                token == other.token &&
