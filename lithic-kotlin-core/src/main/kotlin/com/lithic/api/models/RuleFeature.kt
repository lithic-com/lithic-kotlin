...
private constructor(
    ...
    fun authorization(): AuthorizationFeature? = authorization

    fun authentication(): AuthenticationFeature? = authentication

    fun tokenization(): TokenizationFeature? = tokenization

    fun achReceipt(): AchReceiptFeature? = achReceipt

    fun cardTransaction(): CardTransactionFeature? = cardTransaction

    fun achPayment(): AchPaymentFeature? = achPayment

    fun externalBankAccount(): ExternalBankAccountFeature? = externalBankAccount

    fun card(): CardFeature? = card

    fun accountHolder(): AccountHolderFeature? = accountHolder

    fun ipMetadata(): IpMetadataFeature? = ipMetadata

    fun spendVelocity(): SpendVelocityFeature? = spendVelocity

    fun paymentVelocity(): PaymentVelocityFeature? = paymentVelocity

    fun transactionHistorySignals(): TransactionHistorySignalsFeature? = transactionHistorySignals

    fun consecutiveDeclines(): ConsecutiveDeclinesFeature? = consecutiveDeclines

    fun achPaymentHistory(): AchPaymentHistoryFeature? = achPaymentHistory
     ...
     * import com.lithic.api.core.JsonValue
     *
     * val result: String? = ruleFeature.accept(object : RuleFeature.Visitor<String?> {
     *     override fun visitAuthorization(authorization: AuthorizationFeature): String? = authorization.toString()
     *
     *     // ...
     *
    ...
    companion object {
        ...
        fun ofCard(card: CardFeature) = RuleFeature(card = card)
    ...
    private constructor(
         ...
         */
        internal fun validity(): Int =
            (type.asKnown()?.validity() ?: 0) + (if (name.asKnown() == null) 0 else 1)
    ...
    private constructor(
        ...
        class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
            ...
            companion object {
                ...
                val AUTHENTICATION = of("AUTHENTICATION")
    ...
    private constructor(
        ...
        class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
            ...
            companion object {
                ...
                val ACH_RECEIPT = of("ACH_RECEIPT")
    ...
    private constructor(
        ...
        class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
            ...
            companion object {
                ...
                val ACH_PAYMENT = of("ACH_PAYMENT")
    ...
    private constructor(
        ...
        class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
            ...
            companion object {
                ...
                val EXTERNAL_BANK_ACCOUNT = of("EXTERNAL_BANK_ACCOUNT")
    ...
    private constructor(
        ...
        class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
            ...
            companion object {
                ...
                val ACCOUNT_HOLDER = of("ACCOUNT_HOLDER")
    ...
    private constructor(
        ...
        class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
            ...
            companion object {
                ...
                val IP_METADATA = of("IP_METADATA")
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun filters(): VelocityLimitFilters? = filters.getNullable("filters")
        ...
        class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
            ...
            companion object {
                ...
                val SPEND_VELOCITY = of("SPEND_VELOCITY")
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun filters(): PaymentVelocityFilters? = filters.getNullable("filters")
        ...
        class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
            ...
            companion object {
                ...
                val PAYMENT_VELOCITY = of("PAYMENT_VELOCITY")
        ...
        private constructor(
             ...
             *   the server responded with an unexpected value).
             */
            fun includePaymentTypes(): List<IncludePaymentType>? =
                includePaymentTypes.getNullable("include_payment_types")
             ...
             *   the server responded with an unexpected value).
             */
            fun includePolarities(): List<IncludePolarity>? =
                includePolarities.getNullable("include_polarities")
             ...
             *   the server responded with an unexpected value).
             */
            fun includeStatuses(): List<IncludeStatus>? =
                includeStatuses.getNullable("include_statuses")
            ...
            fun validate(): PaymentVelocityFilters = apply {
                ...
                includePaymentTypes()?.forEach { it.validate() }
                includePolarities()?.forEach { it.validate() }
                includeStatuses()?.forEach { it.validate() }
            ...
            internal fun validity(): Int =
                (excludeTags.asKnown()?.validity() ?: 0) +
                    (includePaymentTypes.asKnown()?.sumOf { it.validity().toInt() } ?: 0) +
                    (includePolarities.asKnown()?.sumOf { it.validity().toInt() } ?: 0) +
                    (includeStatuses.asKnown()?.sumOf { it.validity().toInt() } ?: 0) +
            ...
            private constructor(private val value: JsonField<String>) : Enum {
                ...
                companion object {
                    ...
                    val ORIGINATION = of("ORIGINATION")

                    val RECEIPT = of("RECEIPT")

                    fun of(value: String) = IncludePaymentType(JsonField.of(value))
                }
            ...
            private constructor(private val value: JsonField<String>) : Enum {
                ...
                companion object {
                    ...
                    fun of(value: String) = IncludePolarity(JsonField.of(value))
                }
            ...
            private constructor(private val value: JsonField<String>) : Enum {
                ...
                companion object {
                    ...
                    fun of(value: String) = IncludeStatus(JsonField.of(value))
                }
    ...
    private constructor(
        ...
        class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
            ...
            companion object {
                ...
                val TRANSACTION_HISTORY_SIGNALS = of("TRANSACTION_HISTORY_SIGNALS")
    ...
    private constructor(
        ...
        class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
            ...
            companion object {
                ...
                val ACH_PAYMENT_HISTORY = of("ACH_PAYMENT_HISTORY")
