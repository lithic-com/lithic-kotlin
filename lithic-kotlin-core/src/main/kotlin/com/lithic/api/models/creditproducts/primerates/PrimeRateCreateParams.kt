...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PrimeRateCreateParams].
         *
    ...
    /** A builder for [PrimeRateCreateParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(primeRateCreateParams: PrimeRateCreateParams) = apply {
            creditProductToken = primeRateCreateParams.creditProductToken
            body = primeRateCreateParams.body.toBuilder()
            additionalHeaders = primeRateCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = primeRateCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [PrimeRateCreateParams].
         *
         ...
         */
        fun build(): PrimeRateCreateParams =
    ...
    internal fun _body(): InterestRate = body
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is PrimeRateCreateParams && creditProductToken == other.creditProductToken && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "PrimeRateCreateParams{creditProductToken=$creditProductToken, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
