...
private constructor(
    ...
    fun relatedAccountTokens(): Payment.RelatedAccountTokens? =
        relatedAccountTokens.getNullable("related_account_tokens")
    ...
    class Builder internal constructor() {
        ...
        internal fun from(paymentCreateStablecoinResponse: PaymentCreateStablecoinResponse) =
            apply {
                token = paymentCreateStablecoinResponse.token
                category = paymentCreateStablecoinResponse.category
                created = paymentCreateStablecoinResponse.created
                descriptor = paymentCreateStablecoinResponse.descriptor
                direction = paymentCreateStablecoinResponse.direction
                events = paymentCreateStablecoinResponse.events.map { it.toMutableList() }
                family = paymentCreateStablecoinResponse.family
                financialAccountToken = paymentCreateStablecoinResponse.financialAccountToken
                method = paymentCreateStablecoinResponse.method
                methodAttributes = paymentCreateStablecoinResponse.methodAttributes
                pendingAmount = paymentCreateStablecoinResponse.pendingAmount
                relatedAccountTokens = paymentCreateStablecoinResponse.relatedAccountTokens
                result = paymentCreateStablecoinResponse.result
                settledAmount = paymentCreateStablecoinResponse.settledAmount
                source = paymentCreateStablecoinResponse.source
                status = paymentCreateStablecoinResponse.status
                updated = paymentCreateStablecoinResponse.updated
                blockchainRecipientToken = paymentCreateStablecoinResponse.blockchainRecipientToken
                currency = paymentCreateStablecoinResponse.currency
                expectedReleaseDate = paymentCreateStablecoinResponse.expectedReleaseDate
                externalBankAccountToken = paymentCreateStablecoinResponse.externalBankAccountToken
                tags = paymentCreateStablecoinResponse.tags
                type = paymentCreateStablecoinResponse.type
                userDefinedId = paymentCreateStablecoinResponse.userDefinedId
                balance = paymentCreateStablecoinResponse.balance
                additionalProperties =
                    paymentCreateStablecoinResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [PaymentCreateStablecoinResponse].
         *
         ...
         */
        fun build(): PaymentCreateStablecoinResponse =
            PaymentCreateStablecoinResponse(
     ...
     *   expected type.
     */
    fun validate(): PaymentCreateStablecoinResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PaymentCreateStablecoinResponse &&
            token == other.token &&
