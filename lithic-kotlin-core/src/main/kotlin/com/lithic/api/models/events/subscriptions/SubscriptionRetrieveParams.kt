...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(subscriptionRetrieveParams: SubscriptionRetrieveParams) = apply {
            eventSubscriptionToken = subscriptionRetrieveParams.eventSubscriptionToken
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SubscriptionRetrieveParams && eventSubscriptionToken == other.eventSubscriptionToken && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "SubscriptionRetrieveParams{eventSubscriptionToken=$eventSubscriptionToken, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
