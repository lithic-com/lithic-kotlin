...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun downloadUrlExpires(): OffsetDateTime? =
        downloadUrlExpires.getNullable("download_url_expires")
     ...
     *   server responded with an unexpected value).
     */
    fun sizeBytes(): Long? = sizeBytes.getNullable("size_bytes")
     ...
     *   server responded with an unexpected value).
     */
    fun uploadConstraints(): UploadConstraints? =
     ...
     *   server responded with an unexpected value).
     */
    fun uploadUrlExpires(): OffsetDateTime? = uploadUrlExpires.getNullable("upload_url_expires")
    ...
    internal fun validity(): Int =
        (if (token.asKnown() == null) 0 else 1) +
            ...
            (if (downloadUrlExpires.asKnown() == null) 0 else 1) +
            ...
            (if (uploadUrlExpires.asKnown() == null) 0 else 1)
