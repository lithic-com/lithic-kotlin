...
private constructor(
    ...
    /** A builder for [TransactionSimulateCreditAuthorizationAdviceResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            token = transactionSimulateCreditAuthorizationAdviceResponse.token
            debuggingRequestId =
                transactionSimulateCreditAuthorizationAdviceResponse.debuggingRequestId
            additionalProperties =
                transactionSimulateCreditAuthorizationAdviceResponse.additionalProperties
                    .toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TransactionSimulateCreditAuthorizationAdviceResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TransactionSimulateCreditAuthorizationAdviceResponse =
            TransactionSimulateCreditAuthorizationAdviceResponse(
                token,
                debuggingRequestId,
    ...
    fun validate(): TransactionSimulateCreditAuthorizationAdviceResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (if (token.asKnown() == null) 0 else 1) +
            (if (debuggingRequestId.asKnown() == null) 0 else 1)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TransactionSimulateCreditAuthorizationAdviceResponse &&
            token == other.token &&
    ...
    override fun toString() =
        "TransactionSimulateCreditAuthorizationAdviceResponse{token=$token, debuggingRequestId=$debuggingRequestId, additionalProperties=$additionalProperties}"
}
