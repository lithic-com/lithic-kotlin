...
private constructor(
     ...
     * ```kotlin
     * val myObject: MyClass = interestTierSchedule.penaltyRates().convert(MyClass::class.java)
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```kotlin
     * val myObject: MyClass = interestTierSchedule.tierRates().convert(MyClass::class.java)
     * ```
     */
    ...
    internal fun validity(): Int =
        (if (creditProductToken.asKnown() == null) 0 else 1) +
            ...
            (if (tierName.asKnown() == null) 0 else 1)
