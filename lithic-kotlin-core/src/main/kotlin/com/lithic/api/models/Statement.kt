...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun payoffDetails(): PayoffDetails? = payoffDetails.getNullable("payoff_details")
    ...
    private constructor(
         ...
         */
        internal fun validity(): Int =
            (if (minimumPaymentMonths.asKnown() == null) 0 else 1) +
                (if (minimumPaymentTotal.asKnown() == null) 0 else 1) +
                (if (payoffPeriodLengthMonths.asKnown() == null) 0 else 1) +
                (if (payoffPeriodMonthlyPaymentAmount.asKnown() == null) 0 else 1) +
                (if (payoffPeriodPaymentTotal.asKnown() == null) 0 else 1)
