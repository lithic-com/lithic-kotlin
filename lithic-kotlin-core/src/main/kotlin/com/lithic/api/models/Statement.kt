    ...
    private constructor(
        ...
        private constructor(
            ...
            companion object {
                ...
                val STANDARD = AccountState2(JsonField.of("STANDARD"))

                val PROMO = AccountState2(JsonField.of("PROMO"))

                val PENALTY = AccountState2(JsonField.of("PENALTY"))

                fun of(value: String) = AccountState2(JsonField.of(value))
            }
