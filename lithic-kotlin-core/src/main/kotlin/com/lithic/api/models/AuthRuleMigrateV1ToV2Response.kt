...
@JsonDeserialize(builder = AuthRuleMigrateV1ToV2Response.Builder::class)
@NoAutoDetect
class AuthRuleMigrateV1ToV2Response
private constructor(
    ...
    fun validate(): AuthRuleMigrateV1ToV2Response = apply {
        if (!validated) {
            token()
            state()
            programLevel()
    ...
    class Builder {
        ...
        internal fun from(authRuleMigrateV1ToV2Response: AuthRuleMigrateV1ToV2Response) = apply {
            this.token = authRuleMigrateV1ToV2Response.token
            this.state = authRuleMigrateV1ToV2Response.state
            this.programLevel = authRuleMigrateV1ToV2Response.programLevel
            this.cardTokens = authRuleMigrateV1ToV2Response.cardTokens
            this.accountTokens = authRuleMigrateV1ToV2Response.accountTokens
            this.type = authRuleMigrateV1ToV2Response.type
            this.currentVersion = authRuleMigrateV1ToV2Response.currentVersion
            this.draftVersion = authRuleMigrateV1ToV2Response.draftVersion
            additionalProperties(authRuleMigrateV1ToV2Response.additionalProperties)
        }
        ...
        fun build(): AuthRuleMigrateV1ToV2Response =
