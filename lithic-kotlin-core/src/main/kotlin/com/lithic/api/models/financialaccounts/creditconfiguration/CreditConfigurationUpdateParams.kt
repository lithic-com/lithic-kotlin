...
package com.lithic.api.models.financialaccounts.creditconfiguration
...
class CreditConfigurationUpdateParams
private constructor(
    ...
    /** A builder for [CreditConfigurationUpdateParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(creditConfigurationUpdateParams: CreditConfigurationUpdateParams) =
            apply {
                financialAccountToken = creditConfigurationUpdateParams.financialAccountToken
                body = creditConfigurationUpdateParams.body.toBuilder()
                additionalHeaders = creditConfigurationUpdateParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    creditConfigurationUpdateParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [CreditConfigurationUpdateParams].
         *
         ...
         */
        fun build(): CreditConfigurationUpdateParams =
            CreditConfigurationUpdateParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CreditConfigurationUpdateParams && financialAccountToken == other.financialAccountToken && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "CreditConfigurationUpdateParams{financialAccountToken=$financialAccountToken, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
