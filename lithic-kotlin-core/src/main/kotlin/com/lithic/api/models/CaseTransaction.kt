...
private constructor(
    ...
    fun card(): CardCaseTransaction? = card

    /** A payment (ACH) transaction associated with a case */
    fun payment(): PaymentCaseTransaction? = payment
     ...
     * import com.lithic.api.core.JsonValue
     *
     * val result: String? = caseTransaction.accept(object : CaseTransaction.Visitor<String?> {
     *     override fun visitCard(card: CardCaseTransaction): String? = card.toString()
     *
     *     // ...
     *
    ...
    companion object {
        ...
        /** A card transaction associated with a case */
        fun ofCard(card: CardCaseTransaction) = CaseTransaction(card = card)
    ...
    internal class Deserializer : BaseDeserializer<CaseTransaction>(CaseTransaction::class) {
        ...
        override fun ObjectCodec.deserialize(node: JsonNode): CaseTransaction {
            ...
            val category = json.asObject()?.get("category")?.asString()
    ...
    private constructor(
        ...
        internal fun validity(): Int =
            (if (token.asKnown() == null) 0 else 1) +
                ...
                (if (transactionCreatedAt.asKnown() == null) 0 else 1)
