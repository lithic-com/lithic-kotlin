...
private constructor(
     ...
     */
    fun nameValidation(): NameValidation? = nameValidation.getNullable("name_validation")
     ...
     *   server responded with an unexpected value).
     */
    fun serviceLocation(): ServiceLocation? = serviceLocation.getNullable("service_location")
     ...
     *   server responded with an unexpected value).
     */
    fun cashback(): Long? = cashback.getNullable("cashback")
     ...
     *   server responded with an unexpected value).
     */
    fun fleetInfo(): AsaRequestFleetInfo? = fleetInfo.getNullable("fleet_info")
     ...
     *   server responded with an unexpected value).
     */
    fun latestChallenge(): LatestChallenge? = latestChallenge.getNullable("latest_challenge")
     ...
     *   server responded with an unexpected value).
     */
    fun networkSpecificData(): AsaNetworkSpecificData? =
     ...
     *   server responded with an unexpected value).
     */
    fun ttl(): OffsetDateTime? = ttl.getNullable("ttl")
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun hold(): Amount? = hold.getNullable("hold")
         ...
         *   server responded with an unexpected value).
         */
        fun settlement(): Amount? = settlement.getNullable("settlement")
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun streetAddress(): String? = streetAddress.getNullable("street_address")
    ...
    private constructor(
         ...
         */
        internal fun validity(): Int =
            (name.asKnown()?.validity() ?: 0) + (nameOnFileMatch.asKnown()?.validity() ?: 0)
        ...
        private constructor(
             ...
             * Used for best match union deserialization.
             */
            internal fun validity(): Int = (fullName.asKnown()?.validity() ?: 0)
            ...
            class FullName @JsonCreator private constructor(private val value: JsonField<String>) :
                ...
                companion object {
                    ...
                    fun of(value: String) = FullName(JsonField.of(value))
                }
    ...
    class AsaRequestStatus @JsonCreator private constructor(private val value: JsonField<String>) :
        ...
        companion object {
            ...
            fun of(value: String) = AsaRequestStatus(JsonField.of(value))
        }
    ...
    private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            fun of(value: String) = TransactionInitiator(JsonField.of(value))
        }
    ...
    private constructor(
         ...
         */
        internal fun validity(): Int =
            (fleetPromptCode.asKnown()?.validity() ?: 0) +
                (fleetRestrictionCode.asKnown()?.validity() ?: 0) +
                (if (driverNumber.asKnown() == null) 0 else 1) +
        ...
        private constructor(private val value: JsonField<String>) : Enum {
            ...
            companion object {
                ...
                val NO_PROMPT = of("NO_PROMPT")

                val VEHICLE_NUMBER = of("VEHICLE_NUMBER")

                val DRIVER_NUMBER = of("DRIVER_NUMBER")

                fun of(value: String) = FleetPromptCode(JsonField.of(value))
            }
        ...
        private constructor(private val value: JsonField<String>) : Enum {
            ...
            companion object {
                ...
                val FUEL_ONLY = of("FUEL_ONLY")

                fun of(value: String) = FleetRestrictionCode(JsonField.of(value))
            }
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun mastercard(): AsaNetworkSpecificDataMastercard? = mastercard.getNullable("mastercard")

        /**
         * @throws LithicInvalidDataException if the JSON field has an unexpected type (e.g. if the
         *   server responded with an unexpected value).
         */
        fun visa(): AsaNetworkSpecificDataVisa? = visa.getNullable("visa")
        ...
        private constructor(
            ...
            fun ecommerceSecurityLevelIndicator(): String? =
                ecommerceSecurityLevelIndicator.getNullable("ecommerce_security_level_indicator")
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun entryMode(): AsaRequestPosEntryMode? = entryMode.getNullable("entry_mode")

        /**
         * @throws LithicInvalidDataException if the JSON field has an unexpected type (e.g. if the
         *   server responded with an unexpected value).
         */
        fun terminal(): AsaPosTerminal? = terminal.getNullable("terminal")
        ...
        private constructor(
             ...
             *   the server responded with an unexpected value).
             */
            fun pan(): Pan? = pan.getNullable("pan")
             ...
             *   the server responded with an unexpected value).
             */
            fun pinEntered(): Boolean? = pinEntered.getNullable("pin_entered")
