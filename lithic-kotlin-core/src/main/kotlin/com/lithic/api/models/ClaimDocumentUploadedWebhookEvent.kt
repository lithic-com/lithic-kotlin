...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun downloadUrlExpiresAt(): OffsetDateTime? =
        downloadUrlExpiresAt.getNullable("download_url_expires_at")
     ...
     *   server responded with an unexpected value).
     */
    fun failureReason(): FailureReason? = failureReason.getNullable("failure_reason")
     ...
     *   server responded with an unexpected value).
     */
    fun requirementId(): String? = requirementId.getNullable("requirement_id")
     ...
     *   server responded with an unexpected value).
     */
    fun uploadConstraints(): UploadConstraints2? =
        uploadConstraints.getNullable("upload_constraints")
     ...
     *   server responded with an unexpected value).
     */
    fun uploadUrlExpiresAt(): OffsetDateTime? =
        uploadUrlExpiresAt.getNullable("upload_url_expires_at")
    ...
    /** A builder for [ClaimDocumentUploadedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(claimDocumentUploadedWebhookEvent: ClaimDocumentUploadedWebhookEvent) =
            apply {
                token = claimDocumentUploadedWebhookEvent.token
                created = claimDocumentUploadedWebhookEvent.created
                downloadUrl = claimDocumentUploadedWebhookEvent.downloadUrl
                downloadUrlExpiresAt = claimDocumentUploadedWebhookEvent.downloadUrlExpiresAt
                eventType = claimDocumentUploadedWebhookEvent.eventType
                failureReason = claimDocumentUploadedWebhookEvent.failureReason
                name = claimDocumentUploadedWebhookEvent.name
                requirementId = claimDocumentUploadedWebhookEvent.requirementId
                status = claimDocumentUploadedWebhookEvent.status
                updated = claimDocumentUploadedWebhookEvent.updated
                uploadConstraints = claimDocumentUploadedWebhookEvent.uploadConstraints
                uploadUrl = claimDocumentUploadedWebhookEvent.uploadUrl
                uploadUrlExpiresAt = claimDocumentUploadedWebhookEvent.uploadUrlExpiresAt
                additionalProperties =
                    claimDocumentUploadedWebhookEvent.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ClaimDocumentUploadedWebhookEvent].
         *
         ...
         */
        fun build(): ClaimDocumentUploadedWebhookEvent =
            ClaimDocumentUploadedWebhookEvent(
     ...
     *   expected type.
     */
    fun validate(): ClaimDocumentUploadedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (if (token.asKnown() == null) 0 else 1) +
            ...
            (if (downloadUrlExpiresAt.asKnown() == null) 0 else 1) +
            (eventType.asKnown()?.validity() ?: 0) +
            (failureReason.asKnown()?.validity() ?: 0) +
            (if (name.asKnown() == null) 0 else 1) +
            (if (requirementId.asKnown() == null) 0 else 1) +
            (status.asKnown()?.validity() ?: 0) +
            (if (updated.asKnown() == null) 0 else 1) +
            (uploadConstraints.asKnown()?.validity() ?: 0) +
            (if (uploadUrl.asKnown() == null) 0 else 1) +
            (if (uploadUrlExpiresAt.asKnown() == null) 0 else 1)
    ...
    class FailureReason @JsonCreator private constructor(private val value: JsonField<String>) :
        ...
        companion object {
            ...
            val INVALID_MIME_TYPE = of("INVALID_MIME_TYPE")

            val FILE_TOO_LARGE = of("FILE_TOO_LARGE")

            val FILE_EMPTY = of("FILE_EMPTY")

            val CORRUPT_FILE = of("CORRUPT_FILE")
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun maxSizeBytes(): Long? = maxSizeBytes.getNullable("max_size_bytes")
         ...
         */
        internal fun validity(): Int =
            (acceptedMimeTypes.asKnown()?.size ?: 0) +
                (if (maxSizeBytes.asKnown() == null) 0 else 1)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ClaimDocumentUploadedWebhookEvent &&
            token == other.token &&
    ...
    override fun toString() =
        "ClaimDocumentUploadedWebhookEvent{token=$token, created=$created, downloadUrl=$downloadUrl, downloadUrlExpiresAt=$downloadUrlExpiresAt, eventType=$eventType, failureReason=$failureReason, name=$name, requirementId=$requirementId, status=$status, updated=$updated, uploadConstraints=$uploadConstraints, uploadUrl=$uploadUrl, uploadUrlExpiresAt=$uploadUrlExpiresAt, additionalProperties=$additionalProperties}"
}
