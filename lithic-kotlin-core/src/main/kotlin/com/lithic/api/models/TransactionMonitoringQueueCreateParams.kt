...
class TransactionMonitoringQueueCreateParams
private constructor(
    private val body: CreateQueueRequest,
     ...
     * default list. Values are free-form labels and must be non-empty and unique
     *
     * @throws LithicInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun allowedResolutions(): List<String>? = body.allowedResolutions()
    ...
    companion object {
         ...
         * [TransactionMonitoringQueueCreateParams].
         *
    ...
    /** A builder for [TransactionMonitoringQueueCreateParams]. */
    class Builder internal constructor() {

        private var body: CreateQueueRequest.Builder = CreateQueueRequest.builder()
        private var additionalHeaders: Headers.Builder = Headers.builder()
        private var additionalQueryParams: QueryParams.Builder = QueryParams.builder()

        internal fun from(
            transactionMonitoringQueueCreateParams: TransactionMonitoringQueueCreateParams
        ) = apply {
            body = transactionMonitoringQueueCreateParams.body.toBuilder()
            additionalHeaders = transactionMonitoringQueueCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                transactionMonitoringQueueCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [TransactionMonitoringQueueCreateParams].
         *
         ...
         */
        fun build(): TransactionMonitoringQueueCreateParams =
            TransactionMonitoringQueueCreateParams(
                body.build(),
    ...
    fun _body(): CreateQueueRequest = body
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun allowedResolutions(): List<String>? =
            allowedResolutions.getNullable("allowed_resolutions")
        ...
        /** A builder for [CreateQueueRequest]. */
        class Builder internal constructor() {
            ...
            internal fun from(createQueueRequest: CreateQueueRequest) = apply {
                name = createQueueRequest.name
                allowedResolutions =
                    createQueueRequest.allowedResolutions.map { it.toMutableList() }
                description = createQueueRequest.description
                additionalProperties = createQueueRequest.additionalProperties.toMutableMap()
            }
             ...
             * the default list. Values are free-form labels and must be non-empty and unique
             */
            ...
            /**
             * Returns an immutable instance of [CreateQueueRequest].
             *
             * Further updates to this [Builder] will not mutate the returned instance.
             *
             * The following fields are required:
         ...
         *   expected type.
         */
        fun validate(): CreateQueueRequest = apply {
            if (validated) {
                return@apply
            }
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is CreateQueueRequest &&
                name == other.name &&
        ...
        private val hashCode: Int by lazy {
            Objects.hash(name, allowedResolutions, description, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "CreateQueueRequest{name=$name, allowedResolutions=$allowedResolutions, description=$description, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TransactionMonitoringQueueCreateParams &&
            body == other.body &&
    ...
    override fun toString() =
        "TransactionMonitoringQueueCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
