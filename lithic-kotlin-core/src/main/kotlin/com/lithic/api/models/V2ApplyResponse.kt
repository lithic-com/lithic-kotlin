...
private constructor(
    ...
    override fun toString() =
        "V2ApplyResponse{token=$token, state=$state, programLevel=$programLevel, cardTokens=$cardTokens, excludedCardTokens=$excludedCardTokens, accountTokens=$accountTokens, type=$type, currentVersion=$currentVersion, draftVersion=$draftVersion, name=$name, additionalProperties=$additionalProperties}"
}
