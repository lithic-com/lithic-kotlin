...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [V2ApplyResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(v2ApplyResponse: V2ApplyResponse) = apply {
            ...
            businessAccountTokens = v2ApplyResponse.businessAccountTokens.map { it.toMutableList() }
            ...
            eventStream = v2ApplyResponse.eventStream
            lithicManaged = v2ApplyResponse.lithicManaged
        ...
        /**
         * Returns an immutable instance of [V2ApplyResponse].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is V2ApplyResponse &&
            token == other.token &&
    ...
    override fun toString() =
        "V2ApplyResponse{token=$token, accountTokens=$accountTokens, businessAccountTokens=$businessAccountTokens, cardTokens=$cardTokens, currentVersion=$currentVersion, draftVersion=$draftVersion, eventStream=$eventStream, lithicManaged=$lithicManaged, name=$name, programLevel=$programLevel, state=$state, type=$type, excludedCardTokens=$excludedCardTokens, additionalProperties=$additionalProperties}"
}
