...
private constructor(
    ...
    fun data(): List<AuthRule>? = data.getNullable("data")
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AuthRuleRetrieveResponse && this.data == other.data && this.additionalProperties == other.additionalProperties /* spotless:on */
    }
