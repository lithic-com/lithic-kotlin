...
private constructor(
     ...
     */
    fun settledFunds(): Long? = settledFunds.getNullable("settled_funds")
    ...
    internal fun validity(): Int =
        (if (security.asKnown() == null) 0 else 1) +
            (if (settledFunds.asKnown() == null) 0 else 1) +
            (if (totalOutstandingSpend.asKnown() == null) 0 else 1)
