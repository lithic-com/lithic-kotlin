...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(subscriptionUpdateParams: SubscriptionUpdateParams) = apply {
            eventSubscriptionToken = subscriptionUpdateParams.eventSubscriptionToken
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SubscriptionUpdateParams && eventSubscriptionToken == other.eventSubscriptionToken && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "SubscriptionUpdateParams{eventSubscriptionToken=$eventSubscriptionToken, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
