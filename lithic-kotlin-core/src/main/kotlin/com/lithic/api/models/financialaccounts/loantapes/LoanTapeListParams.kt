...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LoanTapeListParams].
         *
    ...
    /** A builder for [LoanTapeListParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(loanTapeListParams: LoanTapeListParams) = apply {
            financialAccountToken = loanTapeListParams.financialAccountToken
            begin = loanTapeListParams.begin
            end = loanTapeListParams.end
            endingBefore = loanTapeListParams.endingBefore
            pageSize = loanTapeListParams.pageSize
            startingAfter = loanTapeListParams.startingAfter
            additionalHeaders = loanTapeListParams.additionalHeaders.toBuilder()
            additionalQueryParams = loanTapeListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [LoanTapeListParams].
         *
    ...
    override fun toString() =
        "LoanTapeListParams{financialAccountToken=$financialAccountToken, begin=$begin, end=$end, endingBefore=$endingBefore, pageSize=$pageSize, startingAfter=$startingAfter, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
