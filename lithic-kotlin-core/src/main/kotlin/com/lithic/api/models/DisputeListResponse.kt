...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(disputeListResponse: DisputeListResponse) = apply {
            token = disputeListResponse.token
            amount = disputeListResponse.amount
            arbitrationDate = disputeListResponse.arbitrationDate
            created = disputeListResponse.created
            customerFiledDate = disputeListResponse.customerFiledDate
            customerNote = disputeListResponse.customerNote
            networkClaimIds = disputeListResponse.networkClaimIds.map { it.toMutableList() }
            networkFiledDate = disputeListResponse.networkFiledDate
            networkReasonCode = disputeListResponse.networkReasonCode
            prearbitrationDate = disputeListResponse.prearbitrationDate
            primaryClaimId = disputeListResponse.primaryClaimId
            reason = disputeListResponse.reason
            representmentDate = disputeListResponse.representmentDate
            resolutionDate = disputeListResponse.resolutionDate
            resolutionNote = disputeListResponse.resolutionNote
            resolutionReason = disputeListResponse.resolutionReason
            status = disputeListResponse.status
            transactionToken = disputeListResponse.transactionToken
