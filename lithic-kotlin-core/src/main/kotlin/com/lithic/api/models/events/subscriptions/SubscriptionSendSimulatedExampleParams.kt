...
class SubscriptionSendSimulatedExampleParams
private constructor(
    ...
    /** A builder for [SubscriptionSendSimulatedExampleParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            subscriptionSendSimulatedExampleParams: SubscriptionSendSimulatedExampleParams
        ) = apply {
            eventSubscriptionToken = subscriptionSendSimulatedExampleParams.eventSubscriptionToken
            body = subscriptionSendSimulatedExampleParams.body.toBuilder()
            additionalHeaders = subscriptionSendSimulatedExampleParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                subscriptionSendSimulatedExampleParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SubscriptionSendSimulatedExampleParams].
         *
         ...
         */
        fun build(): SubscriptionSendSimulatedExampleParams =
            SubscriptionSendSimulatedExampleParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SubscriptionSendSimulatedExampleParams && eventSubscriptionToken == other.eventSubscriptionToken && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "SubscriptionSendSimulatedExampleParams{eventSubscriptionToken=$eventSubscriptionToken, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
