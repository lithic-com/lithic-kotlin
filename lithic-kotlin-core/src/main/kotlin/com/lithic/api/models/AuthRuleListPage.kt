...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AuthRuleListPage && this.authRulesService == other.authRulesService && this.params == other.params && this.response == other.response /* spotless:on */
    }
    ...
    constructor(
        ...
        override fun iterator(): Iterator<AuthRule> = iterator {
            var page = firstPage
            var index = 0
            while (true) {
