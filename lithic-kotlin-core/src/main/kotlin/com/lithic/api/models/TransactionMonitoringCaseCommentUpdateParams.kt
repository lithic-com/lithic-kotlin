...
private constructor(
    ...
    private val body: EditCommentRequest,
    ...
    fun commentToken(): String? = commentToken
     ...
     */
    fun actorToken(): String? = body.actorToken()
    ...
    /** A builder for [TransactionMonitoringCaseCommentUpdateParams]. */
    class Builder internal constructor() {

        private var caseToken: String? = null
        private var commentToken: String? = null
        private var body: EditCommentRequest.Builder = EditCommentRequest.builder()
        ...
        internal fun from(
            ...
            caseToken = transactionMonitoringCaseCommentUpdateParams.caseToken
            commentToken = transactionMonitoringCaseCommentUpdateParams.commentToken
            body = transactionMonitoringCaseCommentUpdateParams.body.toBuilder()
            additionalHeaders =
                transactionMonitoringCaseCommentUpdateParams.additionalHeaders.toBuilder()
        ...
        /**
         * Returns an immutable instance of [TransactionMonitoringCaseCommentUpdateParams].
         *
    ...
    fun _body(): EditCommentRequest = body
    ...
    /** Parameters for editing an existing comment on a case */
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun actorToken(): String? = actorToken.getNullable("actor_token")
        ...
        /** A builder for [EditCommentRequest]. */
        class Builder internal constructor() {
            ...
            internal fun from(editCommentRequest: EditCommentRequest) = apply {
                comment = editCommentRequest.comment
                actorToken = editCommentRequest.actorToken
                additionalProperties = editCommentRequest.additionalProperties.toMutableMap()
            }
         ...
         *   expected type.
         */
        fun validate(): EditCommentRequest = apply {
            if (validated) {
                return@apply
            }
        ...
        internal fun validity(): Int =
            (if (comment.asKnown() == null) 0 else 1) + (if (actorToken.asKnown() == null) 0 else 1)
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is EditCommentRequest &&
        ...
        override fun toString() =
            "EditCommentRequest{comment=$comment, actorToken=$actorToken, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TransactionMonitoringCaseCommentUpdateParams &&
            caseToken == other.caseToken &&
            commentToken == other.commentToken &&
            body == other.body &&
    ...
    override fun hashCode(): Int =
        Objects.hash(caseToken, commentToken, body, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "TransactionMonitoringCaseCommentUpdateParams{caseToken=$caseToken, commentToken=$commentToken, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
