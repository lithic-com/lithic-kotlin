...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun assignee(): String? = body.assignee()
     ...
     *   server responded with an unexpected value).
     */
    fun priority(): CasePriority? = body.priority()
     ...
     *   server responded with an unexpected value).
     */
    fun resolution(): ResolutionOutcome? = body.resolution()
     ...
     *   server responded with an unexpected value).
     */
    fun resolutionNotes(): String? = body.resolutionNotes()
     ...
     *   server responded with an unexpected value).
     */
    fun slaDeadline(): OffsetDateTime? = body.slaDeadline()
     ...
     *   server responded with an unexpected value).
     */
    fun status(): CaseStatus? = body.status()
    ...
    companion object {
        ...
        fun none(): TransactionMonitoringCaseUpdateParams = builder().build()
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun assignee(): String? = assignee.getNullable("assignee")
         ...
         *   server responded with an unexpected value).
         */
        fun priority(): CasePriority? = priority.getNullable("priority")
         ...
         *   server responded with an unexpected value).
         */
        fun resolutionNotes(): String? = resolutionNotes.getNullable("resolution_notes")
         ...
         *   server responded with an unexpected value).
         */
        fun slaDeadline(): OffsetDateTime? = slaDeadline.getNullable("sla_deadline")
         ...
         *   server responded with an unexpected value).
         */
        fun status(): CaseStatus? = status.getNullable("status")
        ...
        internal fun validity(): Int =
            (if (actorToken.asKnown() == null) 0 else 1) +
                (if (assignee.asKnown() == null) 0 else 1) +
                (priority.asKnown()?.validity() ?: 0) +
                (resolution.asKnown()?.validity() ?: 0) +
                (if (resolutionNotes.asKnown() == null) 0 else 1) +
                (if (slaDeadline.asKnown() == null) 0 else 1) +
