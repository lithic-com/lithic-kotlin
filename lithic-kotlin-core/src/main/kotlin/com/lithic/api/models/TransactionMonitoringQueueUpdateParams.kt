...
class TransactionMonitoringQueueUpdateParams
private constructor(
    private val queueToken: String?,
    private val body: UpdateQueueRequest,
    ...
    companion object {
        ...
        fun none(): TransactionMonitoringQueueUpdateParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of
         * [TransactionMonitoringQueueUpdateParams].
         */
        fun builder() = Builder()
    }

    /** A builder for [TransactionMonitoringQueueUpdateParams]. */
    class Builder internal constructor() {

        private var queueToken: String? = null
        private var body: UpdateQueueRequest.Builder = UpdateQueueRequest.builder()
        private var additionalHeaders: Headers.Builder = Headers.builder()
        private var additionalQueryParams: QueryParams.Builder = QueryParams.builder()

        internal fun from(
            transactionMonitoringQueueUpdateParams: TransactionMonitoringQueueUpdateParams
        ) = apply {
            queueToken = transactionMonitoringQueueUpdateParams.queueToken
            body = transactionMonitoringQueueUpdateParams.body.toBuilder()
            additionalHeaders = transactionMonitoringQueueUpdateParams.additionalHeaders.toBuilder()
        ...
        /**
         * Returns an immutable instance of [TransactionMonitoringQueueUpdateParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TransactionMonitoringQueueUpdateParams =
            TransactionMonitoringQueueUpdateParams(
                queueToken,
                body.build(),
    ...
    fun _body(): UpdateQueueRequest = body
    ...
    /**
     * Parameters for updating a queue. All fields are optional; omitted fields are left unchanged
     */
    ...
    private constructor(
        ...
        companion object {
            ...
            /** Returns a mutable builder for constructing an instance of [UpdateQueueRequest]. */
            fun builder() = Builder()
        }
        ...
        class Builder internal constructor() {
            ...
            /**
             * Returns an immutable instance of [UpdateQueueRequest].
             *
             * Further updates to this [Builder] will not mutate the returned instance.
             */
         ...
         *   expected type.
         */
        fun validate(): UpdateQueueRequest = apply {
            if (validated) {
                return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TransactionMonitoringQueueUpdateParams &&
    ...
    override fun hashCode(): Int =
        Objects.hash(queueToken, body, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "TransactionMonitoringQueueUpdateParams{queueToken=$queueToken, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
