...
private constructor(
    ...
    private constructor(
         ...
         */
        @Deprecated("deprecated")
        fun isSpendBlocked(): Boolean? = isSpendBlocked.getNullable("is_spend_blocked")
        ...
        internal fun validity(): Int =
            (autoCollectionConfiguration.asKnown()?.validity() ?: 0) +
                ...
                (chargedOffReason.asKnown()?.validity() ?: 0) +
        ...
        override fun toString() =
            "FinancialAccountCreditConfig{autoCollectionConfiguration=$autoCollectionConfiguration, creditLimit=$creditLimit, creditProductToken=$creditProductToken, externalBankAccountToken=$externalBankAccountToken, tier=$tier, chargedOffReason=$chargedOffReason, financialAccountState=$financialAccountState, isSpendBlocked=$isSpendBlocked, additionalProperties=$additionalProperties}"
    }
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val CHARGED_OFF_FEES = of("CHARGED_OFF_FEES")

            val CHARGED_OFF_INTEREST = of("CHARGED_OFF_INTEREST")

            val CHARGED_OFF_PRINCIPAL = of("CHARGED_OFF_PRINCIPAL")
