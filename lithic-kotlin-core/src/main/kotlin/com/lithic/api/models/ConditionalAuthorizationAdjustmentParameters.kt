...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [ConditionalAuthorizationAdjustmentParameters].
         *
     ...
     *   expected type.
     */
    fun validate(): ConditionalAuthorizationAdjustmentParameters = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        class Mode @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
            ...
            companion object {
                ...
                val REPLACE_WITH_AMOUNT = of("REPLACE_WITH_AMOUNT")

                val ADD_PERCENTAGE = of("ADD_PERCENTAGE")

                val ADD_AMOUNT = of("ADD_AMOUNT")
            ...
            fun value(): Value =
                when (this) {
                    REPLACE_WITH_AMOUNT -> Value.REPLACE_WITH_AMOUNT
                    ADD_PERCENTAGE -> Value.ADD_PERCENTAGE
            ...
            fun known(): Known =
                when (this) {
                    REPLACE_WITH_AMOUNT -> Known.REPLACE_WITH_AMOUNT
                    ADD_PERCENTAGE -> Known.ADD_PERCENTAGE
                    ADD_AMOUNT -> Known.ADD_AMOUNT
                    else -> throw LithicInvalidDataException("Unknown Mode: $value")
                }
        ...
        class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
            ...
            companion object {
                ...
                val HOLD_ADJUSTMENT = of("HOLD_ADJUSTMENT")
            ...
            fun known(): Known =
                when (this) {
                    HOLD_ADJUSTMENT -> Known.HOLD_ADJUSTMENT
        ...
        private val hashCode: Int by lazy { Objects.hash(mode, type, value, additionalProperties) }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             *   for `BUSINESS_ACCOUNT` scope. Use an integer value.
        ...
        class Attribute @JsonCreator private constructor(private val value: JsonField<String>) :
            ...
            companion object {
                ...
                val CARD_DECLINE_COUNT_15_M = of("CARD_DECLINE_COUNT_15M")

                val CARD_DECLINE_COUNT_1_H = of("CARD_DECLINE_COUNT_1H")

                val CARD_DECLINE_COUNT_24_H = of("CARD_DECLINE_COUNT_24H")
