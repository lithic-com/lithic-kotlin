...
internal class ExternalBankAccountServiceAsyncTest {
    ...
    suspend fun list() {
        ...
        val page = externalBankAccountServiceAsync.list()
    ...
    suspend fun pause() {
        ...
        val externalBankAccount =
            externalBankAccountServiceAsync.pause("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
    ...
    @Test
    suspend fun setVerificationMethod() {
        val client =
            LithicOkHttpClientAsync.builder()
                .baseUrl(TestServerExtension.BASE_URL)
                .apiKey("My Lithic API Key")
        ...
        val externalBankAccount =
            externalBankAccountServiceAsync.setVerificationMethod(
