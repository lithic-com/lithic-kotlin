...
internal class PaymentServiceAsyncTest {
    ...
    suspend fun retrieve() {
        ...
        val payment = paymentServiceAsync.retrieve("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
    ...
    suspend fun retry() {
        ...
        val response = paymentServiceAsync.retry("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
