...
internal class MonitoringCaseTest {
    ...
    fun create() {
        ...
        assertThat(monitoringCase.assignee()).isEqualTo("assignee")
        ...
        assertThat(monitoringCase.resolution()).isEqualTo(ResolutionOutcome.CONFIRMED_FRAUD)
        assertThat(monitoringCase.resolutionNotes()).isEqualTo("resolution_notes")
        assertThat(monitoringCase.resolved())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(monitoringCase.ruleToken()).isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        ...
        assertThat(monitoringCase.title()).isEqualTo("title")
