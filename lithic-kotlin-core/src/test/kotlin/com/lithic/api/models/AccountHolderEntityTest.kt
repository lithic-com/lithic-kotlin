...
internal class AccountHolderEntityTest {
    ...
    fun create() {
        ...
        assertThat(accountHolderEntity.dob()).isEqualTo("1991-03-08 08:00:00")
        assertThat(accountHolderEntity.email()).isEqualTo("tom@middle-earth.com")
        assertThat(accountHolderEntity.firstName()).isEqualTo("Tom")
        assertThat(accountHolderEntity.lastName()).isEqualTo("Bombadil")
        assertThat(accountHolderEntity.phoneNumber()).isEqualTo("+15555555555")
