...
internal class CardReissueResponseTest {
    ...
    fun create() {
        ...
        assertThat(cardReissueResponse.authRuleTokens()).containsExactly("string")
        assertThat(cardReissueResponse.cardholderCurrency()).isEqualTo("USD")
        assertThat(cardReissueResponse.cvv()).isEqualTo("776")
        assertThat(cardReissueResponse.digitalCardArtToken())
            .isEqualTo("00000000-0000-0000-1000-000000000000")
        assertThat(cardReissueResponse.expMonth()).isEqualTo("06")
        assertThat(cardReissueResponse.expYear()).isEqualTo("2027")
        assertThat(cardReissueResponse.hostname()).isEqualTo("hostname")
        assertThat(cardReissueResponse.memo()).isEqualTo("New Card")
        assertThat(cardReissueResponse.pan()).isEqualTo("4111111289144142")
        assertThat(cardReissueResponse.pendingCommands()).containsExactly("string")
        assertThat(cardReissueResponse.productId()).isEqualTo("1")
