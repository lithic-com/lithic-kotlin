...
internal class VelocityLimitFiltersTest {
    ...
    fun create() {
        ...
        assertThat(velocityLimitFilters.excludeCountries()).containsExactly("USD")
        assertThat(velocityLimitFilters.excludeMccs()).containsExactly("5542")
        assertThat(velocityLimitFilters.includeCountries()).containsExactly("USD")
        assertThat(velocityLimitFilters.includeMccs()).containsExactly("5542")
        assertThat(velocityLimitFilters.includePanEntryModes())
