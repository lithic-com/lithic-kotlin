...
internal class CaseActivityEntryTest {
    ...
    fun create() {
        ...
        assertThat(caseActivityEntry.actorToken()).isEqualTo("actor_token")
        assertThat(caseActivityEntry.created())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(caseActivityEntry.entryType()).isEqualTo(CaseActivityType.STATUS)
        assertThat(caseActivityEntry.newValue()).isEqualTo("new_value")
        assertThat(caseActivityEntry.previousValue()).isEqualTo("previous_value")
    }
