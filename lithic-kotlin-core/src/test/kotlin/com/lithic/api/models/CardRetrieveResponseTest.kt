...
internal class CardRetrieveResponseTest {
    ...
    fun create() {
        ...
        assertThat(cardRetrieveResponse.authRuleTokens()).containsExactly("string")
        assertThat(cardRetrieveResponse.cardholderCurrency()).isEqualTo("USD")
        assertThat(cardRetrieveResponse.cvv()).isEqualTo("776")
        assertThat(cardRetrieveResponse.digitalCardArtToken())
            .isEqualTo("00000000-0000-0000-1000-000000000000")
        assertThat(cardRetrieveResponse.expMonth()).isEqualTo("06")
        assertThat(cardRetrieveResponse.expYear()).isEqualTo("2027")
        assertThat(cardRetrieveResponse.hostname()).isEqualTo("hostname")
        assertThat(cardRetrieveResponse.memo()).isEqualTo("New Card")
        assertThat(cardRetrieveResponse.pan()).isEqualTo("4111111289144142")
        assertThat(cardRetrieveResponse.pendingCommands()).containsExactly("string")
        assertThat(cardRetrieveResponse.productId()).isEqualTo("1")
