...
internal class CardRenewResponseTest {
    ...
    fun create() {
        ...
        assertThat(cardRenewResponse.authRuleTokens()).containsExactly("string")
        assertThat(cardRenewResponse.cardholderCurrency()).isEqualTo("USD")
        assertThat(cardRenewResponse.cvv()).isEqualTo("776")
        assertThat(cardRenewResponse.digitalCardArtToken())
            .isEqualTo("00000000-0000-0000-1000-000000000000")
        assertThat(cardRenewResponse.expMonth()).isEqualTo("06")
        assertThat(cardRenewResponse.expYear()).isEqualTo("2027")
        assertThat(cardRenewResponse.hostname()).isEqualTo("hostname")
        assertThat(cardRenewResponse.memo()).isEqualTo("New Card")
        assertThat(cardRenewResponse.pan()).isEqualTo("4111111289144142")
        assertThat(cardRenewResponse.pendingCommands()).containsExactly("string")
        assertThat(cardRenewResponse.productId()).isEqualTo("1")
