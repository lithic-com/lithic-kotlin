...
internal class CardTransactionUpdatedWebhookEventTest {

    @Test
    fun create() {
        val cardTransactionUpdatedWebhookEvent =
        ...
        assertThat(cardTransactionUpdatedWebhookEvent.token())
            .isEqualTo("c30c2182-1e69-4e0d-b40f-eec0d2a19123")
        assertThat(cardTransactionUpdatedWebhookEvent.accountToken())
            .isEqualTo("db3942f0-0627-4887-a190-1ea83b46d091")
        assertThat(cardTransactionUpdatedWebhookEvent.acquirerFee()).isEqualTo(0L)
        assertThat(cardTransactionUpdatedWebhookEvent.acquirerReferenceNumber()).isNull()
        assertThat(cardTransactionUpdatedWebhookEvent.amount()).isEqualTo(1800L)
        assertThat(cardTransactionUpdatedWebhookEvent.amounts())
            .isEqualTo(
                Transaction.TransactionAmounts.builder()
                    .cardholder(
                        Transaction.TransactionAmounts.Cardholder.builder()
        ...
        assertThat(cardTransactionUpdatedWebhookEvent.authorizationAmount()).isEqualTo(1800L)
        assertThat(cardTransactionUpdatedWebhookEvent.authorizationCode()).isEqualTo("071471")
        assertThat(cardTransactionUpdatedWebhookEvent.avs())
            .isEqualTo(
                Transaction.Avs.builder().address("123 Evergreen Terrace").zipcode("95006").build()
            )
        assertThat(cardTransactionUpdatedWebhookEvent.cardToken())
            .isEqualTo("aac502f9-aecc-458a-954e-4bcf6edb6123")
        assertThat(cardTransactionUpdatedWebhookEvent.cardholderAuthentication())
            .isEqualTo(
                CardholderAuthentication.builder()
                    .authenticationMethod(
                        CardholderAuthentication.AuthenticationMethod.FRICTIONLESS
        ...
        assertThat(cardTransactionUpdatedWebhookEvent.created())
            .isEqualTo(OffsetDateTime.parse("2023-08-03T18:42:30Z"))
        assertThat(cardTransactionUpdatedWebhookEvent.financialAccountToken())
            .isEqualTo("a3b113e8-01fe-42d3-b900-b9adf3f15496")
        assertThat(cardTransactionUpdatedWebhookEvent.merchant())
            .isEqualTo(
                Transaction.TransactionMerchant.builder()
                    .acceptorId("452322000053360")
                    .acquiringInstitutionId("333301802529120")
        ...
        assertThat(cardTransactionUpdatedWebhookEvent.merchantAmount()).isEqualTo(1800L)
        assertThat(cardTransactionUpdatedWebhookEvent.merchantAuthorizationAmount())
            .isEqualTo(1800L)
        assertThat(cardTransactionUpdatedWebhookEvent.merchantCurrency()).isEqualTo("USD")
        assertThat(cardTransactionUpdatedWebhookEvent.network())
            .isEqualTo(Transaction.Network.MASTERCARD)
        assertThat(cardTransactionUpdatedWebhookEvent.networkRiskScore()).isEqualTo(5L)
        assertThat(cardTransactionUpdatedWebhookEvent.pos())
            .isEqualTo(
                Transaction.Pos.builder()
                    .entryMode(
                        Transaction.Pos.PosEntryMode.builder()
        ...
        assertThat(cardTransactionUpdatedWebhookEvent.result())
            .isEqualTo(Transaction.DeclineResult.APPROVED)
        assertThat(cardTransactionUpdatedWebhookEvent.serviceLocation())
            .isEqualTo(
                Transaction.ServiceLocation.builder()
                    .city("city")
                    .country("country")
        ...
        assertThat(cardTransactionUpdatedWebhookEvent.settledAmount()).isEqualTo(0L)
        assertThat(cardTransactionUpdatedWebhookEvent.status())
            .isEqualTo(Transaction.Status.PENDING)
        assertThat(cardTransactionUpdatedWebhookEvent.tags())
            .isEqualTo(
                Transaction.Tags.builder()
                    .putAdditionalProperty("risk-level", JsonValue.from("high"))
                    .build()
            )
        assertThat(cardTransactionUpdatedWebhookEvent.tokenInfo())
            .isEqualTo(TokenInfo.builder().walletType(TokenInfo.WalletType.APPLE_PAY).build())
        assertThat(cardTransactionUpdatedWebhookEvent.updated())
            .isEqualTo(OffsetDateTime.parse("2023-08-03T18:42:30Z"))
        assertThat(cardTransactionUpdatedWebhookEvent.events())
            .containsExactly(
                Transaction.TransactionEvent.builder()
                    .token("bbbf1e86-322d-11ee-9779-00505685a123")
                    .amount(1800L)
        ...
        assertThat(cardTransactionUpdatedWebhookEvent.eventType())
            .isEqualTo(CardTransactionUpdatedWebhookEvent.EventType.CARD_TRANSACTION_UPDATED)
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedCardTransactionUpdatedWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(cardTransactionUpdatedWebhookEvent),
                jacksonTypeRef<CardTransactionUpdatedWebhookEvent>(),
            )

        assertThat(roundtrippedCardTransactionUpdatedWebhookEvent)
            .isEqualTo(cardTransactionUpdatedWebhookEvent)
    }
}
