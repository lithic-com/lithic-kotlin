...
internal class TokenMetadataTest {
    ...
    fun create() {
        ...
        assertThat(tokenMetadata.paymentAppInstanceId()).isEqualTo("payment_app_instance_id")
        assertThat(tokenMetadata.tokenRequestorId()).isEqualTo("xxxxxxxxxxx")
        assertThat(tokenMetadata.tokenRequestorName())
            .isEqualTo(TokenMetadata.TokenRequestorName.APPLE_PAY)
    }
