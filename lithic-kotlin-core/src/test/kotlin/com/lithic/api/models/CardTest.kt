...
internal class CardTest {
    ...
    fun create() {
        ...
        assertThat(card.authRuleTokens()).containsExactly("string")
        assertThat(card.bulkOrderToken()).isEqualTo("5e9483eb-8103-4e16-9794-2106111b2eca")
        assertThat(card.cardholderCurrency()).isEqualTo("USD")
        assertThat(card.comment()).isEqualTo("comment")
        assertThat(card.digitalCardArtToken()).isEqualTo("5e9483eb-8103-4e16-9794-2106111b2eca")
        assertThat(card.expMonth()).isEqualTo("06")
        assertThat(card.expYear()).isEqualTo("2027")
        assertThat(card.hostname()).isEqualTo("hostname")
        assertThat(card.memo()).isEqualTo("New Card")
        assertThat(card.networkProgramToken()).isEqualTo("5e9483eb-8103-4e16-9794-2106111b2eca")
        ...
        assertThat(card.substatus()).isEqualTo(NonPciCard.Substatus.LOST)
        assertThat(card.cvv()).isEqualTo("776")
