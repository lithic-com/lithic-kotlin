...
internal class BookTransferCreateParamsTest {
    ...
    fun body() {
        ...
        assertThat(body.holdToken()).isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        assertThat(body.memo()).isEqualTo("memo")
        assertThat(body.onClosedAccount()).isEqualTo(BookTransferCreateParams.OnClosedAccount.FAIL)
    }
