...
internal class AccountHolderCreatedWebhookEventTest {
    ...
    fun create() {
        ...
        assertThat(accountHolderCreatedWebhookEvent.requiredDocuments())
            .containsExactly(
                RequiredDocument.builder()
                    .entityToken("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .addStatusReason("string")
        ...
        assertThat(accountHolderCreatedWebhookEvent.status())
            .isEqualTo(AccountHolderCreatedWebhookEvent.Status.ACCEPTED)
        assertThat(accountHolderCreatedWebhookEvent.statusReason()).containsExactly("string")
    }
