...
internal class AccountActivityRetrieveTransactionResponseTest {
    ...
    fun ofFinancialTransaction() {
        ...
        assertThat(accountActivityRetrieveTransactionResponse.bookTransferTransaction()).isNull()
        assertThat(accountActivityRetrieveTransactionResponse.cardTransaction()).isNull()
        assertThat(accountActivityRetrieveTransactionResponse.paymentTransaction()).isNull()
    ...
    fun ofBookTransferTransaction() {
        ...
        assertThat(accountActivityRetrieveTransactionResponse.financialTransaction()).isNull()
