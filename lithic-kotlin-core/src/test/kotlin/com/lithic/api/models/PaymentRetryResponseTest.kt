...
internal class PaymentRetryResponseTest {
    ...
    fun create() {
        ...
        assertThat(paymentRetryResponse.blockchainRecipientToken())
            .isEqualTo("1e3fdb71-4b52-4a30-a7a9-52c85e26a1d9")
        assertThat(paymentRetryResponse.currency()).isEqualTo("USD")
        assertThat(paymentRetryResponse.expectedReleaseDate()).isNull()
        ...
        assertThat(paymentRetryResponse.type()).isEqualTo(Payment.TransferType.ORIGINATION_CREDIT)
        assertThat(paymentRetryResponse.userDefinedId()).isNull()
