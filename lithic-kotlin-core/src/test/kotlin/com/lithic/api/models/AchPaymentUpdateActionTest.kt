...
internal class AchPaymentUpdateActionTest {
    ...
    fun ofTag() {
        ...
        assertThat(achPaymentUpdateAction.tag()).isEqualTo(tag)
        assertThat(achPaymentUpdateAction.createCase()).isNull()
    }
    ...
    fun ofCreateCase() {
        ...
        assertThat(achPaymentUpdateAction.tag()).isNull()
        assertThat(achPaymentUpdateAction.createCase()).isEqualTo(createCase)
    }
