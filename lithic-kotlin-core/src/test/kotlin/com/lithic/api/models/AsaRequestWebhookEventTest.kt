...
internal class AsaRequestWebhookEventTest {
    ...
    fun create() {
        ...
        assertThat(asaRequestWebhookEvent.accountType())
            .isEqualTo(AsaRequestWebhookEvent.AccountType.CHECKING)
        ...
        assertThat(asaRequestWebhookEvent.cashback()).isEqualTo(0L)
        assertThat(asaRequestWebhookEvent.conversionRate()).isEqualTo(0.0)
        ...
        assertThat(asaRequestWebhookEvent.network()).isEqualTo(AsaRequestWebhookEvent.Network.AMEX)
        assertThat(asaRequestWebhookEvent.networkRiskScore()).isEqualTo(0L)
