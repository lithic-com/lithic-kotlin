...
internal class ExternalBankAccountUnpauseResponseTest {
    ...
    fun create() {
        ...
        assertThat(externalBankAccountUnpauseResponse.companyId()).isEqualTo("company_id")
        assertThat(externalBankAccountUnpauseResponse.dob())
        ...
        assertThat(externalBankAccountUnpauseResponse.financialAccountToken())
            .isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        assertThat(externalBankAccountUnpauseResponse.name()).isEqualTo("name")
        assertThat(externalBankAccountUnpauseResponse.userDefinedId()).isEqualTo("user_defined_id")
