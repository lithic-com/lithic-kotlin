...
internal class DisputeV2Test {
    ...
    fun create() {
        ...
        assertThat(disputeV2.caseId()).isEqualTo("case_id")
        assertThat(disputeV2.claimToken()).isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        ...
        assertThat(disputeV2.disposition()).isEqualTo(DisputeV2.Disposition.WON)
        ...
        assertThat(disputeV2.status()).isEqualTo(DisputeV2.Status.OPEN)
