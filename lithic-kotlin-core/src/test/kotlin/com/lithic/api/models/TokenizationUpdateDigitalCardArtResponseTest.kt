...
internal class TokenizationUpdateDigitalCardArtResponseTest {
    ...
    fun roundtrip() {
        ...
        val roundtrippedTokenizationUpdateDigitalCardArtResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(tokenizationUpdateDigitalCardArtResponse),
                jacksonTypeRef<TokenizationUpdateDigitalCardArtResponse>(),
            )

        assertThat(roundtrippedTokenizationUpdateDigitalCardArtResponse)
            .isEqualTo(tokenizationUpdateDigitalCardArtResponse)
    }
}
