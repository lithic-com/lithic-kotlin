...
internal class DisputeTransactionUpdatedWebhookEventTest {
    ...
    fun create() {
        ...
        assertThat(disputeTransactionUpdatedWebhookEvent.cardToken())
            .isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        assertThat(disputeTransactionUpdatedWebhookEvent.caseId()).isEqualTo("case_id")
        ...
        assertThat(disputeTransactionUpdatedWebhookEvent.status()).isEqualTo(DisputeV2.Status.OPEN)
