...
internal class TokenizationApprovalRequestWebhookEventTest {
    ...
    fun create() {
        ...
        assertThat(tokenizationApprovalRequestWebhookEvent.digitalWalletTokenMetadata())
            .isEqualTo(
                DigitalWalletTokenMetadata.builder()
                    .paymentAccountInfo(
                        DigitalWalletTokenMetadata.PaymentAccountInfo.builder()
        ...
        assertThat(tokenizationApprovalRequestWebhookEvent.ruleResults())
            .containsExactly(
                TokenizationRuleResult.builder()
                    .authRuleToken("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .explanation("explanation")
        ...
        assertThat(tokenizationApprovalRequestWebhookEvent.tokenizationDeclineReasons())
        ...
        assertThat(tokenizationApprovalRequestWebhookEvent.tokenizationSource())
            .isEqualTo(TokenizationApprovalRequestWebhookEvent.TokenizationSource.PUSH_PROVISION)
        assertThat(tokenizationApprovalRequestWebhookEvent.tokenizationTfaReasons())
