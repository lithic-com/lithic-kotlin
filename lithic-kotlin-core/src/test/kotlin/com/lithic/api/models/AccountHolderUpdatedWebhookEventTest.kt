...
internal class AccountHolderUpdatedWebhookEventTest {
    ...
    fun ofKybPayload() {
        ...
        assertThat(accountHolderUpdatedWebhookEvent.kybPayload()).isEqualTo(kybPayload)
        assertThat(accountHolderUpdatedWebhookEvent.kycPayload()).isNull()
        assertThat(accountHolderUpdatedWebhookEvent.legacyPayload()).isNull()
    }
    ...
    fun ofKycPayload() {
        ...
        assertThat(accountHolderUpdatedWebhookEvent.kybPayload()).isNull()
        assertThat(accountHolderUpdatedWebhookEvent.kycPayload()).isEqualTo(kycPayload)
        assertThat(accountHolderUpdatedWebhookEvent.legacyPayload()).isNull()
    }
    ...
    fun ofLegacyPayload() {
        ...
        assertThat(accountHolderUpdatedWebhookEvent.kybPayload()).isNull()
        assertThat(accountHolderUpdatedWebhookEvent.kycPayload()).isNull()
        assertThat(accountHolderUpdatedWebhookEvent.legacyPayload()).isEqualTo(legacyPayload)
    }
