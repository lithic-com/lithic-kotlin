    ...
    fun createV2ListResponse() {
            ...
            V2ListResponse.builder()
                ...
                .currentVersion(
                    V2ListResponse.CurrentVersion.builder()
                        .parameters(
                            V2ListResponse.CurrentVersion.AuthRuleParameters
                ...
                .draftVersion(
                    V2ListResponse.DraftVersion.builder()
                        .parameters(
                            V2ListResponse.DraftVersion.AuthRuleParameters
                                .ofConditionalBlockParameters(
                                    V2ListResponse.DraftVersion.AuthRuleParameters
                                        .ConditionalBlockParameters
                                        .builder()
        ...
        assertThat(v2ListResponse.draftVersion())
            .isEqualTo(
                V2ListResponse.DraftVersion.builder()
                    .parameters(
                        V2ListResponse.DraftVersion.AuthRuleParameters.ofConditionalBlockParameters(
                            V2ListResponse.DraftVersion.AuthRuleParameters
                                .ConditionalBlockParameters
                                .builder()
                                .conditions(
