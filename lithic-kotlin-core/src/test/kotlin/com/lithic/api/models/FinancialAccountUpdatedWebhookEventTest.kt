...
internal class FinancialAccountUpdatedWebhookEventTest {
    ...
    fun create() {
        ...
        assertThat(financialAccountUpdatedWebhookEvent.nickname()).isEqualTo("nickname")
        ...
        assertThat(financialAccountUpdatedWebhookEvent.userDefinedStatus())
            .isEqualTo("user_defined_status")
        assertThat(financialAccountUpdatedWebhookEvent.accountNumber()).isEqualTo("account_number")
        assertThat(financialAccountUpdatedWebhookEvent.blockchainAddresses())
            .isEqualTo(
                FinancialAccount.BlockchainAddresses.builder()
                    .putAdditionalProperty(
                        "ETHEREUM",
        ...
        assertThat(financialAccountUpdatedWebhookEvent.routingNumber()).isEqualTo("routing_number")
