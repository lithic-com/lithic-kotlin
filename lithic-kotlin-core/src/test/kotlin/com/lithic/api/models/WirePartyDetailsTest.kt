...
internal class WirePartyDetailsTest {
    ...
    fun create() {
        ...
        assertThat(wirePartyDetails.accountNumber()).isEqualTo("account_number")
        assertThat(wirePartyDetails.agentId()).isEqualTo("agent_id")
        assertThat(wirePartyDetails.agentName()).isEqualTo("agent_name")
        assertThat(wirePartyDetails.name()).isEqualTo("name")
    }
