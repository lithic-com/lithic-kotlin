    ...
    fun createExternalBankAccountCreateResponse() {
        val externalBankAccountCreateResponse =
            ExternalBankAccountCreateResponse.builder()
                ...
                .state(ExternalBankAccountCreateResponse.State.CLOSED)
                ...
                .verificationState(ExternalBankAccountCreateResponse.VerificationState.ENABLED)
        ...
        assertThat(externalBankAccountCreateResponse.state())
            .isEqualTo(ExternalBankAccountCreateResponse.State.CLOSED)
        ...
        assertThat(externalBankAccountCreateResponse.verificationState())
            .isEqualTo(ExternalBankAccountCreateResponse.VerificationState.ENABLED)
        ...
        assertThat(externalBankAccountCreateResponse.companyId()).isEqualTo("string")
