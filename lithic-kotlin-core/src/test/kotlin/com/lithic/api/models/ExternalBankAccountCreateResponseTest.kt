...
internal class ExternalBankAccountCreateResponseTest {
    ...
    fun create() {
        ...
        assertThat(externalBankAccountCreateResponse.companyId()).isEqualTo("company_id")
        ...
        assertThat(externalBankAccountCreateResponse.financialAccountToken())
            .isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        assertThat(externalBankAccountCreateResponse.name()).isEqualTo("name")
        assertThat(externalBankAccountCreateResponse.userDefinedId()).isEqualTo("user_defined_id")
