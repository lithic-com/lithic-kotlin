...
internal class ExternalBankAccountRetryPrenoteResponseTest {
    ...
    fun create() {
        ...
        assertThat(externalBankAccountRetryPrenoteResponse.companyId()).isEqualTo("company_id")
        ...
        assertThat(externalBankAccountRetryPrenoteResponse.financialAccountToken())
            .isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        assertThat(externalBankAccountRetryPrenoteResponse.name()).isEqualTo("name")
    ...
    fun roundtrip() {
        ...
        val roundtrippedExternalBankAccountRetryPrenoteResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(externalBankAccountRetryPrenoteResponse),
                jacksonTypeRef<ExternalBankAccountRetryPrenoteResponse>(),
            )

        assertThat(roundtrippedExternalBankAccountRetryPrenoteResponse)
            .isEqualTo(externalBankAccountRetryPrenoteResponse)
    }
}
