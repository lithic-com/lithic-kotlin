...
class ExternalBankAccountRetryPrenoteResponseTest {
    ...
    fun createExternalBankAccountRetryPrenoteResponse() {
        ...
        assertThat(externalBankAccountRetryPrenoteResponse.companyId()).isEqualTo("string")
        assertThat(externalBankAccountRetryPrenoteResponse.dob())
            .isEqualTo(LocalDate.parse("2019-12-27"))
        assertThat(externalBankAccountRetryPrenoteResponse.doingBusinessAs()).isEqualTo("string")
        assertThat(externalBankAccountRetryPrenoteResponse.financialAccountToken())
            .isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        assertThat(externalBankAccountRetryPrenoteResponse.name()).isEqualTo("string")
        assertThat(externalBankAccountRetryPrenoteResponse.userDefinedId()).isEqualTo("string")
