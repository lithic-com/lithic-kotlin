...
internal class CaseTransactionTest {
    ...
    fun ofCard() {
        ...
        assertThat(caseTransaction.card()).isEqualTo(card)
        assertThat(caseTransaction.payment()).isNull()
    }
    ...
    fun ofPayment() {
        ...
        assertThat(caseTransaction.card()).isNull()
        assertThat(caseTransaction.payment()).isEqualTo(payment)
    }
