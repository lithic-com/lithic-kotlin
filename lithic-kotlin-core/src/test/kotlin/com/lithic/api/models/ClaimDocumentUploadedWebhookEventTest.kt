...
internal class ClaimDocumentUploadedWebhookEventTest {
    ...
    fun create() {
        ...
        assertThat(claimDocumentUploadedWebhookEvent.downloadUrl()).isEqualTo("download_url")
        ...
        assertThat(claimDocumentUploadedWebhookEvent.failureReason())
            .isEqualTo(ClaimDocumentUploadedWebhookEvent.FailureReason.INVALID_MIME_TYPE)
        assertThat(claimDocumentUploadedWebhookEvent.name()).isEqualTo("name")
        assertThat(claimDocumentUploadedWebhookEvent.requirementId()).isEqualTo("requirement_id")
        ...
        assertThat(claimDocumentUploadedWebhookEvent.uploadUrl()).isEqualTo("upload_url")
