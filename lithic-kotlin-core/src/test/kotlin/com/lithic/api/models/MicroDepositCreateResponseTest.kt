...
internal class MicroDepositCreateResponseTest {
    ...
    fun create() {
        val microDepositCreateResponse =
            MicroDepositCreateResponse.builder()
                ...
                .type(MicroDepositCreateResponse.AccountType.CHECKING)
        ...
        assertThat(microDepositCreateResponse.type())
            .isEqualTo(MicroDepositCreateResponse.AccountType.CHECKING)
    ...
    fun roundtrip() {
        ...
        val roundtrippedMicroDepositCreateResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(microDepositCreateResponse),
                jacksonTypeRef<MicroDepositCreateResponse>(),
            )

        assertThat(roundtrippedMicroDepositCreateResponse).isEqualTo(microDepositCreateResponse)
    }
}
