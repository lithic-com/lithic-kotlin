...
internal class AccountActivityListResponseTest {
    ...
    fun ofInternal() {
        ...
        assertThat(accountActivityListResponse.internal_()).isEqualTo(internal_)
    ...
    fun ofTransfer() {
        ...
        assertThat(accountActivityListResponse.transfer()).isEqualTo(transfer)
        assertThat(accountActivityListResponse.card()).isNull()
        assertThat(accountActivityListResponse.payment()).isNull()
        assertThat(accountActivityListResponse.externalPayment()).isNull()
        assertThat(accountActivityListResponse.managementOperation()).isNull()
    ...
    fun ofCard() {
        val card =
            AccountActivityListResponse.CardTransaction.builder()
                ...
                .merchant(
                    Transaction.TransactionMerchant.builder()
                ...
                .serviceLocation(
                    Transaction.ServiceLocation.builder()
                        .city("city")
                        .country("country")
        ...
        assertThat(accountActivityListResponse.internal_()).isNull()
        assertThat(accountActivityListResponse.transfer()).isNull()
        assertThat(accountActivityListResponse.card()).isEqualTo(card)
        assertThat(accountActivityListResponse.payment()).isNull()
        assertThat(accountActivityListResponse.externalPayment()).isNull()
        assertThat(accountActivityListResponse.managementOperation()).isNull()
        assertThat(accountActivityListResponse.hold()).isNull()
