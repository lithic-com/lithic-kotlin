...
internal class FinancialEventTest {
    ...
    fun create() {
        ...
        assertThat(financialEvent.token()).isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        assertThat(financialEvent.amount()).isEqualTo(0L)
        assertThat(financialEvent.created())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(financialEvent.result()).isEqualTo(FinancialEvent.Result.APPROVED)
        assertThat(financialEvent.type())
            .isEqualTo(FinancialEvent.FinancialEventType.ACH_ORIGINATION_CANCELLED)
    }
