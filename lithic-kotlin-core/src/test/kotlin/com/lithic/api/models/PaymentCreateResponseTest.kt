...
internal class PaymentCreateResponseTest {
    ...
    fun create() {
        ...
        assertThat(paymentCreateResponse.token()).isEqualTo("bd4efddb-771b-49e3-9af9-49b077ab5eb8")
        ...
        assertThat(paymentCreateResponse.descriptor()).isEqualTo("ach_origination_credit")
        ...
        assertThat(paymentCreateResponse.blockchainRecipientToken())
            .isEqualTo("1e3fdb71-4b52-4a30-a7a9-52c85e26a1d9")
        assertThat(paymentCreateResponse.currency()).isEqualTo("USD")
        assertThat(paymentCreateResponse.expectedReleaseDate()).isNull()
        assertThat(paymentCreateResponse.externalBankAccountToken())
            .isEqualTo("feb4fee1-2414-4c38-a5f6-9deac293c8f4")
        assertThat(paymentCreateResponse.tags())
            .isEqualTo(
                Payment.Tags.builder()
                    .putAdditionalProperty("risk-level", JsonValue.from("high"))
                    .build()
            )
        assertThat(paymentCreateResponse.type()).isEqualTo(Payment.TransferType.ORIGINATION_CREDIT)
        assertThat(paymentCreateResponse.userDefinedId()).isNull()
