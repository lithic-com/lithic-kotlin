...
class AccountHolderTest {
    ...
    fun createAccountHolder() {
        ...
        assertThat(accountHolder.externalId()).isEqualTo("string")
        ...
        assertThat(accountHolder.natureOfBusiness()).isEqualTo("string")
        ...
        assertThat(accountHolder.websiteUrl()).isEqualTo("string")
    }
}
