...
internal class DisputeTransactionCreatedWebhookEventTest {
    ...
    fun create() {
        ...
        assertThat(disputeTransactionCreatedWebhookEvent.cardToken())
            .isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        assertThat(disputeTransactionCreatedWebhookEvent.caseId()).isEqualTo("case_id")
        assertThat(disputeTransactionCreatedWebhookEvent.claimToken())
            .isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        ...
        assertThat(disputeTransactionCreatedWebhookEvent.disposition())
            .isEqualTo(DisputeV2.Disposition.WON)
        ...
        assertThat(disputeTransactionCreatedWebhookEvent.status()).isEqualTo(DisputeV2.Status.OPEN)
