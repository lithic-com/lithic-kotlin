    ...
    fun create() {
        val externalBankAccountRetrieveResponse =
            ExternalBankAccountRetrieveResponse.builder()
                ...
                .type(ExternalBankAccountRetrieveResponse.AccountType.CHECKING)
        ...
        assertThat(externalBankAccountRetrieveResponse.type())
            .isEqualTo(ExternalBankAccountRetrieveResponse.AccountType.CHECKING)
        ...
        assertThat(externalBankAccountRetrieveResponse.companyId()).isEqualTo("company_id")
        ...
        assertThat(externalBankAccountRetrieveResponse.financialAccountToken())
            .isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        assertThat(externalBankAccountRetrieveResponse.name()).isEqualTo("name")
        assertThat(externalBankAccountRetrieveResponse.userDefinedId()).isEqualTo("user_defined_id")
