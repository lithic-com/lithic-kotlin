    ...
    fun createExternalBankAccountRetrieveResponse() {
        val externalBankAccountRetrieveResponse =
            ExternalBankAccountRetrieveResponse.builder()
                ...
                .state(ExternalBankAccountRetrieveResponse.State.CLOSED)
                ...
                .verificationState(ExternalBankAccountRetrieveResponse.VerificationState.ENABLED)
        ...
        assertThat(externalBankAccountRetrieveResponse.state())
            .isEqualTo(ExternalBankAccountRetrieveResponse.State.CLOSED)
        assertThat(externalBankAccountRetrieveResponse.type())
            .isEqualTo(ExternalBankAccountRetrieveResponse.Type.CHECKING)
        assertThat(externalBankAccountRetrieveResponse.verificationAttempts()).isEqualTo(123L)
        ...
        assertThat(externalBankAccountRetrieveResponse.verificationState())
            .isEqualTo(ExternalBankAccountRetrieveResponse.VerificationState.ENABLED)
        ...
        assertThat(externalBankAccountRetrieveResponse.companyId()).isEqualTo("string")
        assertThat(externalBankAccountRetrieveResponse.dob())
            .isEqualTo(LocalDate.parse("2019-12-27"))
        assertThat(externalBankAccountRetrieveResponse.doingBusinessAs()).isEqualTo("string")
        assertThat(externalBankAccountRetrieveResponse.financialAccountToken())
            .isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        assertThat(externalBankAccountRetrieveResponse.name()).isEqualTo("string")
        assertThat(externalBankAccountRetrieveResponse.userDefinedId()).isEqualTo("string")
