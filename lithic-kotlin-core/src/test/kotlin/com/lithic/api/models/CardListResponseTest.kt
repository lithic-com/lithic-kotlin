...
internal class CardListResponseTest {
    ...
    fun create() {
        ...
        assertThat(cardListResponse.authRuleTokens()).containsExactly("string")
        assertThat(cardListResponse.cardholderCurrency()).isEqualTo("USD")
        assertThat(cardListResponse.digitalCardArtToken())
            .isEqualTo("00000000-0000-0000-1000-000000000000")
        assertThat(cardListResponse.expMonth()).isEqualTo("06")
        assertThat(cardListResponse.expYear()).isEqualTo("2027")
        assertThat(cardListResponse.hostname()).isEqualTo("hostname")
        assertThat(cardListResponse.memo()).isEqualTo("New Card")
        assertThat(cardListResponse.pendingCommands()).containsExactly("string")
        assertThat(cardListResponse.productId()).isEqualTo("1")
