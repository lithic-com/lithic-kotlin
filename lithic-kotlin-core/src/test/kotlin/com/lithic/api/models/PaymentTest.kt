...
internal class PaymentTest {
    ...
    fun create() {
        ...
        assertThat(payment.pendingAmount()).isEqualTo(200L)
        ...
        assertThat(payment.settledAmount()).isEqualTo(500L)
        ...
        assertThat(payment.expectedReleaseDate()).isEqualTo(LocalDate.parse("2019-12-27"))
        assertThat(payment.externalBankAccountToken())
            .isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        assertThat(payment.type()).isEqualTo(Payment.TransferType.ORIGINATION_CREDIT)
        assertThat(payment.userDefinedId()).isEqualTo("user_defined_id")
    }
