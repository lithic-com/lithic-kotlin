...
internal class TokenizationSimulateResponseTest {
    ...
    fun roundtrip() {
        ...
        val roundtrippedTokenizationSimulateResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(tokenizationSimulateResponse),
                jacksonTypeRef<TokenizationSimulateResponse>(),
            )

        assertThat(roundtrippedTokenizationSimulateResponse).isEqualTo(tokenizationSimulateResponse)
    }
}
