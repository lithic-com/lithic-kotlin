...
internal class ManagementOperationCreatedWebhookEventTest {
    ...
    fun create() {
        ...
        assertThat(managementOperationCreatedWebhookEvent.currency()).isEqualTo("currency")
        ...
        assertThat(managementOperationCreatedWebhookEvent.events())
            .containsExactly(
                ManagementOperationTransaction.ManagementOperationEvent.builder()
                    .token("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .amount(0L)
        ...
        assertThat(managementOperationCreatedWebhookEvent.financialAccountToken())
            .isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        assertThat(managementOperationCreatedWebhookEvent.pendingAmount()).isEqualTo(0L)
        ...
        assertThat(managementOperationCreatedWebhookEvent.settledAmount()).isEqualTo(0L)
