...
internal class StatementTest {
    ...
    fun create() {
        ...
        assertThat(statement.nextPaymentDueDate()).isEqualTo(LocalDate.parse("2019-12-27"))
        assertThat(statement.nextStatementEndDate()).isEqualTo(LocalDate.parse("2019-12-27"))
        ...
        assertThat(statement.statementTotals())
            .isEqualTo(
                StatementTotals.builder()
                    .balanceTransfers(0L)
                    .cashAdvances(0L)
