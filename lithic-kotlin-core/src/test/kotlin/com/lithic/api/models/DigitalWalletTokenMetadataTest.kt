...
internal class DigitalWalletTokenMetadataTest {
    ...
    fun create() {
        ...
        assertThat(digitalWalletTokenMetadata.paymentAppInstanceId())
            .isEqualTo("payment_app_instance_id")
        assertThat(digitalWalletTokenMetadata.tokenRequestorId()).isEqualTo("xxxxxxxxxxx")
        assertThat(digitalWalletTokenMetadata.tokenRequestorName())
            .isEqualTo(DigitalWalletTokenMetadata.TokenRequestorName.APPLE_PAY)
    }
