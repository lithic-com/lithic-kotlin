...
internal class ClaimDocumentAcceptedWebhookEventTest {
    ...
    fun create() {
        ...
        assertThat(claimDocumentAcceptedWebhookEvent.downloadUrl()).isEqualTo("download_url")
        ...
        assertThat(claimDocumentAcceptedWebhookEvent.failureReason())
            .isEqualTo(ClaimDocumentAcceptedWebhookEvent.FailureReason.INVALID_MIME_TYPE)
        assertThat(claimDocumentAcceptedWebhookEvent.name()).isEqualTo("name")
        assertThat(claimDocumentAcceptedWebhookEvent.requirementId()).isEqualTo("requirement_id")
        ...
        assertThat(claimDocumentAcceptedWebhookEvent.uploadUrl()).isEqualTo("upload_url")
