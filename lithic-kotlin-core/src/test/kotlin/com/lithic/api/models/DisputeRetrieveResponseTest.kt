...
internal class DisputeRetrieveResponseTest {
    ...
    fun create() {
        ...
        assertThat(disputeRetrieveResponse.customerFiledDate())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(disputeRetrieveResponse.customerNote()).isEqualTo("customer_note")
        assertThat(disputeRetrieveResponse.networkClaimIds()).containsExactly("string")
        assertThat(disputeRetrieveResponse.networkFiledDate())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(disputeRetrieveResponse.networkReasonCode()).isEqualTo("network_reason_code")
        assertThat(disputeRetrieveResponse.prearbitrationDate())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(disputeRetrieveResponse.primaryClaimId()).isEqualTo("primary_claim_id")
        ...
        assertThat(disputeRetrieveResponse.resolutionDate())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(disputeRetrieveResponse.resolutionNote()).isEqualTo("resolution_note")
        assertThat(disputeRetrieveResponse.resolutionReason())
            .isEqualTo(DisputeRetrieveResponse.ResolutionReason.CASE_LOST)
