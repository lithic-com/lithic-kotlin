...
internal class DisputeTest {
    ...
    fun create() {
        ...
        assertThat(dispute.caseId()).isEqualTo("case_id")
        ...
        assertThat(dispute.disposition()).isEqualTo(Dispute.Disposition.WON)
        ...
        assertThat(dispute.status()).isEqualTo(Dispute.Status.OPEN)
