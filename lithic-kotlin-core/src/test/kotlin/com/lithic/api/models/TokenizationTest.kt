...
internal class TokenizationTest {
    ...
    fun create() {
            ...
            Tokenization.builder()
                ...
                .addEvent(
                    Tokenization.TokenizationEvent.builder()
                        .token("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                        .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                        .result(Tokenization.TokenizationEvent.TokenizationEventOutcome.APPROVED)
                        .addRuleResult(
                        ...
                        .addTokenizationDeclineReason(
                            Tokenization.TokenizationEvent.TokenizationDeclineReason.ACCOUNT_SCORE_1
                        )
        ...
        assertThat(tokenization.dpan()).isEqualTo("dpan")
        ...
        assertThat(tokenization.updatedAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(tokenization.deviceId()).isEqualTo("device_id")
        ...
        assertThat(tokenization.events())
            .containsExactly(
                Tokenization.TokenizationEvent.builder()
                    ...
                    .addTokenizationTfaReason(
                        Tokenization.TokenizationEvent.TokenizationTfaReason.WALLET_RECOMMENDED_TFA
                    )
                    .type(Tokenization.TokenizationEvent.Type.TOKENIZATION_2_FA)
                    .build()
            )
        assertThat(tokenization.paymentAccountReferenceId())
            .isEqualTo("payment_account_reference_id")
    }
