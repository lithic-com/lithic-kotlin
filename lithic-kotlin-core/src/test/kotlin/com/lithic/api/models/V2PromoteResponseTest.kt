...
internal class V2PromoteResponseTest {
    ...
    fun create() {
        val v2PromoteResponse =
            V2PromoteResponse.builder()
                ...
                .eventStream(V2PromoteResponse.EventStream.AUTHORIZATION)
                .lithicManaged(true)
                .name("name")
                .programLevel(true)
        ...
        assertThat(v2PromoteResponse.businessAccountTokens())
            .containsExactly("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        ...
        assertThat(v2PromoteResponse.eventStream())
            .isEqualTo(V2PromoteResponse.EventStream.AUTHORIZATION)
        assertThat(v2PromoteResponse.lithicManaged()).isEqualTo(true)
        assertThat(v2PromoteResponse.name()).isEqualTo("name")
        ...
        assertThat(v2PromoteResponse.excludedCardTokens())
            .containsExactly("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedV2PromoteResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(v2PromoteResponse),
                jacksonTypeRef<V2PromoteResponse>(),
            )

        assertThat(roundtrippedV2PromoteResponse).isEqualTo(v2PromoteResponse)
    }
}
