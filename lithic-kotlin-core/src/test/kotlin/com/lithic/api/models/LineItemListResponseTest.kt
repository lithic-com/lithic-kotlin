    ...
    fun createLineItemListResponse() {
        val lineItemListResponse =
            LineItemListResponse.builder()
                ...
                .currency("string")
                .eventType(LineItemListResponse.FinancialEventType.ACH_EXCEEDED_THRESHOLD)
        ...
        assertThat(lineItemListResponse.eventType())
            .isEqualTo(LineItemListResponse.FinancialEventType.ACH_EXCEEDED_THRESHOLD)
        ...
        assertThat(lineItemListResponse.cardToken())
            .isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        assertThat(lineItemListResponse.descriptor()).isEqualTo("string")
    }
}
