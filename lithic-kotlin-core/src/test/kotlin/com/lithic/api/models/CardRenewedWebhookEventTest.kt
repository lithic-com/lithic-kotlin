...
internal class CardRenewedWebhookEventTest {
    ...
    fun create() {
        ...
        assertThat(cardRenewedWebhookEvent.expMonth()).isEqualTo("01")
        assertThat(cardRenewedWebhookEvent.expYear()).isEqualTo("2030")
        assertThat(cardRenewedWebhookEvent.previousExpMonth()).isEqualTo("01")
        assertThat(cardRenewedWebhookEvent.previousExpYear()).isEqualTo("2024")
    }
