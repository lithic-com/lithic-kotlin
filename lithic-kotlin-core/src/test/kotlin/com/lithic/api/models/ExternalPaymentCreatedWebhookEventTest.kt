...
internal class ExternalPaymentCreatedWebhookEventTest {
    ...
    fun create() {
        ...
        assertThat(externalPaymentCreatedWebhookEvent.currency()).isEqualTo("currency")
        assertThat(externalPaymentCreatedWebhookEvent.events())
            .containsExactly(
                ExternalPayment.ExternalPaymentEvent.builder()
                    .token("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .amount(0L)
        ...
        assertThat(externalPaymentCreatedWebhookEvent.pendingAmount()).isEqualTo(0L)
        assertThat(externalPaymentCreatedWebhookEvent.result())
            .isEqualTo(ExternalPayment.TransactionResult.APPROVED)
        assertThat(externalPaymentCreatedWebhookEvent.settledAmount()).isEqualTo(0L)
        assertThat(externalPaymentCreatedWebhookEvent.userDefinedId()).isEqualTo("user_defined_id")
