...
internal class ExternalPaymentUpdatedWebhookEventTest {
    ...
    fun create() {
        ...
        assertThat(externalPaymentUpdatedWebhookEvent.currency()).isEqualTo("currency")
        assertThat(externalPaymentUpdatedWebhookEvent.events())
            .containsExactly(
                ExternalPayment.ExternalPaymentEvent.builder()
                    .token("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .amount(0L)
        ...
        assertThat(externalPaymentUpdatedWebhookEvent.family())
            .isEqualTo(ExternalPayment.Family.EXTERNAL_PAYMENT)
        ...
        assertThat(externalPaymentUpdatedWebhookEvent.pendingAmount()).isEqualTo(0L)
        assertThat(externalPaymentUpdatedWebhookEvent.result())
            .isEqualTo(ExternalPayment.TransactionResult.APPROVED)
        assertThat(externalPaymentUpdatedWebhookEvent.settledAmount()).isEqualTo(0L)
        assertThat(externalPaymentUpdatedWebhookEvent.userDefinedId()).isEqualTo("user_defined_id")
