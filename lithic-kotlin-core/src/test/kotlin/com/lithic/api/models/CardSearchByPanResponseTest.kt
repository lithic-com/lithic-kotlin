...
internal class CardSearchByPanResponseTest {
    ...
    fun create() {
        ...
        assertThat(cardSearchByPanResponse.authRuleTokens()).containsExactly("string")
        assertThat(cardSearchByPanResponse.cardholderCurrency()).isEqualTo("USD")
        assertThat(cardSearchByPanResponse.cvv()).isEqualTo("776")
        assertThat(cardSearchByPanResponse.digitalCardArtToken())
            .isEqualTo("00000000-0000-0000-1000-000000000000")
        assertThat(cardSearchByPanResponse.expMonth()).isEqualTo("06")
        assertThat(cardSearchByPanResponse.expYear()).isEqualTo("2027")
        assertThat(cardSearchByPanResponse.hostname()).isEqualTo("hostname")
        assertThat(cardSearchByPanResponse.memo()).isEqualTo("New Card")
        assertThat(cardSearchByPanResponse.pan()).isEqualTo("4111111289144142")
        assertThat(cardSearchByPanResponse.pendingCommands()).containsExactly("string")
        assertThat(cardSearchByPanResponse.productId()).isEqualTo("1")
