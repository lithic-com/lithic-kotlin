...
internal class CaseFileTest {
    ...
    fun create() {
        ...
        assertThat(caseFile.downloadUrl()).isEqualTo("download_url")
        assertThat(caseFile.downloadUrlExpires())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(caseFile.failureReason()).isEqualTo("failure_reason")
        assertThat(caseFile.mimeType()).isEqualTo("mime_type")
        assertThat(caseFile.name()).isEqualTo("name")
        assertThat(caseFile.sizeBytes()).isEqualTo(0L)
        ...
        assertThat(caseFile.uploadUrl()).isEqualTo("upload_url")
