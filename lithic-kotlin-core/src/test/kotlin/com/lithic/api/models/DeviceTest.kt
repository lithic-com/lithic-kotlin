...
internal class DeviceTest {
    ...
    fun create() {
        ...
        assertThat(device.imei()).isEqualTo("123456789012345")
        assertThat(device.ipAddress()).isEqualTo("1.1.1.1")
        assertThat(device.location()).isEqualTo("37.3860517/-122.0838511")
    }
