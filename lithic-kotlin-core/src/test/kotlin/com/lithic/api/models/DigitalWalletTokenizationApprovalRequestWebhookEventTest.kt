...
internal class DigitalWalletTokenizationApprovalRequestWebhookEventTest {
    ...
    fun create() {
        ...
        assertThat(digitalWalletTokenizationApprovalRequestWebhookEvent.ruleResults())
            .containsExactly(
                TokenizationRuleResult.builder()
                    .authRuleToken("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .explanation("explanation")
        ...
        assertThat(digitalWalletTokenizationApprovalRequestWebhookEvent.tokenizationTfaReasons())
