...
internal class ClaimDocumentRejectedWebhookEventTest {
    ...
    fun create() {
        ...
        assertThat(claimDocumentRejectedWebhookEvent.downloadUrl()).isEqualTo("download_url")
        ...
        assertThat(claimDocumentRejectedWebhookEvent.failureReason())
            .isEqualTo(ClaimDocumentRejectedWebhookEvent.FailureReason.INVALID_MIME_TYPE)
        assertThat(claimDocumentRejectedWebhookEvent.name()).isEqualTo("name")
        assertThat(claimDocumentRejectedWebhookEvent.requirementId()).isEqualTo("requirement_id")
        ...
        assertThat(claimDocumentRejectedWebhookEvent.uploadUrl()).isEqualTo("upload_url")
