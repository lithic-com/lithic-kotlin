...
internal class CardCreateResponseTest {
    ...
    fun create() {
        ...
        assertThat(cardCreateResponse.authRuleTokens()).containsExactly("string")
        assertThat(cardCreateResponse.cardholderCurrency()).isEqualTo("USD")
        assertThat(cardCreateResponse.cvv()).isEqualTo("776")
        assertThat(cardCreateResponse.digitalCardArtToken())
            .isEqualTo("00000000-0000-0000-1000-000000000000")
        assertThat(cardCreateResponse.expMonth()).isEqualTo("06")
        assertThat(cardCreateResponse.expYear()).isEqualTo("2027")
        assertThat(cardCreateResponse.hostname()).isEqualTo("hostname")
        assertThat(cardCreateResponse.memo()).isEqualTo("New Card")
        assertThat(cardCreateResponse.pan()).isEqualTo("4111111289144142")
        assertThat(cardCreateResponse.pendingCommands()).containsExactly("string")
        assertThat(cardCreateResponse.productId()).isEqualTo("1")
