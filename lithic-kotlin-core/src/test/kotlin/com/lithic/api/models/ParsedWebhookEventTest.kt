...
internal class ParsedWebhookEventTest {
    ...
    fun ofAccountHolderCreated() {
        ...
        assertThat(parsedWebhookEvent.accountHolderCreated()).isEqualTo(accountHolderCreated)
        ...
        assertThat(parsedWebhookEvent.cardAuthorizationChallenge()).isNull()
        assertThat(parsedWebhookEvent.cardAuthorizationChallengeResponse()).isNull()
        ...
        assertThat(parsedWebhookEvent.cardPinUpdated()).isNull()
        ...
        assertThat(parsedWebhookEvent.claimCreated()).isNull()
        assertThat(parsedWebhookEvent.claimUpdated()).isNull()
        assertThat(parsedWebhookEvent.claimDocumentUploaded()).isNull()
        assertThat(parsedWebhookEvent.claimDocumentAccepted()).isNull()
        assertThat(parsedWebhookEvent.claimDocumentRejected()).isNull()
        ...
        assertThat(parsedWebhookEvent.embedSessionGenerated()).isNull()
        assertThat(parsedWebhookEvent.embedViewed()).isNull()
    ...
    fun ofKybPayload() {
        ...
        assertThat(parsedWebhookEvent.kybPayload()).isEqualTo(kybPayload)
        assertThat(parsedWebhookEvent.kycPayload()).isNull()
        assertThat(parsedWebhookEvent.legacyPayload()).isNull()
        assertThat(parsedWebhookEvent.accountHolderVerification()).isNull()
        assertThat(parsedWebhookEvent.accountHolderDocumentUpdated()).isNull()
    ...
    fun ofKycPayload() {
        ...
        assertThat(parsedWebhookEvent.accountHolderCreated()).isNull()
        assertThat(parsedWebhookEvent.kybPayload()).isNull()
        assertThat(parsedWebhookEvent.kycPayload()).isEqualTo(kycPayload)
        assertThat(parsedWebhookEvent.legacyPayload()).isNull()
        assertThat(parsedWebhookEvent.accountHolderVerification()).isNull()
        assertThat(parsedWebhookEvent.accountHolderDocumentUpdated()).isNull()
        assertThat(parsedWebhookEvent.cardAuthorizationApprovalRequest()).isNull()
    ...
    fun ofLegacyPayload() {
        ...
        assertThat(parsedWebhookEvent.kybPayload()).isNull()
        assertThat(parsedWebhookEvent.kycPayload()).isNull()
        assertThat(parsedWebhookEvent.legacyPayload()).isEqualTo(legacyPayload)
        assertThat(parsedWebhookEvent.accountHolderVerification()).isNull()
        assertThat(parsedWebhookEvent.accountHolderDocumentUpdated()).isNull()
        assertThat(parsedWebhookEvent.cardAuthorizationApprovalRequest()).isNull()
        assertThat(parsedWebhookEvent.cardAuthorizationChallenge()).isNull()
    ...
    fun ofCardAuthorizationChallenge() {
        ...
        assertThat(parsedWebhookEvent.cardAuthorizationChallenge())
            .isEqualTo(cardAuthorizationChallenge)
        assertThat(parsedWebhookEvent.cardAuthorizationChallengeResponse()).isNull()
        assertThat(parsedWebhookEvent.authRulesBacktestReportCreated()).isNull()
        assertThat(parsedWebhookEvent.balanceUpdated()).isNull()
        assertThat(parsedWebhookEvent.bookTransferTransactionCreated()).isNull()
    ...
    fun ofCardAuthorizationChallengeResponse() {
        ...
        assertThat(parsedWebhookEvent.cardAuthorizationChallengeResponse())
            .isEqualTo(cardAuthorizationChallengeResponse)
        assertThat(parsedWebhookEvent.authRulesBacktestReportCreated()).isNull()
        assertThat(parsedWebhookEvent.balanceUpdated()).isNull()
        assertThat(parsedWebhookEvent.bookTransferTransactionCreated()).isNull()
        assertThat(parsedWebhookEvent.bookTransferTransactionUpdated()).isNull()
    ...
    fun ofBookTransferTransactionCreated() {
        ...
        assertThat(parsedWebhookEvent.bookTransferTransactionCreated())
            .isEqualTo(bookTransferTransactionCreated)
        assertThat(parsedWebhookEvent.bookTransferTransactionUpdated()).isNull()
        assertThat(parsedWebhookEvent.cardCreated()).isNull()
        assertThat(parsedWebhookEvent.cardConverted()).isNull()
        assertThat(parsedWebhookEvent.cardPinUpdated()).isNull()
    ...
    fun ofBookTransferTransactionUpdated() {
        ...
        assertThat(parsedWebhookEvent.bookTransferTransactionUpdated())
            .isEqualTo(bookTransferTransactionUpdated)
        assertThat(parsedWebhookEvent.cardCreated()).isNull()
        assertThat(parsedWebhookEvent.cardConverted()).isNull()
        assertThat(parsedWebhookEvent.cardPinUpdated()).isNull()
        assertThat(parsedWebhookEvent.cardRenewed()).isNull()
    ...
    fun ofCardCreated() {
        ...
        assertThat(parsedWebhookEvent.bookTransferTransactionCreated()).isNull()
        assertThat(parsedWebhookEvent.bookTransferTransactionUpdated()).isNull()
        assertThat(parsedWebhookEvent.cardCreated()).isEqualTo(cardCreated)
        assertThat(parsedWebhookEvent.cardConverted()).isNull()
        assertThat(parsedWebhookEvent.cardPinUpdated()).isNull()
        assertThat(parsedWebhookEvent.cardRenewed()).isNull()
        assertThat(parsedWebhookEvent.cardReissued()).isNull()
    ...
    fun ofCardConverted() {
        ...
        assertThat(parsedWebhookEvent.bookTransferTransactionUpdated()).isNull()
        assertThat(parsedWebhookEvent.cardCreated()).isNull()
        assertThat(parsedWebhookEvent.cardConverted()).isEqualTo(cardConverted)
        assertThat(parsedWebhookEvent.cardPinUpdated()).isNull()
        assertThat(parsedWebhookEvent.cardRenewed()).isNull()
        assertThat(parsedWebhookEvent.cardReissued()).isNull()
        assertThat(parsedWebhookEvent.cardShipped()).isNull()
    ...
    fun ofCardPinUpdated() {
        ...
        val parsedWebhookEvent = ParsedWebhookEvent.ofCardPinUpdated(cardPinUpdated)
        ...
        assertThat(parsedWebhookEvent.cardCreated()).isNull()
        assertThat(parsedWebhookEvent.cardConverted()).isNull()
        assertThat(parsedWebhookEvent.cardPinUpdated()).isEqualTo(cardPinUpdated)
        assertThat(parsedWebhookEvent.cardRenewed()).isNull()
        assertThat(parsedWebhookEvent.cardReissued()).isNull()
        assertThat(parsedWebhookEvent.cardShipped()).isNull()
        assertThat(parsedWebhookEvent.cardUpdated()).isNull()
    ...
    @Test
    fun ofCardPinUpdatedRoundtrip() {
        val jsonMapper = jsonMapper()
        val parsedWebhookEvent =
            ParsedWebhookEvent.ofCardPinUpdated(
                CardPinUpdatedWebhookEvent.builder()
                    .cardToken("4df9a19c-9e1e-40d1-b27a-05e01152ee07")
                    .eventType(CardPinUpdatedWebhookEvent.EventType.CARD_PIN_UPDATED)
                    .pinStatus(CardPinUpdatedWebhookEvent.PinStatus.OK)
    ...
    fun ofCardRenewed() {
        ...
        assertThat(parsedWebhookEvent.cardConverted()).isNull()
        assertThat(parsedWebhookEvent.cardPinUpdated()).isNull()
        assertThat(parsedWebhookEvent.cardRenewed()).isEqualTo(cardRenewed)
        assertThat(parsedWebhookEvent.cardReissued()).isNull()
        assertThat(parsedWebhookEvent.cardShipped()).isNull()
        assertThat(parsedWebhookEvent.cardUpdated()).isNull()
        assertThat(parsedWebhookEvent.cardTransactionUpdated()).isNull()
    ...
    fun ofCardReissued() {
        ...
        assertThat(parsedWebhookEvent.cardPinUpdated()).isNull()
        assertThat(parsedWebhookEvent.cardRenewed()).isNull()
        assertThat(parsedWebhookEvent.cardReissued()).isEqualTo(cardReissued)
        assertThat(parsedWebhookEvent.cardShipped()).isNull()
        assertThat(parsedWebhookEvent.cardUpdated()).isNull()
        assertThat(parsedWebhookEvent.cardTransactionUpdated()).isNull()
        assertThat(parsedWebhookEvent.cardTransactionEnhancedDataCreated()).isNull()
    ...
    fun ofCardShipped() {
        ...
        assertThat(parsedWebhookEvent.cardRenewed()).isNull()
        assertThat(parsedWebhookEvent.cardReissued()).isNull()
        assertThat(parsedWebhookEvent.cardShipped()).isEqualTo(cardShipped)
        assertThat(parsedWebhookEvent.cardUpdated()).isNull()
        assertThat(parsedWebhookEvent.cardTransactionUpdated()).isNull()
        assertThat(parsedWebhookEvent.cardTransactionEnhancedDataCreated()).isNull()
        assertThat(parsedWebhookEvent.cardTransactionEnhancedDataUpdated()).isNull()
    ...
    fun ofCardUpdated() {
        ...
        assertThat(parsedWebhookEvent.cardReissued()).isNull()
        assertThat(parsedWebhookEvent.cardShipped()).isNull()
        assertThat(parsedWebhookEvent.cardUpdated()).isEqualTo(cardUpdated)
        assertThat(parsedWebhookEvent.cardTransactionUpdated()).isNull()
        assertThat(parsedWebhookEvent.cardTransactionEnhancedDataCreated()).isNull()
        assertThat(parsedWebhookEvent.cardTransactionEnhancedDataUpdated()).isNull()
        assertThat(parsedWebhookEvent.claimCreated()).isNull()
    ...
    fun ofCardTransactionUpdated() {
        ...
        assertThat(parsedWebhookEvent.cardShipped()).isNull()
        assertThat(parsedWebhookEvent.cardUpdated()).isNull()
        assertThat(parsedWebhookEvent.cardTransactionUpdated()).isEqualTo(cardTransactionUpdated)
        assertThat(parsedWebhookEvent.cardTransactionEnhancedDataCreated()).isNull()
        assertThat(parsedWebhookEvent.cardTransactionEnhancedDataUpdated()).isNull()
        assertThat(parsedWebhookEvent.claimCreated()).isNull()
        assertThat(parsedWebhookEvent.claimUpdated()).isNull()
    ...
    fun ofCardTransactionEnhancedDataCreated() {
        ...
        assertThat(parsedWebhookEvent.cardTransactionEnhancedDataCreated())
            .isEqualTo(cardTransactionEnhancedDataCreated)
        assertThat(parsedWebhookEvent.cardTransactionEnhancedDataUpdated()).isNull()
        assertThat(parsedWebhookEvent.claimCreated()).isNull()
        assertThat(parsedWebhookEvent.claimUpdated()).isNull()
        assertThat(parsedWebhookEvent.claimDocumentUploaded()).isNull()
    ...
    fun ofCardTransactionEnhancedDataUpdated() {
        ...
        assertThat(parsedWebhookEvent.cardTransactionEnhancedDataUpdated())
            .isEqualTo(cardTransactionEnhancedDataUpdated)
        assertThat(parsedWebhookEvent.claimCreated()).isNull()
        assertThat(parsedWebhookEvent.claimUpdated()).isNull()
        assertThat(parsedWebhookEvent.claimDocumentUploaded()).isNull()
        assertThat(parsedWebhookEvent.claimDocumentAccepted()).isNull()
    ...
    fun ofClaimCreated() {
        ...
        assertThat(parsedWebhookEvent.cardTransactionEnhancedDataCreated()).isNull()
        assertThat(parsedWebhookEvent.cardTransactionEnhancedDataUpdated()).isNull()
        assertThat(parsedWebhookEvent.claimCreated()).isEqualTo(claimCreated)
        assertThat(parsedWebhookEvent.claimUpdated()).isNull()
        assertThat(parsedWebhookEvent.claimDocumentUploaded()).isNull()
        assertThat(parsedWebhookEvent.claimDocumentAccepted()).isNull()
        assertThat(parsedWebhookEvent.claimDocumentRejected()).isNull()
    ...
    fun ofClaimUpdated() {
        ...
        assertThat(parsedWebhookEvent.cardTransactionEnhancedDataUpdated()).isNull()
        assertThat(parsedWebhookEvent.claimCreated()).isNull()
        assertThat(parsedWebhookEvent.claimUpdated()).isEqualTo(claimUpdated)
        assertThat(parsedWebhookEvent.claimDocumentUploaded()).isNull()
        assertThat(parsedWebhookEvent.claimDocumentAccepted()).isNull()
        assertThat(parsedWebhookEvent.claimDocumentRejected()).isNull()
        assertThat(parsedWebhookEvent.digitalWalletTokenizationApprovalRequest()).isNull()
    ...
    fun ofClaimDocumentUploaded() {
        ...
        assertThat(parsedWebhookEvent.claimCreated()).isNull()
        assertThat(parsedWebhookEvent.claimUpdated()).isNull()
        assertThat(parsedWebhookEvent.claimDocumentUploaded()).isEqualTo(claimDocumentUploaded)
        assertThat(parsedWebhookEvent.claimDocumentAccepted()).isNull()
        assertThat(parsedWebhookEvent.claimDocumentRejected()).isNull()
        assertThat(parsedWebhookEvent.digitalWalletTokenizationApprovalRequest()).isNull()
        assertThat(parsedWebhookEvent.digitalWalletTokenizationResult()).isNull()
    ...
    fun ofClaimDocumentAccepted() {
        ...
        assertThat(parsedWebhookEvent.claimUpdated()).isNull()
        assertThat(parsedWebhookEvent.claimDocumentUploaded()).isNull()
        assertThat(parsedWebhookEvent.claimDocumentAccepted()).isEqualTo(claimDocumentAccepted)
        assertThat(parsedWebhookEvent.claimDocumentRejected()).isNull()
        assertThat(parsedWebhookEvent.digitalWalletTokenizationApprovalRequest()).isNull()
        assertThat(parsedWebhookEvent.digitalWalletTokenizationResult()).isNull()
        assertThat(parsedWebhookEvent.digitalWalletTokenizationTwoFactorAuthenticationCode())
    ...
    fun ofClaimDocumentRejected() {
        ...
        assertThat(parsedWebhookEvent.claimDocumentUploaded()).isNull()
        assertThat(parsedWebhookEvent.claimDocumentAccepted()).isNull()
        assertThat(parsedWebhookEvent.claimDocumentRejected()).isEqualTo(claimDocumentRejected)
        assertThat(parsedWebhookEvent.digitalWalletTokenizationApprovalRequest()).isNull()
        assertThat(parsedWebhookEvent.digitalWalletTokenizationResult()).isNull()
        assertThat(parsedWebhookEvent.digitalWalletTokenizationTwoFactorAuthenticationCode())
            .isNull()
    ...
    fun ofDigitalWalletTokenizationApprovalRequest() {
        ...
        assertThat(parsedWebhookEvent.digitalWalletTokenizationApprovalRequest())
            .isEqualTo(digitalWalletTokenizationApprovalRequest)
        assertThat(parsedWebhookEvent.digitalWalletTokenizationResult()).isNull()
        assertThat(parsedWebhookEvent.digitalWalletTokenizationTwoFactorAuthenticationCode())
            .isNull()
        assertThat(parsedWebhookEvent.digitalWalletTokenizationTwoFactorAuthenticationCodeSent())
    ...
    fun ofDigitalWalletTokenizationResult() {
        ...
        assertThat(parsedWebhookEvent.digitalWalletTokenizationResult())
            .isEqualTo(digitalWalletTokenizationResult)
        assertThat(parsedWebhookEvent.digitalWalletTokenizationTwoFactorAuthenticationCode())
            .isNull()
        assertThat(parsedWebhookEvent.digitalWalletTokenizationTwoFactorAuthenticationCodeSent())
            .isNull()
    ...
    fun ofDigitalWalletTokenizationTwoFactorAuthenticationCode() {
        ...
        assertThat(parsedWebhookEvent.digitalWalletTokenizationResult()).isNull()
        assertThat(parsedWebhookEvent.digitalWalletTokenizationTwoFactorAuthenticationCode())
            .isEqualTo(digitalWalletTokenizationTwoFactorAuthenticationCode)
        assertThat(parsedWebhookEvent.digitalWalletTokenizationTwoFactorAuthenticationCodeSent())
            .isNull()
        assertThat(parsedWebhookEvent.digitalWalletTokenizationUpdated()).isNull()
        assertThat(parsedWebhookEvent.disputeUpdated()).isNull()
    ...
    fun ofDigitalWalletTokenizationTwoFactorAuthenticationCodeSent() {
        ...
        assertThat(parsedWebhookEvent.digitalWalletTokenizationTwoFactorAuthenticationCode())
            .isNull()
        assertThat(parsedWebhookEvent.digitalWalletTokenizationTwoFactorAuthenticationCodeSent())
            .isEqualTo(digitalWalletTokenizationTwoFactorAuthenticationCodeSent)
        assertThat(parsedWebhookEvent.digitalWalletTokenizationUpdated()).isNull()
        assertThat(parsedWebhookEvent.disputeUpdated()).isNull()
        assertThat(parsedWebhookEvent.disputeEvidenceUploadFailed()).isNull()
        assertThat(parsedWebhookEvent.embedSessionGenerated()).isNull()
    ...
    fun ofDigitalWalletTokenizationUpdated() {
        ...
        assertThat(parsedWebhookEvent.digitalWalletTokenizationUpdated())
            .isEqualTo(digitalWalletTokenizationUpdated)
        assertThat(parsedWebhookEvent.disputeUpdated()).isNull()
        assertThat(parsedWebhookEvent.disputeEvidenceUploadFailed()).isNull()
        assertThat(parsedWebhookEvent.embedSessionGenerated()).isNull()
        assertThat(parsedWebhookEvent.embedViewed()).isNull()
    ...
    fun ofDisputeUpdated() {
        ...
        assertThat(parsedWebhookEvent.digitalWalletTokenizationTwoFactorAuthenticationCodeSent())
            .isNull()
        assertThat(parsedWebhookEvent.digitalWalletTokenizationUpdated()).isNull()
        assertThat(parsedWebhookEvent.disputeUpdated()).isEqualTo(disputeUpdated)
        assertThat(parsedWebhookEvent.disputeEvidenceUploadFailed()).isNull()
        assertThat(parsedWebhookEvent.embedSessionGenerated()).isNull()
        assertThat(parsedWebhookEvent.embedViewed()).isNull()
        assertThat(parsedWebhookEvent.externalBankAccountCreated()).isNull()
    ...
    fun ofDisputeEvidenceUploadFailed() {
        ...
        assertThat(parsedWebhookEvent.disputeEvidenceUploadFailed())
            .isEqualTo(disputeEvidenceUploadFailed)
        assertThat(parsedWebhookEvent.embedSessionGenerated()).isNull()
        assertThat(parsedWebhookEvent.embedViewed()).isNull()
        assertThat(parsedWebhookEvent.externalBankAccountCreated()).isNull()
        assertThat(parsedWebhookEvent.externalBankAccountUpdated()).isNull()
    ...
    fun ofEmbedSessionGenerated() {
        ...
        assertThat(parsedWebhookEvent.disputeUpdated()).isNull()
        assertThat(parsedWebhookEvent.disputeEvidenceUploadFailed()).isNull()
        assertThat(parsedWebhookEvent.embedSessionGenerated()).isEqualTo(embedSessionGenerated)
        assertThat(parsedWebhookEvent.embedViewed()).isNull()
        assertThat(parsedWebhookEvent.externalBankAccountCreated()).isNull()
        assertThat(parsedWebhookEvent.externalBankAccountUpdated()).isNull()
        assertThat(parsedWebhookEvent.externalPaymentCreated()).isNull()
    ...
    fun ofEmbedViewed() {
        ...
        assertThat(parsedWebhookEvent.disputeEvidenceUploadFailed()).isNull()
        assertThat(parsedWebhookEvent.embedSessionGenerated()).isNull()
        assertThat(parsedWebhookEvent.embedViewed()).isEqualTo(embedViewed)
        assertThat(parsedWebhookEvent.externalBankAccountCreated()).isNull()
        assertThat(parsedWebhookEvent.externalBankAccountUpdated()).isNull()
        assertThat(parsedWebhookEvent.externalPaymentCreated()).isNull()
        assertThat(parsedWebhookEvent.externalPaymentUpdated()).isNull()
    ...
    fun ofExternalBankAccountCreated() {
        ...
        assertThat(parsedWebhookEvent.externalBankAccountCreated())
            .isEqualTo(externalBankAccountCreated)
        assertThat(parsedWebhookEvent.externalBankAccountUpdated()).isNull()
        assertThat(parsedWebhookEvent.externalPaymentCreated()).isNull()
        assertThat(parsedWebhookEvent.externalPaymentUpdated()).isNull()
        assertThat(parsedWebhookEvent.financialAccountCreated()).isNull()
    ...
    fun ofExternalBankAccountUpdated() {
        ...
        assertThat(parsedWebhookEvent.externalBankAccountUpdated())
            .isEqualTo(externalBankAccountUpdated)
        assertThat(parsedWebhookEvent.externalPaymentCreated()).isNull()
        assertThat(parsedWebhookEvent.externalPaymentUpdated()).isNull()
        assertThat(parsedWebhookEvent.financialAccountCreated()).isNull()
        assertThat(parsedWebhookEvent.financialAccountUpdated()).isNull()
    ...
    fun ofExternalPaymentCreated() {
        ...
        assertThat(parsedWebhookEvent.externalBankAccountCreated()).isNull()
        assertThat(parsedWebhookEvent.externalBankAccountUpdated()).isNull()
        assertThat(parsedWebhookEvent.externalPaymentCreated()).isEqualTo(externalPaymentCreated)
        assertThat(parsedWebhookEvent.externalPaymentUpdated()).isNull()
        assertThat(parsedWebhookEvent.financialAccountCreated()).isNull()
        assertThat(parsedWebhookEvent.financialAccountUpdated()).isNull()
        assertThat(parsedWebhookEvent.fundingEventCreated()).isNull()
    ...
    fun ofExternalPaymentUpdated() {
        ...
        assertThat(parsedWebhookEvent.externalBankAccountUpdated()).isNull()
        assertThat(parsedWebhookEvent.externalPaymentCreated()).isNull()
        assertThat(parsedWebhookEvent.externalPaymentUpdated()).isEqualTo(externalPaymentUpdated)
        assertThat(parsedWebhookEvent.financialAccountCreated()).isNull()
        assertThat(parsedWebhookEvent.financialAccountUpdated()).isNull()
        assertThat(parsedWebhookEvent.fundingEventCreated()).isNull()
        assertThat(parsedWebhookEvent.loanTapeCreated()).isNull()
    ...
    fun ofFinancialAccountCreated() {
        ...
        assertThat(parsedWebhookEvent.externalPaymentCreated()).isNull()
        assertThat(parsedWebhookEvent.externalPaymentUpdated()).isNull()
        assertThat(parsedWebhookEvent.financialAccountCreated()).isEqualTo(financialAccountCreated)
        assertThat(parsedWebhookEvent.financialAccountUpdated()).isNull()
        assertThat(parsedWebhookEvent.fundingEventCreated()).isNull()
        assertThat(parsedWebhookEvent.loanTapeCreated()).isNull()
        assertThat(parsedWebhookEvent.loanTapeUpdated()).isNull()
    ...
    fun ofFinancialAccountUpdated() {
        ...
        assertThat(parsedWebhookEvent.externalPaymentUpdated()).isNull()
        assertThat(parsedWebhookEvent.financialAccountCreated()).isNull()
        assertThat(parsedWebhookEvent.financialAccountUpdated()).isEqualTo(financialAccountUpdated)
        assertThat(parsedWebhookEvent.fundingEventCreated()).isNull()
        assertThat(parsedWebhookEvent.loanTapeCreated()).isNull()
        assertThat(parsedWebhookEvent.loanTapeUpdated()).isNull()
        assertThat(parsedWebhookEvent.managementOperationCreated()).isNull()
    ...
    fun ofFundingEventCreated() {
        ...
        assertThat(parsedWebhookEvent.financialAccountCreated()).isNull()
        assertThat(parsedWebhookEvent.financialAccountUpdated()).isNull()
        assertThat(parsedWebhookEvent.fundingEventCreated()).isEqualTo(fundingEventCreated)
        assertThat(parsedWebhookEvent.loanTapeCreated()).isNull()
        assertThat(parsedWebhookEvent.loanTapeUpdated()).isNull()
        assertThat(parsedWebhookEvent.managementOperationCreated()).isNull()
        assertThat(parsedWebhookEvent.managementOperationUpdated()).isNull()
    ...
    fun ofLoanTapeCreated() {
        ...
        assertThat(parsedWebhookEvent.financialAccountUpdated()).isNull()
        assertThat(parsedWebhookEvent.fundingEventCreated()).isNull()
        assertThat(parsedWebhookEvent.loanTapeCreated()).isEqualTo(loanTapeCreated)
        assertThat(parsedWebhookEvent.loanTapeUpdated()).isNull()
        assertThat(parsedWebhookEvent.managementOperationCreated()).isNull()
        assertThat(parsedWebhookEvent.managementOperationUpdated()).isNull()
        assertThat(parsedWebhookEvent.internalTransactionCreated()).isNull()
    ...
    fun ofLoanTapeUpdated() {
        ...
        assertThat(parsedWebhookEvent.fundingEventCreated()).isNull()
        assertThat(parsedWebhookEvent.loanTapeCreated()).isNull()
        assertThat(parsedWebhookEvent.loanTapeUpdated()).isEqualTo(loanTapeUpdated)
        assertThat(parsedWebhookEvent.managementOperationCreated()).isNull()
        assertThat(parsedWebhookEvent.managementOperationUpdated()).isNull()
        assertThat(parsedWebhookEvent.internalTransactionCreated()).isNull()
        assertThat(parsedWebhookEvent.internalTransactionUpdated()).isNull()
    ...
    fun ofManagementOperationCreated() {
        ...
        assertThat(parsedWebhookEvent.managementOperationCreated())
            .isEqualTo(managementOperationCreated)
        assertThat(parsedWebhookEvent.managementOperationUpdated()).isNull()
        assertThat(parsedWebhookEvent.internalTransactionCreated()).isNull()
        assertThat(parsedWebhookEvent.internalTransactionUpdated()).isNull()
        assertThat(parsedWebhookEvent.networkTotalCreated()).isNull()
    ...
    fun ofManagementOperationUpdated() {
        ...
        assertThat(parsedWebhookEvent.managementOperationUpdated())
            .isEqualTo(managementOperationUpdated)
        assertThat(parsedWebhookEvent.internalTransactionCreated()).isNull()
        assertThat(parsedWebhookEvent.internalTransactionUpdated()).isNull()
        assertThat(parsedWebhookEvent.networkTotalCreated()).isNull()
        assertThat(parsedWebhookEvent.networkTotalUpdated()).isNull()
    ...
    fun ofInternalTransactionCreated() {
        ...
        assertThat(parsedWebhookEvent.internalTransactionCreated())
            .isEqualTo(internalTransactionCreated)
        assertThat(parsedWebhookEvent.internalTransactionUpdated()).isNull()
        assertThat(parsedWebhookEvent.networkTotalCreated()).isNull()
        assertThat(parsedWebhookEvent.networkTotalUpdated()).isNull()
        assertThat(parsedWebhookEvent.paymentTransactionCreated()).isNull()
    ...
    fun ofInternalTransactionUpdated() {
        ...
        assertThat(parsedWebhookEvent.internalTransactionUpdated())
            .isEqualTo(internalTransactionUpdated)
        assertThat(parsedWebhookEvent.networkTotalCreated()).isNull()
        assertThat(parsedWebhookEvent.networkTotalUpdated()).isNull()
        assertThat(parsedWebhookEvent.paymentTransactionCreated()).isNull()
        assertThat(parsedWebhookEvent.paymentTransactionUpdated()).isNull()
    ...
    fun ofNetworkTotalCreated() {
        ...
        assertThat(parsedWebhookEvent.internalTransactionCreated()).isNull()
        assertThat(parsedWebhookEvent.internalTransactionUpdated()).isNull()
        assertThat(parsedWebhookEvent.networkTotalCreated()).isEqualTo(networkTotalCreated)
        assertThat(parsedWebhookEvent.networkTotalUpdated()).isNull()
        assertThat(parsedWebhookEvent.paymentTransactionCreated()).isNull()
        assertThat(parsedWebhookEvent.paymentTransactionUpdated()).isNull()
        assertThat(parsedWebhookEvent.settlementReportUpdated()).isNull()
    ...
    fun ofNetworkTotalUpdated() {
        ...
        assertThat(parsedWebhookEvent.internalTransactionUpdated()).isNull()
        assertThat(parsedWebhookEvent.networkTotalCreated()).isNull()
        assertThat(parsedWebhookEvent.networkTotalUpdated()).isEqualTo(networkTotalUpdated)
        assertThat(parsedWebhookEvent.paymentTransactionCreated()).isNull()
        assertThat(parsedWebhookEvent.paymentTransactionUpdated()).isNull()
        assertThat(parsedWebhookEvent.settlementReportUpdated()).isNull()
        assertThat(parsedWebhookEvent.statementsCreated()).isNull()
    ...
    fun ofPaymentTransactionCreated() {
        ...
        assertThat(parsedWebhookEvent.paymentTransactionCreated())
            .isEqualTo(paymentTransactionCreated)
        assertThat(parsedWebhookEvent.paymentTransactionUpdated()).isNull()
        assertThat(parsedWebhookEvent.settlementReportUpdated()).isNull()
        assertThat(parsedWebhookEvent.statementsCreated()).isNull()
        assertThat(parsedWebhookEvent.threeDSAuthenticationCreated()).isNull()
    ...
    fun ofPaymentTransactionUpdated() {
        ...
        assertThat(parsedWebhookEvent.paymentTransactionUpdated())
            .isEqualTo(paymentTransactionUpdated)
        assertThat(parsedWebhookEvent.settlementReportUpdated()).isNull()
        assertThat(parsedWebhookEvent.statementsCreated()).isNull()
        assertThat(parsedWebhookEvent.threeDSAuthenticationCreated()).isNull()
        assertThat(parsedWebhookEvent.threeDSAuthenticationUpdated()).isNull()
    ...
    fun ofSettlementReportUpdated() {
        ...
        assertThat(parsedWebhookEvent.paymentTransactionCreated()).isNull()
        assertThat(parsedWebhookEvent.paymentTransactionUpdated()).isNull()
        assertThat(parsedWebhookEvent.settlementReportUpdated()).isEqualTo(settlementReportUpdated)
        assertThat(parsedWebhookEvent.statementsCreated()).isNull()
        assertThat(parsedWebhookEvent.threeDSAuthenticationCreated()).isNull()
        assertThat(parsedWebhookEvent.threeDSAuthenticationUpdated()).isNull()
        assertThat(parsedWebhookEvent.threeDSAuthenticationChallenge()).isNull()
    ...
    fun ofStatementsCreated() {
        ...
        assertThat(parsedWebhookEvent.paymentTransactionUpdated()).isNull()
        assertThat(parsedWebhookEvent.settlementReportUpdated()).isNull()
        assertThat(parsedWebhookEvent.statementsCreated()).isEqualTo(statementsCreated)
        assertThat(parsedWebhookEvent.threeDSAuthenticationCreated()).isNull()
        assertThat(parsedWebhookEvent.threeDSAuthenticationUpdated()).isNull()
        assertThat(parsedWebhookEvent.threeDSAuthenticationChallenge()).isNull()
        assertThat(parsedWebhookEvent.tokenizationApprovalRequest()).isNull()
    ...
    fun ofThreeDSAuthenticationCreated() {
        ...
        assertThat(parsedWebhookEvent.threeDSAuthenticationCreated())
            .isEqualTo(threeDSAuthenticationCreated)
        assertThat(parsedWebhookEvent.threeDSAuthenticationUpdated()).isNull()
        assertThat(parsedWebhookEvent.threeDSAuthenticationChallenge()).isNull()
        assertThat(parsedWebhookEvent.tokenizationApprovalRequest()).isNull()
        assertThat(parsedWebhookEvent.tokenizationResult()).isNull()
    ...
    fun ofThreeDSAuthenticationUpdated() {
        ...
        assertThat(parsedWebhookEvent.threeDSAuthenticationUpdated())
            .isEqualTo(threeDSAuthenticationUpdated)
        assertThat(parsedWebhookEvent.threeDSAuthenticationChallenge()).isNull()
        assertThat(parsedWebhookEvent.tokenizationApprovalRequest()).isNull()
        assertThat(parsedWebhookEvent.tokenizationResult()).isNull()
        assertThat(parsedWebhookEvent.tokenizationTwoFactorAuthenticationCode()).isNull()
    ...
    fun ofThreeDSAuthenticationChallenge() {
        ...
        assertThat(parsedWebhookEvent.threeDSAuthenticationChallenge())
            .isEqualTo(threeDSAuthenticationChallenge)
        assertThat(parsedWebhookEvent.tokenizationApprovalRequest()).isNull()
        assertThat(parsedWebhookEvent.tokenizationResult()).isNull()
        assertThat(parsedWebhookEvent.tokenizationTwoFactorAuthenticationCode()).isNull()
        assertThat(parsedWebhookEvent.tokenizationTwoFactorAuthenticationCodeSent()).isNull()
    ...
    fun ofTokenizationApprovalRequest() {
        ...
        assertThat(parsedWebhookEvent.tokenizationApprovalRequest())
            .isEqualTo(tokenizationApprovalRequest)
        assertThat(parsedWebhookEvent.tokenizationResult()).isNull()
        assertThat(parsedWebhookEvent.tokenizationTwoFactorAuthenticationCode()).isNull()
        assertThat(parsedWebhookEvent.tokenizationTwoFactorAuthenticationCodeSent()).isNull()
        assertThat(parsedWebhookEvent.tokenizationUpdated()).isNull()
    ...
    fun ofTokenizationResult() {
        ...
        assertThat(parsedWebhookEvent.threeDSAuthenticationChallenge()).isNull()
        assertThat(parsedWebhookEvent.tokenizationApprovalRequest()).isNull()
        assertThat(parsedWebhookEvent.tokenizationResult()).isEqualTo(tokenizationResult)
        assertThat(parsedWebhookEvent.tokenizationTwoFactorAuthenticationCode()).isNull()
        assertThat(parsedWebhookEvent.tokenizationTwoFactorAuthenticationCodeSent()).isNull()
        assertThat(parsedWebhookEvent.tokenizationUpdated()).isNull()
        assertThat(parsedWebhookEvent.threeDSAuthenticationApprovalRequest()).isNull()
    ...
    fun ofTokenizationTwoFactorAuthenticationCode() {
        ...
        assertThat(parsedWebhookEvent.tokenizationTwoFactorAuthenticationCode())
            .isEqualTo(tokenizationTwoFactorAuthenticationCode)
        assertThat(parsedWebhookEvent.tokenizationTwoFactorAuthenticationCodeSent()).isNull()
        assertThat(parsedWebhookEvent.tokenizationUpdated()).isNull()
        assertThat(parsedWebhookEvent.threeDSAuthenticationApprovalRequest()).isNull()
        assertThat(parsedWebhookEvent.disputeTransactionCreated()).isNull()
    ...
    fun ofTokenizationTwoFactorAuthenticationCodeSent() {
        ...
        assertThat(parsedWebhookEvent.tokenizationTwoFactorAuthenticationCodeSent())
            .isEqualTo(tokenizationTwoFactorAuthenticationCodeSent)
        assertThat(parsedWebhookEvent.tokenizationUpdated()).isNull()
        assertThat(parsedWebhookEvent.threeDSAuthenticationApprovalRequest()).isNull()
        assertThat(parsedWebhookEvent.disputeTransactionCreated()).isNull()
        assertThat(parsedWebhookEvent.disputeTransactionUpdated()).isNull()
    ...
    fun ofTokenizationUpdated() {
        ...
        assertThat(parsedWebhookEvent.tokenizationTwoFactorAuthenticationCode()).isNull()
        assertThat(parsedWebhookEvent.tokenizationTwoFactorAuthenticationCodeSent()).isNull()
        assertThat(parsedWebhookEvent.tokenizationUpdated()).isEqualTo(tokenizationUpdated)
        assertThat(parsedWebhookEvent.threeDSAuthenticationApprovalRequest()).isNull()
        assertThat(parsedWebhookEvent.disputeTransactionCreated()).isNull()
        assertThat(parsedWebhookEvent.disputeTransactionUpdated()).isNull()
    }
    ...
    fun ofThreeDSAuthenticationApprovalRequest() {
        ...
        assertThat(parsedWebhookEvent.threeDSAuthenticationApprovalRequest())
            .isEqualTo(threeDSAuthenticationApprovalRequest)
        assertThat(parsedWebhookEvent.disputeTransactionCreated()).isNull()
        assertThat(parsedWebhookEvent.disputeTransactionUpdated()).isNull()
    }
    ...
    fun ofDisputeTransactionCreated() {
        ...
        assertThat(parsedWebhookEvent.disputeTransactionCreated())
            .isEqualTo(disputeTransactionCreated)
        assertThat(parsedWebhookEvent.disputeTransactionUpdated()).isNull()
    }
    ...
    fun ofDisputeTransactionUpdated() {
        ...
        assertThat(parsedWebhookEvent.disputeTransactionUpdated())
            .isEqualTo(disputeTransactionUpdated)
    }
