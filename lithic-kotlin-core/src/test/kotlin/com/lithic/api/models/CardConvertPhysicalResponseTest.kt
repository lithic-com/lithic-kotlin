...
internal class CardConvertPhysicalResponseTest {
    ...
    fun create() {
        ...
        assertThat(cardConvertPhysicalResponse.authRuleTokens()).containsExactly("string")
        assertThat(cardConvertPhysicalResponse.cardholderCurrency()).isEqualTo("USD")
        assertThat(cardConvertPhysicalResponse.cvv()).isEqualTo("776")
        assertThat(cardConvertPhysicalResponse.digitalCardArtToken())
            .isEqualTo("00000000-0000-0000-1000-000000000000")
        assertThat(cardConvertPhysicalResponse.expMonth()).isEqualTo("06")
        assertThat(cardConvertPhysicalResponse.expYear()).isEqualTo("2027")
        assertThat(cardConvertPhysicalResponse.hostname()).isEqualTo("hostname")
        assertThat(cardConvertPhysicalResponse.memo()).isEqualTo("New Card")
        assertThat(cardConvertPhysicalResponse.pan()).isEqualTo("4111111289144142")
        assertThat(cardConvertPhysicalResponse.pendingCommands()).containsExactly("string")
        assertThat(cardConvertPhysicalResponse.productId()).isEqualTo("1")
