...
class NetworkTotalRetrieveResponseTest {

    @Test
    fun createNetworkTotalRetrieveResponse() {
        val networkTotalRetrieveResponse =
            NetworkTotalRetrieveResponse.builder()
                ...
                .cycle(0L)
                .build()
        assertThat(networkTotalRetrieveResponse).isNotNull
        ...
        assertThat(networkTotalRetrieveResponse.updated())
            .isEqualTo(OffsetDateTime.parse("2025-02-25T13:07:31.419631Z"))
        assertThat(networkTotalRetrieveResponse.cycle()).isEqualTo(0L)
    }
}
