...
internal class DisputeEvidenceUploadFailedWebhookEventTest {
    ...
    fun create() {
        ...
        assertThat(disputeEvidenceUploadFailedWebhookEvent.downloadUrl()).isEqualTo("download_url")
        assertThat(disputeEvidenceUploadFailedWebhookEvent.filename()).isEqualTo("filename")
        assertThat(disputeEvidenceUploadFailedWebhookEvent.uploadUrl()).isEqualTo("upload_url")
